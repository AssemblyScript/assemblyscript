...
@builtin export declare function isDefined(expression: unknown): bool;
@builtin export declare function isConstant(expression: unknown): bool;
@builtin export declare function isManaged<T>(value?: T): bool;
@inline export function isNaN<T extends number>(value: T): bool { return value != value; }
@inline export function isFinite<T extends number>(value: T): bool { return value - value == 0; }
...
@builtin export declare function reinterpret<T>(value: unknown): T;
...
@builtin export declare function store<T>(offset: usize, value: unknown, constantOffset?: usize): void;
...
@builtin export declare function changetype<T>(value: unknown): T;
...
@builtin export declare function call_indirect<T>(target: unknown, ...args: unknown[]): T;
@builtin export declare function instantiate<T>(...args: unknown[]): T;

@builtin export declare function i8(value: unknown): i8;
export namespace i8 {
  export const MIN_VALUE: i8 = -128;
  export const MAX_VALUE: i8 =  127;
}

@builtin export declare function i16(value: unknown): i16;
export namespace i16 {
  export const MIN_VALUE: i16 = -32768;
  export const MAX_VALUE: i16 =  32767;
}

@builtin export declare function i32(value: unknown): i32;
...
@builtin export declare function i64(value: unknown): i64;
...
@builtin export declare function isize(value: unknown): isize;
...
@builtin export declare function u8(value: unknown): u8;
export namespace u8 {
  export const MIN_VALUE: u8 = 0;
  export const MAX_VALUE: u8 = 255;
}

@builtin export declare function u16(value: unknown): u16;
export namespace u16 {
  export const MIN_VALUE: u16 = 0;
  export const MAX_VALUE: u16 = 65535;
}

@builtin export declare function u32(value: unknown): u32;
export namespace u32 {
  export const MIN_VALUE: u32 = 0;
  export const MAX_VALUE: u32 = 4294967295;
}

@builtin export declare function u64(value: unknown): u64;
export namespace u64 {
  export const MIN_VALUE: u64 = 0;
  export const MAX_VALUE: u64 = 18446744073709551615;
}

@builtin export declare function usize(value: unknown): usize;
...
@builtin export declare function bool(value: unknown): bool;
export namespace bool {
  export const MIN_VALUE: bool = false;
  export const MAX_VALUE: bool = true;
}

@builtin export declare function f32(value: unknown): f32;
...
@builtin export declare function f64(value: unknown): f64;
