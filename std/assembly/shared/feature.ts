...
export const enum Feature {
  ...
  /** Function references. */
  FunctionReferences = 1 << 12, // see: https://github.com/WebAssembly/function-references
  /** Relaxed SIMD. */
  RelaxedSimd = 1 << 13, // see: https://github.com/WebAssembly/relaxed-simd
  /** Extended const expressions. */
  ExtendedConst = 1 << 14 // see: https://github.com/WebAssembly/extended-const
}
