...
import {u128 as u128} from "bignum";
...
export function __near_encode_Array_Uint8Array(
          value: Array<Uint8Array>,
          encoder: JSONEncoder): void {
for (let i = 0; i < value.length; i++) {
if (value[i] != null) {
            encoder.setString(null, base64.encode(value[i]));
          } else {
            encoder.setNull(null);
          };
}
...
if (value.uint8arrays != null) {
          encoder.pushArray("uint8arrays");
          __near_encode_Array_Uint8Array(value.uint8arrays, encoder);
          encoder.popArray();
        } else {
          encoder.setNull("uint8arrays");
        }
}
...
if (name == "arr") {
          this.value.arr = __near_decode_Array_Array_String(this.buffer, this.decoder.state);
          return false;
        }
if (name == "u32Arr") {
          this.value.u32Arr = __near_decode_Array_u32(this.buffer, this.decoder.state);
          return false;
        }
if (name == "i32Arr") {
          this.value.i32Arr = __near_decode_Array_i32(this.buffer, this.decoder.state);
          return false;
        }
if (name == "uint8arrays") {
          this.value.uint8arrays = __near_decode_Array_Uint8Array(this.buffer, this.decoder.state);
          return false;
        }
...
pushObject(name: string): bool {
        this.value.push(__near_decode_Array_String(this.buffer, this.decoder.state));
        return false;
      }
      pushArray(name: string): bool {
        assert(name == null || name.length == 0);
...
export function __near_decode_Array_Array_String(
        buffer: Uint8Array, state: DecoderState, value: Array<Array<String>> = null):Array<Array<String>> {
      if (value == null) {
...
export function __near_decode_Array_u32(
        buffer: Uint8Array, state: DecoderState, value: Array<u32> = null):Array<u32> {
      if (value == null) {
        value = new Array<u32>();
      }
...
export class __near_JSONHandler_Array_Uint8Array extends ThrowingJSONHandler {
      buffer: Uint8Array;
      decoder: JSONDecoder<__near_JSONHandler_Array_Uint8Array>;
      handledRoot: boolean = false;
      value: Array<Uint8Array>;
      
      constructor(value_: Array<Uint8Array>) {
        super();
        this.value = value_;
      }
...
setNull(name: string): void {
        this.value.push(<Uint8Array>null);
      }
      pushArray(name: string): bool {
        assert((name == null || name.length == 0) && !this.handledRoot);
        this.handledRoot = true;
...
export function __near_decode_Array_Uint8Array(
        buffer: Uint8Array, state: DecoderState, value: Array<Uint8Array> = null):Array<Uint8Array> {
      if (value == null) {
        value = new Array<Uint8Array>();
      }
      let handler = new __near_JSONHandler_Array_Uint8Array(value);
      handler.buffer = buffer;
      handler.decoder = new JSONDecoder<__near_JSONHandler_Array_Uint8Array>(handler);
      handler.decoder.deserialize(buffer, state);
      return value;
    }

export function __near_decode_FooBar(
        buffer: Uint8Array, state: DecoderState, value: FooBar = null):FooBar {
      if (value == null) {
        value = new FooBar();
      }
...
export function __near_decode_ContainerClass(
        buffer: Uint8Array, state: DecoderState, value: ContainerClass = null):ContainerClass {
      if (value == null) {
...
if (!this.handledRoot) {
      ...
      pushArray(name: string): bool {
if (name == "foobars") {
          this.value.foobars = __near_decode_Array_Array_FooBar(this.buffer, this.decoder.state);
          return false;
        }
...
pushObject(name: string): bool {
        this.value.push(__near_decode_Array_FooBar(this.buffer, this.decoder.state));
        return false;
      }
      pushArray(name: string): bool {
        assert(name == null || name.length == 0);
...
export function __near_decode_Array_FooBar(
        buffer: Uint8Array, state: DecoderState, value: Array<FooBar> = null):Array<FooBar> {
      if (value == null) {
...
export function __near_decode_Array_Array_FooBar(
        buffer: Uint8Array, state: DecoderState, value: Array<Array<FooBar>> = null):Array<Array<FooBar>> {
      if (value == null) {
...
export function __near_decode_AnotherContainerClass(
        buffer: Uint8Array, state: DecoderState, value: AnotherContainerClass = null):AnotherContainerClass {
      if (value == null) {
...
if (name == "args") {
          this.value.args = __near_decode_PromiseArgs(this.buffer, this.decoder.state);
          return false;
        }
if (name == "callbackArgs") {
          this.value.callbackArgs = __near_decode_PromiseArgs(this.buffer, this.decoder.state);
          return false;
        }
...
export function __near_decode_PromiseArgs(
        buffer: Uint8Array, state: DecoderState, value: PromiseArgs = null):PromiseArgs {
      if (value == null) {
...
if (name == "r") {
          this.value.r = __near_decode_MyCallbackResult(this.buffer, this.decoder.state);
          return false;
        }
...
if (!this.handledRoot) {
      ...
      pushArray(name: string): bool {
if (name == "rs") {
          this.value.rs = __near_decode_Array_MyContractPromiseResult(this.buffer, this.decoder.state);
          return false;
        }
...
pushObject(name: string): bool {
        this.value.push(__near_decode_MyContractPromiseResult(this.buffer, this.decoder.state));
        return false;
      }
      pushArray(name: string): bool {
        assert(name == null || name.length == 0);
...
export function __near_decode_Array_MyContractPromiseResult(
        buffer: Uint8Array, state: DecoderState, value: Array<MyContractPromiseResult> = null):Array<MyContractPromiseResult> {
      if (value == null) {
...
export function __near_decode_MyCallbackResult(
        buffer: Uint8Array, state: DecoderState, value: MyCallbackResult = null):MyCallbackResult {
      if (value == null) {
...
export function __near_decode_MyContractPromiseResult(
        buffer: Uint8Array, state: DecoderState, value: MyContractPromiseResult = null):MyContractPromiseResult {
      if (value == null) {
