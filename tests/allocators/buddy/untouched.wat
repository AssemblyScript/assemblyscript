(module
 ...
 (func $~lib/allocator/buddy/update_max_ptr (; 8 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
 ...
 (func $~lib/allocator/buddy/buckets$get (; 9 ;) (type $ii) (param $0 i32) (result i32)
  ...
  (if
   (i32.eqz
    ...
    (i32.lt_u
     ...
     (get_global $~lib/allocator/buddy/BUCKET_COUNT)
    )
   )
   (block
    (call $~lib/env/abort
  ...
  (i32.add
   ...
   (i32.mul
    ...
    (get_global $~lib/allocator/buddy/List.SIZE)
   )
  )
 )
 (func $~lib/allocator/buddy/list_init (; 10 ;) (type $iv) (param $0 i32)
 ...
 (func $~lib/allocator/buddy/list_push (; 11 ;) (type $iiv) (param $0 i32) (param $1 i32)
  (local $2 i32)
 ...
 (func $~lib/allocator/buddy/bucket_for_request (; 12 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  ...
  (set_local $2
   ...
   (get_global $~lib/allocator/buddy/MIN_ALLOC)
  )
 ...
 (func $~lib/allocator/buddy/node_for_ptr (; 13 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
   ...
   (i32.add
    (i32.shr_u
     ...
     (i32.sub
      ...
      (get_global $~lib/allocator/buddy/MAX_ALLOC_LOG2)
 ...
 (func $~lib/allocator/buddy/node_is_split$get (; 14 ;) (type $ii) (param $0 i32) (result i32)
  ...
  (if
   (i32.eqz
    ...
    (i32.lt_u
     ...
     (get_global $~lib/allocator/buddy/SPLIT_COUNT)
    )
   )
   (block
    (call $~lib/env/abort
 ...
 (func $~lib/allocator/buddy/parent_is_split (; 15 ;) (type $ii) (param $0 i32) (result i32)
 ...
 (func $~lib/allocator/buddy/list_remove (; 16 ;) (type $iv) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
 ...
 (func $~lib/allocator/buddy/ptr_for_node (; 17 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
 ...
 (func $~lib/allocator/buddy/node_is_split$set (; 18 ;) (type $iiv) (param $0 i32) (param $1 i32)
 ...
 (func $~lib/allocator/buddy/flip_parent_is_split (; 19 ;) (type $iv) (param $0 i32)
  (local $1 i32)
 ...
 (func $~lib/allocator/buddy/lower_bucket_limit (; 20 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
 ...
 (func $~lib/allocator/buddy/list_pop (; 21 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/allocator/buddy/__memory_allocate (; 22 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (if
   ...
   (i32.gt_u
    ...
    (i32.sub
     (get_global $~lib/allocator/buddy/MAX_ALLOC)
     ;;@ ~lib/allocator/buddy.ts:350:28
     (get_global $~lib/allocator/buddy/HEADER_SIZE)
    )
   )
 ...
 (func $~lib/allocator/buddy/__memory_free (; 24 ;) (type $iv) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/allocator/buddy/__memory_reset (; 26 ;) (type $v)
