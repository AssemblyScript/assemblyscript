...
// ERROR 1039: "Initializers are not allowed in ambient contexts." in class.ts(32,35+1)
// ERROR 1042: "'declare' modifier cannot be used here." in class.ts(36,3+7)
// ERROR 1183: "An implementation cannot be declared in ambient contexts." in class.ts(36,32+1)
