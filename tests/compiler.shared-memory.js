...
if (args.help) {
  console.log([
    ...
    "  " + colorsUtil.cyan("npm run test:compiler.shared-memory --") + " [test1, test2 ...] [options]",
    "",
...
const basedir = path.join(__dirname, "compiler.shared-memory");
...
tests.forEach(filename => {
  console.log(colorsUtil.white("Testing compiler.shared-memory/" + filename) + "\n");
  ...
  asc.main( [
    ...
    asc.main(cmd, {
      ...
      // Instantiate
      try {
        let memory = new WebAssembly.Memory({ initial: 256, maximum: 256, shared: true });
        let exports = {};
