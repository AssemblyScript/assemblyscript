(module
 ...
 (func $~lib/map/Map<~lib/string/String,u64>#has (param $this i32) (param $key i32) (result i32)
  local.get $this
  local.get $key
  local.get $key
 ...
 (func $~lib/map/Map<~lib/string/String,u64>#rehash (param $this i32) (param $newBucketsMask i32)
 ...
 (func $~lib/map/Map<~lib/string/String,u64>#get (param $this i32) (param $key i32) (result i64)
  (local $entry i32)
  local.get $this
  local.get $key
  local.get $key
 ...
 (func $~lib/map/Map<~lib/string/String,u64>#delete (param $this i32) (param $key i32) (result i32)
  (local $entry i32)
 ...
 (func $~lib/map/Map<~lib/string/String,u64>#__visit (param $this i32) (param $cookie i32)
  (local $entries i32)
  (local $var$3 i32)
  (local $var$4 i32)
  (local $var$5 i32)
