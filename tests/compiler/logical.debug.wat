(module
 ...
 (global $~lib/util/dtoa/POW10_MINOR i32 (i32.const 248))
 (global $~lib/util/dtoa/POW10_MAJOR i32 (i32.const 472))
 (global $~lib/util/dtoa/POW10_FIXUPS i32 (i32.const 840))
 ...
 (global $~lib/util/dtoa/SCRATCH i32 (i32.const 928))
 (global $~lib/util/dtoa/POW10_FLOAT_HI i32 (i32.const 1056))
 (global $~lib/util/dtoa/H37 i32 (i32.const 1672))
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2180))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34948))
 (global $~lib/memory/__heap_base i32 (i32.const 34948))
 (memory $0 1)
