(module
 ...
 (global $~lib/rt/__rtti_base i32 (i32.const 14192))
 (global $~lib/memory/__data_end i32 (i32.const 14212))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 46980))
 (global $~lib/memory/__heap_base i32 (i32.const 46980))
 (memory $0 1)
