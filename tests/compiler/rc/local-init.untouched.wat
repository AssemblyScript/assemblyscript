(module
 ...
 (data (i32.const 240) "(\00\00\00\01\00\00\00\01\00\00\00(\00\00\00a\00l\00l\00o\00c\00a\00t\00i\00o\00n\00 \00t\00o\00o\00 \00l\00a\00r\00g\00e\00")
 (data (i32.const 304) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 ...
 (func $~lib/rt/tlsf/freeBlock (; 7 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  i32.load
  local.set $2
 ...
 (func $~lib/rt/__typeinfo (; 8 ;) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/rt/tlsf/addMemory (; 9 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $~lib/rt/tlsf/__free (; 25 ;) (param $0 i32)
  call $~lib/rt/tlsf/maybeInitialize
  local.get $0
  call $~lib/rt/tlsf/checkUsedBlock
  call $~lib/rt/tlsf/freeBlock
 )
 (func $~lib/rt/pure/growRoots (; 26 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/pure/appendRoot (; 27 ;) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.set $1
  local.get $1
 ...
 (func $rc/local-init/getRef (; 30 ;) (result i32)
  i32.const 32
 )
 (func $~lib/rt/pure/increment (; 31 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/pure/__retain (; 32 ;) (param $0 i32) (result i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.gt_u
  if
 ...
 (func $rc/local-init/Ref#constructor (; 33 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
