(module
 ...
 (func $~lib/rt/tlsf/initializeRoot (; 10 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $rc/local-init/getRef (; 29 ;) (result i32)
  i32.const 32
 )
 ...
 (func $rc/local-init/Ref#constructor (; 32 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
