(module
 ...
 (func $~lib/rt/pure/decrement (; 9 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
 ...
 (func $rc/local-init/getRef (; 11 ;) (result i32)
  i32.const 32
 )
 ...
 (func $rc/local-init/Ref#constructor (; 22 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
