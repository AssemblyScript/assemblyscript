(module
 ...
 (func $rc/ternary-mismatch/Ref#constructor (; 17 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $rc/ternary-mismatch/getRef (; 18 ;) (result i32)
  i32.const 0
  call $rc/ternary-mismatch/Ref#constructor
 )
 (func $rc/ternary-mismatch/test1 (; 19 ;) (param $0 i32) (result i32)
  local.get $0
  if (result i32)
 ...
 (func $rc/ternary-mismatch/test2 (; 30 ;) (param $0 i32) (result i32)
  local.get $0
  if (result i32)
   global.get $rc/ternary-mismatch/gloRef
   call $~lib/rt/pure/__retain
 ...
 (func $start:rc/ternary-mismatch (; 31 ;)
  i32.const 0
  call $rc/ternary-mismatch/Ref#constructor
 ...
 (func $~lib/rt/pure/__visit_collect (; 36 ;) (param $0 i32) (param $1 i32)
  unreachable
 )
)
