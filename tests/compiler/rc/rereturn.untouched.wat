(module
 ...
 (func $rc/rereturn/Ref#constructor (; 17 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $rc/rereturn/getRef (; 18 ;) (result i32)
  i32.const 0
  call $rc/rereturn/Ref#constructor
 )
 (func $rc/rereturn/rereturnRef (; 19 ;) (result i32)
  call $rc/rereturn/getRef
 )
 (func $start:rc/rereturn (; 20 ;)
