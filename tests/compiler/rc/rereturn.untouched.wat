(module
 ...
 (func $rc/rereturn/Ref#constructor (; 23 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $rc/rereturn/getRef (; 24 ;) (result i32)
  i32.const 0
  call $rc/rereturn/Ref#constructor
 )
 (func $rc/rereturn/rereturnRef (; 25 ;) (result i32)
  call $rc/rereturn/getRef
 )
 (func $start:rc/rereturn (; 26 ;)
 ...
 (func $~lib/rt/pure/__visit_collect (; 31 ;) (param $0 i32) (param $1 i32)
  unreachable
 )
)
