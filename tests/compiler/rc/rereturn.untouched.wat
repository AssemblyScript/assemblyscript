(module
 ...
 (func $rc/rereturn/Ref#constructor (; 29 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $rc/rereturn/getRef (; 30 ;) (type $FUNCSIG$i) (result i32)
  i32.const 0
  call $rc/rereturn/Ref#constructor
 )
 (func $rc/rereturn/rereturnRef (; 31 ;) (type $FUNCSIG$i) (result i32)
  call $rc/rereturn/getRef
 )
 (func $start:rc/rereturn (; 32 ;) (type $FUNCSIG$v)
