(module
 ...
 (data (i32.const 240) "\03\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 ...
 (func $~lib/rt/pure/decrement (; 11 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/rt/pure/appendRoot (; 15 ;) (param $0 i32)
  unreachable
 )
 (func $~lib/rt/pure/__visit (; 16 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
 ...
 (func $~lib/rt/__visit_members (; 17 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
