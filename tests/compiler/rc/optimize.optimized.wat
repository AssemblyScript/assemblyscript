(module
 ...
 (data (i32.const 288) "\02\00\00\00\01\00\00\00\01\00\00\00\02\00\00\00a")
 ...
 (func $rc/optimize/getRef (; 21 ;) (result i32)
  i32.const 0
  i32.const 3
 ...
 (func $rc/optimize/eliminated_rr (; 30 ;) (param $0 i32) (result i32)
  call $rc/optimize/getRef
 )
 (func $rc/optimize/OptimizeARC.eliminates.balancedInsideOutsideLoopWithBranch (; 31 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  loop $while-continue|0
   local.get $1
   if
    local.get $2
 ...
 (func $rc/optimize/OptimizeARC.keeps.partialRetains (; 32 ;) (param $0 i32) (param $1 i32)
  local.get $1
  if (result i32)
   local.get $0
   call $~lib/rt/pure/__retain
 ...
 (func $rc/optimize/OptimizeARC.keeps.reachesReturn (; 33 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $1
 ...
 (func $rc/optimize/FinalizeARC.keeps.dynamicRetain (; 34 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  drop
 )
 (func $rc/optimize/FinalizeARC.keeps.dynamicRelease (; 35 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__release
 )
