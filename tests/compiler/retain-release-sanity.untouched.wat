(module
 ...
 (func $~lib/rt/tlsf/__realloc (; 37 ;) (param $0 i32) (param $1 i32) (result i32)
  call $~lib/rt/tlsf/maybeInitialize
  local.get $0
  call $~lib/rt/tlsf/checkUsedBlock
  local.get $1
 ...
 (func $~lib/array/Array<i32>#push (; 39 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<i32>#pop (; 40 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<~lib/array/Array<~lib/string/String>>#constructor (; 41 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/array/Array<~lib/string/String>#constructor (; 42 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/array/Array<~lib/string/String>#push (; 43 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $~lib/string/String#concat (; 45 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/string/String.__concat (; 46 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $retain-release-sanity/A#constructor (; 47 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $retain-release-sanity/B#constructor (; 48 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $start:retain-release-sanity (; 49 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
