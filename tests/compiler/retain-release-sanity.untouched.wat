(module
 ...
 (func $~lib/array/Array<i32>#push (; 38 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<i32>#pop (; 39 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<~lib/array/Array<~lib/string/String>>#constructor (; 40 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/array/Array<~lib/string/String>#constructor (; 41 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/array/Array<~lib/string/String>#push (; 42 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $~lib/string/String#get:length (; 43 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 16
  i32.sub
  i32.load offset=12
 ...
 (func $~lib/string/String#concat (; 44 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/string/String.__concat (; 45 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $retain-release-sanity/A#constructor (; 46 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $retain-release-sanity/B#constructor (; 47 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $start:retain-release-sanity (; 48 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/array/Array<i32>#__visit_impl (; 50 ;) (param $0 i32) (param $1 i32)
  nop
 )
