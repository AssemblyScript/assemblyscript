(module
 ...
 (func $~lib/array/Array<extends-baseaggregate/A2>#push (; 26 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $start:extends-baseaggregate (; 27 ;)
  (local $0 i32)
  (local $1 i32)
 ...
 (func $~lib/rt/pure/appendRoot (; 36 ;) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.set $1
  local.get $1
