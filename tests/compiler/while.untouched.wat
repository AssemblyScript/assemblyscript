(module
 ...
 (func $while/testAlwaysBreaks (; 10 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 0
  local.set $0
 ...
 (func $while/testAlwaysReturns (; 11 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 0
  local.set $0
 ...
 (func $while/testNestedContinue (; 13 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/tlsf/allocateBlock (; 28 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $while/Ref#constructor (; 32 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $~lib/rt/__typeinfo (; 33 ;) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/rt/tlsf/__free (; 36 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  if (result i32)
 ...
 (func $while/getRef (; 42 ;) (result i32)
  i32.const 0
  call $while/Ref#constructor
 )
 (func $while/testRefAutorelease (; 43 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
