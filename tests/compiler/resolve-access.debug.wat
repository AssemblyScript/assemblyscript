(module
 ...
 (data $16 (i32.const 2272) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\02\00\00\02\t\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $resolve-access/Container#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $resolve-access/Container#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $resolve-access/Container#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
