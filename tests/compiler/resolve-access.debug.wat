(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 67860))
 (global $~lib/memory/__heap_base i32 (i32.const 67860))
 (memory $0 2)
 ...
 (func $~lib/util/number/utoa64 (type $i64_i32_=>_i32) (param $value i64) (param $radix i32) (result i32)
  ...
  if
   ...
   if
    ...
    local.set $decimals_2
    global.get $~lib/memory/__stack_pointer
    local.get $decimals_2
    i32.const 1
    i32.shl
    i32.const 1
    call $~lib/rt/itcms/__new
