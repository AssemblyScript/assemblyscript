(module
 ...
 (func $class-overloading-virtual/Baa#constructor (; 6 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $class-overloading-virtual/Foo#foo (; 7 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 96
 )
 ...
 (func $class-overloading-virtual/test (; 12 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/stub/__retain
  local.set $0
  ...
  local.get $0
  call $class-overloading-virtual/Foo#foo
  local.tee $2
  i32.const 96
 ...
 (func $class-overloading-virtual/testBar (; 13 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $0
  call $~lib/rt/stub/__retain
  local.set $0
  ...
  local.get $0
  call $class-overloading-virtual/Bar#foo
  local.tee $3
  local.get $2
  call $~lib/string/String.__eq
  i32.eqz
 ...
 (func $start:class-overloading-virtual (; 14 ;) (type $FUNCSIG$v)
  ...
  i32.const 0
  call $class-overloading-virtual/Baa#constructor
 ...
 (func $class-overloading-virtual/Foo#baz~virtual (; 16 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 42
 )
 (func $class-overloading-virtual/Baa#baz (; 17 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 168
 )
 (func $class-overloading-virtual/Foo#baz (; 18 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  ...
  local.get $0
  call $class-overloading-virtual/Baa#baz
  return
 )
 (func $class-overloading-virtual/Bar#baz~virtual (; 19 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 84
 )
 (func $class-overloading-virtual/Bar#baz (; 20 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  block $switch$1$case$4
   block $switch$1$case$3
    block $switch$1$default
     local.get $0
   ...
   local.get $0
   call $class-overloading-virtual/Bar#baz~virtual
   return
  end
  local.get $0
  call $class-overloading-virtual/Baa#baz
 ...
 (func $class-overloading-virtual/Bar#foo~virtual (; 21 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 128
 )
 (func $class-overloading-virtual/Baa#foo (; 22 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 160
 )
 (func $class-overloading-virtual/Bar#foo (; 23 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  block $switch$1$case$4
   block $switch$1$case$3
    block $switch$1$default
     local.get $0
   ...
   local.get $0
   call $class-overloading-virtual/Bar#foo~virtual
   return
  end
  local.get $0
  call $class-overloading-virtual/Baa#foo
  return
 )
