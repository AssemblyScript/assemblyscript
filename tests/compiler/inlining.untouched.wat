(module
 ...
 (func $inlining/recursive_b (; 4 ;) (type $iv) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  if
   local.get $0
   call $inlining/recursive_a
  end
 )
 (func $inlining/recursive_a (; 5 ;) (type $iv) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  if
 ...
 (func $inlining/test_recursive (; 6 ;) (type $v)
  (local $0 i32)
  i32.const 0
  local.set $0
  local.get $0
