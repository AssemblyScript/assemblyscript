(module
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32)
  ...
  if
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/rt/itcms/__renew$299
    i32.const 1073741820
    local.get $2
    i32.const 1
    i32.shl
    ...
    if
     ...
     local.get $2
     local.set $1
     br $__inlined_func$~lib/rt/itcms/__renew$299
    end
    local.get $3
    local.get $4
    i32.load offset=12
 ...
 (func $~lib/string/String.__eq (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   block $__inlined_func$~lib/util/string/compareImpl$215
    loop $while-continue|1
     ...
     if
      ...
      local.get $5
      i32.ne
      br_if $__inlined_func$~lib/util/string/compareImpl$215
      local.get $2
      i32.const 2
      i32.add
      local.set $2
 ...
 (func $closure-stress/mutateStringRef~anonymous|0 (param $0 i32)
  ...
  block $folding-inner0
   ...
   local.tee $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$374
    local.get $0
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 3936
     local.set $0
     br $__inlined_func$~lib/string/String#concat$374
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
