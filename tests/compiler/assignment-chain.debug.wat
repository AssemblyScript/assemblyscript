(module
 ...
 (func $assignment-chain/A#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assignment-chain/A#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $assignment-chain/A#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assignment-chain/B#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assignment-chain/B#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $assignment-chain/B#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
