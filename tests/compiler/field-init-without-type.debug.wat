(module
 ...
 (func $field-init-without-type/A#set:i (param $this i32) (param $i i32)
  local.get $this
  local.get $i
  i32.store
 )
 (func $field-init-without-type/A#set:d (param $this i32) (param $d f64)
  local.get $this
  local.get $d
  f64.store offset=8
 )
 (func $field-init-without-type/A#set:t (param $this i32) (param $t i32)
  local.get $this
  local.get $t
  i32.store8 offset=16
 )
 (func $field-init-without-type/A#set:f (param $this i32) (param $f i32)
  local.get $this
  local.get $f
  i32.store8 offset=17
 )
 (func $start:field-init-without-type
  memory.size
  i32.const 16
  i32.shl
  global.get $~lib/memory/__heap_base
  ...
  global.set $~lib/rt/itcms/fromSpace
  i32.const 0
  call $field-init-without-type/A#constructor
  drop
 )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $field-init-without-type/A
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $field-init-without-type/A $invalid
       end
       return
      end
      return
 ...
 (func $~start
  call $start:field-init-without-type
 )
 (func $~stack_check
  global.get $~lib/memory/__stack_pointer
 ...
 (func $field-init-without-type/A#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $1
  i32.const 1
  call $field-init-without-type/A#set:i
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  local.get $1
  ...
  local.get $1
  f64.const 1
  call $field-init-without-type/A#set:d
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  local.get $1
  ...
  local.get $1
  i32.const 1
  call $field-init-without-type/A#set:t
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  local.get $1
  ...
  local.get $1
  i32.const 0
  call $field-init-without-type/A#set:f
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
