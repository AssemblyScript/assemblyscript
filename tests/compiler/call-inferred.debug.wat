(module
 ...
 (global $~lib/util/dtoa/POW10_MINOR i32 (i32.const 264))
 (global $~lib/util/dtoa/POW10_MAJOR i32 (i32.const 488))
 (global $~lib/util/dtoa/POW10_FIXUPS i32 (i32.const 856))
 ...
 (global $~lib/util/dtoa/SCRATCH i32 (i32.const 944))
 (global $~lib/util/dtoa/POW10_FLOAT_HI i32 (i32.const 1072))
 (global $~lib/util/dtoa/H37 i32 (i32.const 1688))
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2192))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34960))
 (global $~lib/memory/__heap_base i32 (i32.const 34960))
 (memory $0 1)
