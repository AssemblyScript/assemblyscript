(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 1392))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34160))
 (global $~lib/memory/__heap_base i32 (i32.const 34160))
 (memory $0 1)
