(module
 ...
 (memory $0 1)
 (data (i32.const 1036) "<")
 (data (i32.const 1052) " \00\00\00\01\00\00\00\02\00\00\00\03\00\00\00\04\00\00\00\05\00\00\00\06\00\00\00\07\00\00\00\08")
 (data (i32.const 1100) "<")
 ...
 (data (i32.const 1512) "\04\00\00\00\08\00\00\00\01")
 (data (i32.const 1532) ",")
 (data (i32.const 1544) "\01\00\00\00\0e\00\00\00v\00o\00i\00d\00.\00t\00s")
 ...
 (func $start:void~anonymous|0 (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  global.set $void/foo
 )
    ...
    block $~lib/function/Function<%28i32%2Ci32%2C~lib/array/Array<i32>%29=>void>
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $~lib/function/Function<%28i32%2Ci32%2C~lib/array/Array<i32>%29=>void> $invalid
      end
      return
     end
     return
