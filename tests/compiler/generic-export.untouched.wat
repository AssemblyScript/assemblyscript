(module
 ...
 (export "genericExample<i32>" (func $generic-export/genericExample<i32>))
 ...
 (func $generic-export/okFunction (; 6 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 2
  i32.const 2
 ...
 (func $generic-export/OkClass#one (; 7 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 1
 )
 (func $generic-export/genericExample<i32> (; 8 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 2
  i32.const 2
 ...
 (func $generic-export/functionThatUsesGenericFunction (; 9 ;) (type $FUNCSIG$i) (result i32)
  i32.const 1
  i32.const 1
  call $generic-export/genericExample<i32>
 )
