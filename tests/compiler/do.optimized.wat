(module
 ...
 (func $do/Ref#constructor (; 28 ;) (result i32)
  (local $0 i32)
  i32.const 0
  i32.const 3
 ...
 (func $~lib/rt/tlsf/__free (; 31 ;) (param $0 i32)
  local.get $0
  i32.const 15
  i32.and
  i32.eqz
 ...
 (func $~lib/rt/pure/appendRoot (; 33 ;) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.tee $1
 ...
 (func $~lib/rt/pure/__release (; 35 ;) (param $0 i32)
  local.get $0
  i32.const 356
  i32.gt_u
  if
