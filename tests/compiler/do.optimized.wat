(module
 ...
 (data (i32.const 1260) "\18\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\18\00\00\00i\00n\00 \00f\00r\00o\00m\00S\00p\00a\00c\00e")
 (data (i32.const 1308) "\14\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\14\00\00\00i\00n\00 \00t\00o\00S\00p\00a\00c\00e")
 (data (i32.const 1356) "\n\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\n\00\00\00d\00o\00.\00t\00s")
 (data (i32.const 1392) "\04")
 ...
 (func $~lib/rt/tcms/__collect (param $0 i32)
  local.get $0
  if
   block $__inlined_func$~lib/rt/tcms/collectIncremental
    global.get $~lib/rt/tcms/total
    global.get $~lib/rt/tcms/threshold
    i32.lt_u
    br_if $__inlined_func$~lib/rt/tcms/collectIncremental
    global.get $~lib/rt/tcms/total
    global.get $~lib/rt/tcms/threshold
    i32.sub
    global.set $~lib/rt/tcms/debt
    ...
    loop $do-continue|0
     ...
     if
      ...
      br $__inlined_func$~lib/rt/tcms/collectIncremental
     end
     local.get $0
     i32.const 0
     i32.gt_s
