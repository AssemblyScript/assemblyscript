(module
 ...
 (global $~lib/util/dtoa/POW10_MINOR i32 (i32.const 136))
 (global $~lib/util/dtoa/POW10_MAJOR i32 (i32.const 360))
 (global $~lib/util/dtoa/POW10_FIXUPS i32 (i32.const 728))
 ...
 (global $~lib/util/dtoa/SCRATCH i32 (i32.const 816))
 (global $~lib/util/dtoa/POW10_FLOAT_HI i32 (i32.const 944))
 (global $~lib/util/dtoa/H37 i32 (i32.const 1560))
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2256))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 35024))
 (global $~lib/memory/__heap_base i32 (i32.const 35024))
 (memory $0 1)
