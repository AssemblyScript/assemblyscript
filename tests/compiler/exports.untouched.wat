(module
 ...
 (export "vehicles.Car#get:doors" (func $export:exports/vehicles.Car#get:doors))
 (export "vehicles.Car#set:doors" (func $export:exports/vehicles.Car#set:doors))
 (export "vehicles.Car#constructor" (func $export:exports/vehicles.Car#constructor@varargs))
 (export "vehicles.Car#get:numDoors" (func $export:exports/vehicles.Car#get:numDoors))
 (export "vehicles.Car#set:numDoors" (func $export:exports/vehicles.Car#set:numDoors))
 (export "vehicles.Car#openDoors" (func $export:exports/vehicles.Car#openDoors))
 (start $~start)
