(module
 ...
 (func $exports/math.sub (; 2 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  get_local $0
  get_local $1
  i32.sub
 )
 (func $exports/Car.getNumTires (; 3 ;) (; has Stack IR ;) (type $i) (result i32)
 ...
 (func $exports/Car#constructor (; 6 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  get_local $0
  if (result i32)
   get_local $0
 ...
 (func $exports/Car#get:numDoors (; 7 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  get_local $0
  i32.load
 )
 (func $exports/Car#set:numDoors (; 8 ;) (; has Stack IR ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
  i32.store
 )
 (func $exports/Car#openDoors (; 9 ;) (; has Stack IR ;) (type $iv) (param $0 i32)
  nop
 )
 (func $exports/vehicles.Car.getNumTires (; 10 ;) (; has Stack IR ;) (type $i) (result i32)
  get_global $exports/vehicles.Car.TIRES
 )
 (func $exports/vehicles.Car#constructor (; 11 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  get_local $0
  if (result i32)
   get_local $0
 ...
 (func $exports/vehicles.Car#get:numDoors (; 12 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  get_local $0
  i32.load
 )
 (func $exports/vehicles.Car#set:numDoors (; 13 ;) (; has Stack IR ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
  i32.store
 )
 (func $exports/vehicles.Car#openDoors (; 14 ;) (; has Stack IR ;) (type $iv) (param $0 i32)
  nop
 )
 ...
 (func $null (; 16 ;) (; has Stack IR ;) (type $v)
 )
 (func $exports/subOpt|trampoline (; 17 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  block $1of1
   block $0of1
    block $outOfRange
     get_global $~argc
 ...
 (func $~setargc (; 18 ;) (; has Stack IR ;) (type $iv) (param $0 i32)
  get_local $0
  set_global $~argc
 )
 (func $exports/Car#constructor|trampoline (; 19 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  block $1of1
   block $0of1
    block $outOfRange
     get_global $~argc
 ...
 (func $Car#get:doors (; 20 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  get_local $0
  i32.load
 )
 (func $Car#set:doors (; 21 ;) (; has Stack IR ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
  i32.store
 )
 (func $exports/vehicles.Car#constructor|trampoline (; 22 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  block $1of1
   block $0of1
    block $outOfRange
     get_global $~argc
 ...
 (func $vehicles.Car#get:doors (; 23 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  get_local $0
  i32.load
 )
 (func $vehicles.Car#set:doors (; 24 ;) (; has Stack IR ;) (type $iiv) (param $0 i32) (param $1 i32)
  get_local $0
  get_local $1
  i32.store
 )
