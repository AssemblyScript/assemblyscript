(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 16876))
 (global $~lib/memory/__heap_base i32 (i32.const 16876))
 (memory $0 1)
     ...
     block $~lib/arraybuffer/ArrayBufferView
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load $0
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $getter-call/C $~lib/function/Function<%28%29=>i32> $invalid
       end
       return
      end
      return
 ...
 (func $getter-call/C#constructor (type $i32_=>_i32) (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
