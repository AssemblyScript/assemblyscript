(module
 ...
 (start $~start)
 (func $~lib/math/ipow32 (; 0 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  i32.const 1
 ...
 (func $~lib/math/NativeMathf.pow (; 3 ;) (param $0 f32) (param $1 f32) (result f32)
  (local $2 f32)
  (local $3 f32)
  (local $4 i32)
  (local $5 i32)
