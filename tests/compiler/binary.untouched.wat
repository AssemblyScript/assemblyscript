(module
 ...
 (start $start)
 (func $~lib/util/math/pow_lut (; 0 ;) (type $FUNCSIG$ddd) (param $0 f64) (param $1 f64) (result f64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $~lib/util/math/powf_lut (; 3 ;) (type $FUNCSIG$fff) (param $0 f32) (param $1 f32) (result f32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
