(module
 ...
 (data (i32.const 32) "\10\00\00\00\01\00\00\00\03\00\00\00\10\00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data (i32.const 160) "\1e\00\00\00\01\00\00\00\01\00\00\00\1e\00\00\00~\00l\00i\00b\00/\00r\00t\00/\00s\00t\00u\00b\00.\00t\00s\00")
 (table $0 1 funcref)
 (global $empty/initializedArray i32 (i32.const 48))
 ...
 (func $~lib/rt/stub/__retain (; 7 ;) (param $0 i32) (result i32)
  local.get $0
 )
 (func $~lib/array/ensureSize (; 8 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $~lib/array/Array<i32>#push (; 9 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $empty/willFail (; 10 ;)
  global.get $empty/initializedArray
  i32.const 1
