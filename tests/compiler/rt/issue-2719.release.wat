(module
 ...
 (data $19.1 (i32.const 3416) "\02\00\00\00 \00\00\00r\00t\00/\00i\00s\00s\00u\00e\00-\002\007\001\009\00.\00t\00s")
 (data $20 (i32.const 3472) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$137
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1120
     local.set $0
     br $__inlined_func$~lib/string/String#concat$137
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
