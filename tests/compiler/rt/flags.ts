...
function test<T>(flags: TypeinfoFlags): void {
	assert(__typeinfo(idof<T>()) == flags);
}
...
const VALUE_ALIGN_REF =
	sizeof<usize>() == 4
		? TypeinfoFlags.VALUE_ALIGN_2
		: TypeinfoFlags.VALUE_ALIGN_3;
const KEY_ALIGN_REF =
	sizeof<usize>() == 4 ? TypeinfoFlags.KEY_ALIGN_2 : TypeinfoFlags.KEY_ALIGN_3;
...
test<Array<Ref>>(
	TypeinfoFlags.ARRAY | VALUE_ALIGN_REF | TypeinfoFlags.VALUE_MANAGED,
);
test<Array<Ref | null>>(
	TypeinfoFlags.ARRAY |
		VALUE_ALIGN_REF |
		TypeinfoFlags.VALUE_NULLABLE |
		TypeinfoFlags.VALUE_MANAGED,
);

test<Set<i8>>(
	TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_0 | TypeinfoFlags.VALUE_SIGNED,
);
test<Set<u8>>(TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_0);
test<Set<i16>>(
	TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_1 | TypeinfoFlags.VALUE_SIGNED,
);
test<Set<u16>>(TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_1);
test<Set<i32>>(
	TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_2 | TypeinfoFlags.VALUE_SIGNED,
);
test<Set<u32>>(TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_2);
test<Set<i64>>(
	TypeinfoFlags.SET | TypeinfoFlags.VALUE_ALIGN_3 | TypeinfoFlags.VALUE_SIGNED,
);
...
test<Set<Ref>>(
	TypeinfoFlags.SET | VALUE_ALIGN_REF | TypeinfoFlags.VALUE_MANAGED,
);
test<Set<Ref | null>>(
	TypeinfoFlags.SET |
		VALUE_ALIGN_REF |
...
test<Map<i64, i16>>(
	TypeinfoFlags.MAP |
		TypeinfoFlags.KEY_ALIGN_3 |
		TypeinfoFlags.KEY_SIGNED |
		TypeinfoFlags.VALUE_ALIGN_1 |
		TypeinfoFlags.VALUE_SIGNED,
);
test<Map<i32, i32>>(
	TypeinfoFlags.MAP |
		TypeinfoFlags.KEY_ALIGN_2 |
		TypeinfoFlags.KEY_SIGNED |
		TypeinfoFlags.VALUE_ALIGN_2 |
		TypeinfoFlags.VALUE_SIGNED,
);
...
test<Map<Ref, i8>>(
	TypeinfoFlags.MAP |
		KEY_ALIGN_REF |
		TypeinfoFlags.KEY_MANAGED |
		TypeinfoFlags.VALUE_ALIGN_0 |
		TypeinfoFlags.VALUE_SIGNED,
);
test<Map<Ref | null, i8>>(
	TypeinfoFlags.MAP |
		KEY_ALIGN_REF |
		TypeinfoFlags.KEY_NULLABLE |
		TypeinfoFlags.KEY_MANAGED |
		TypeinfoFlags.VALUE_ALIGN_0 |
		TypeinfoFlags.VALUE_SIGNED,
);
test<Map<i8, Ref>>(
	TypeinfoFlags.MAP |
		TypeinfoFlags.KEY_ALIGN_0 |
		TypeinfoFlags.KEY_SIGNED |
		TypeinfoFlags.VALUE_MANAGED |
		VALUE_ALIGN_REF,
);
test<Map<i8, Ref | null>>(
	TypeinfoFlags.MAP |
		TypeinfoFlags.KEY_ALIGN_0 |
		TypeinfoFlags.KEY_SIGNED |
		TypeinfoFlags.VALUE_NULLABLE |
