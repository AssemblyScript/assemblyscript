(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2168))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34936))
 (global $~lib/memory/__heap_base i32 (i32.const 34936))
 (memory $0 1)
 ...
 (data $15 (i32.const 2076) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00 \00\00\00r\00t\00/\00i\00s\00s\00u\00e\00-\002\007\001\009\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $16 (i32.const 2144) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $rt/issue-2719/issue2719_T
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $rt/issue-2719/issue2719_T $invalid
       end
       return
      end
      return
 ...
 (func $rt/issue-2719/issue2719_f1 (param $a i32) (param $t i32) (param $b i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $3
  call $rt/issue-2719/issue2719_T#get:v
  i32.const 0
  i32.eq
  i32.eqz
  if
 ...
 (func $start:rt/issue-2719
  ...
  call $rt/issue-2719/issue2719_f1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
