(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2152))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34920))
 (global $~lib/memory/__heap_base i32 (i32.const 34920))
 ...
 (data $14 (i32.const 2012) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1c\00\00\00r\00t\00/\00f\00i\00n\00a\00l\00i\00z\00e\00.\00t\00s\00")
 ...
 (data $16 (i32.const 2128) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $rt/finalize/__finalize (param $ptr i32)
  local.get $ptr
 ...
 (func $start:rt/finalize
  ...
  global.set $~lib/rt/itcms/fromSpace
  i32.const 0
  call $rt/finalize/Ref#constructor
  global.set $rt/finalize/expect
  call $~lib/rt/itcms/__collect
  global.get $rt/finalize/ran
  i32.eqz
  if
   i32.const 0
   i32.const 2032
