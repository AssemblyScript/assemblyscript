(module
 ...
 (func $bindings/esm/typedarrayFunction (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner1
   ...
   i32.store offset=4
   local.get $7
   block $__inlined_func$~lib/arraybuffer/ArrayBufferView#constructor$1 (result i32)
    global.get $~lib/memory/__stack_pointer
    i32.const 16
    i32.sub
    global.set $~lib/memory/__stack_pointer
    block $folding-inner00
     ...
     global.set $~lib/memory/__stack_pointer
     local.get $2
     br $__inlined_func$~lib/arraybuffer/ArrayBufferView#constructor$1
    end
    br $folding-inner1
   end
   local.tee $2
 ...
 (func $~lib/array/Array<i32>#constructor|default (param $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $bindings/esm/arrayOfStringsFunction (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
