(module
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32)
  ...
  if
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/rt/itcms/__renew$264
    i32.const 1073741820
    local.get $2
    i32.const 1
    i32.shl
    ...
    if
     ...
     local.get $2
     local.set $1
     br $__inlined_func$~lib/rt/itcms/__renew$264
    end
    local.get $3
    local.get $4
    i32.load offset=12
 ...
 (func $bindings/esm/stringFunction (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$287
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1760
     local.set $2
     br $__inlined_func$~lib/string/String#concat$287
    end
    global.get $~lib/memory/__stack_pointer
    local.get $2
    i32.const 2
 ...
 (func $export:bindings/esm/objectFunction (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner1
   ...
   i32.store offset=8
   global.get $~lib/memory/__stack_pointer
   block $__inlined_func$bindings/esm/PlainObject#constructor$2 (result i32)
    global.get $~lib/memory/__stack_pointer
    i32.const 8
    i32.sub
    global.set $~lib/memory/__stack_pointer
    block $folding-inner00
     ...
     global.set $~lib/memory/__stack_pointer
     local.get $2
     br $__inlined_func$bindings/esm/PlainObject#constructor$2
    end
    br $folding-inner1
   end
   local.tee $2
