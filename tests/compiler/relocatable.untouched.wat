(module
 ...
 (func $~lib/array/Array<i32>#__unchecked_get (; 6 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  global.get $__memory_base
  global.get $__memory_base
  local.get $0
  i32.add
 ...
 (func $~lib/array/Array<i32>#__get (; 7 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $1
  global.get $__memory_base
  local.get $0
