(module
 ...
 (data (i32.const 1624) "\01\00\00\00\04\00\00\001\001")
 (data (i32.const 1648) "\t\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1676) "\02\19")
 (data (i32.const 1692) " \00\00\00\00\00\00\00 ")
 (table $0 2 funcref)
       ...
       block $~lib/arraybuffer/ArrayBufferView
        block $~lib/string/String
         block $~lib/arraybuffer/ArrayBuffer
          ...
          i32.sub
          i32.load
          br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/array/Array<f32> $folding-inner0 $infer-generic/Ref $infer-generic/Ref2<~lib/string/String> $folding-inner0 $folding-inner0 $invalid
         end
         return
        end
        return
