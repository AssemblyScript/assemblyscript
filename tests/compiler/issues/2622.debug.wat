(module
 ...
 (global $issues/2622/_a/t1 (mut i32) (i32.const 0))
 (global $issues/2622/a (mut i32) (i32.const 0))
 (global $issues/2622/_b/t2 (mut i32) (i32.const 0))
 (global $issues/2622/b (mut i32) (i32.const 0))
 (global $~lib/rt/__rtti_base i32 (i32.const 2080))
 (global $~lib/memory/__data_end i32 (i32.const 2108))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34876))
 (global $~lib/memory/__heap_base i32 (i32.const 34876))
 (memory $0 1)
 ...
 (data $15 (i32.const 2080) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $start:issues/2622/_a
  ...
  global.set $~lib/rt/itcms/fromSpace
  i32.const 0
  call $issues/2622/_a/T1#constructor
  global.set $issues/2622/_a/t1
 )
 (func $start:issues/2622
  call $start:issues/2622/_a
  global.get $issues/2622/_a/t1
  global.set $issues/2622/a
  i32.const 0
  call $issues/2622/_b/T2#constructor
  global.set $issues/2622/_b/t2
 ...
 (func $issues/2622/_a/T1#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
 ...
 (func $issues/2622/_b/T2#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
