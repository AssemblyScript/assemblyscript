(module
 ...
 (data (i32.const 1532) "|")
 (data (i32.const 1544) "\02\00\00\00^\00\00\00E\00l\00e\00m\00e\00n\00t\00 \00t\00y\00p\00e\00 \00m\00u\00s\00t\00 \00b\00e\00 \00n\00u\00l\00l\00a\00b\00l\00e\00 \00i\00f\00 \00a\00r\00r\00a\00y\00 \00i\00s\00 \00h\00o\00l\00e\00y")
 (data (i32.const 1660) ",")
 (data (i32.const 1672) "\02\00\00\00\1c\00\00\00i\00s\00s\00u\00e\00s\00/\001\006\009\009\00.\00t\00s")
 (data (i32.const 1712) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\02A")
      ...
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        block $~lib/object/Object
         ...
         i32.sub
         i32.load $0
         br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $issues/1699/MultiAssignmentTest $~lib/array/Array<issues/1699/MultiAssignmentTest> $invalid
        end
        return
       end
       return
 ...
 (func $~start (type $none_=>_none)
  ...
  (local $2 i32)
  (local $3 i32)
  block $__inlined_func$start:issues/1699
   memory.size $0
   i32.const 16
   i32.shl
   i32.const 34508
   ...
   block $folding-inner0
    ...
    i32.add
    global.set $~lib/memory/__stack_pointer
    br $__inlined_func$start:issues/1699
   end
   i32.const 34528
   i32.const 34576
   i32.const 1
 ...
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#__get (type $i32_i32_=>_i32) (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
