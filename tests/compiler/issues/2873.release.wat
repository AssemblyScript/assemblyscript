  ...
  block $folding-inner1
   block $folding-inner0
    ...
    if
     ...
     i32.const 1056
     local.set $0
     block $~lib/util/number/dtoa_impl|inlined.2
      local.get $5
      f64.promote_f32
      local.tee $3
      f64.const 0
      f64.eq
      br_if $~lib/util/number/dtoa_impl|inlined.2
      local.get $3
      local.get $3
      f64.sub
      f64.const 0
  ...
  block $folding-inner1
   block $folding-inner0
    ...
    if
     ...
     i32.const 1056
     local.set $0
     block $~lib/util/number/dtoa_impl|inlined.3
      local.get $3
      f64.const 0
      f64.eq
      br_if $~lib/util/number/dtoa_impl|inlined.3
      local.get $3
      local.get $3
      f64.sub
      f64.const 0
