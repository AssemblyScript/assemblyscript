(module
 ...
 (type $4 (func (param i32 f32) (result i32)))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 46300))
 (memory $0 1)
 ...
 (func $~lib/util/xjb/ftoa/ftoa_buffered (param $0 i32) (param $1 f32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $~lib/util/xjb/dtoa/dtoa_buffered (param $0 i32) (param $1 f64) (result i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $~lib/util/number/dtoa_buffered<f64> (param $0 i32) (param $1 f64) (result i32)
  ...
  i32.add
  local.set $3
  block $~lib/util/number/dtoa_dotZero|inlined.3
   loop $while-continue|0
    local.get $0
    local.get $3
    i32.lt_u
    if
     ...
     i32.ne
     i32.and
     br_if $~lib/util/number/dtoa_dotZero|inlined.3
     local.get $0
     i32.const 2
     i32.add
     local.set $0
