(module
 ...
 (data (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00&\00\00\00i\00s\00s\00u\00e\00s\00/\002\006\002\002\00/\002\006\002\002\00.\00t\00s\00\00\00\00\00\00\00")
 (data (i32.const 480) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $issues/2622/node_modules_a/T#set:t_in_node_module_a (param $this i32) (param $t_in_node_module_a i32)
  local.get $this
  local.get $t_in_node_module_a
  i32.store $0
 )
 (func $issues/2622/node_modules_a/T#get:t_in_node_module_a (param $this i32) (result i32)
  local.get $this
  i32.load $0
 )
 ...
 (func $issues/2622/node_modules_a/T#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $1
  i32.const 1
  call $issues/2622/node_modules_a/T#set:t_in_node_module_a
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $start:issues/2622/2622
  ...
  global.set $~lib/rt/itcms/fromSpace
  i32.const 0
  call $issues/2622/node_modules_a/T#constructor
  ...
  i32.store $0
  local.get $0
  call $issues/2622/node_modules_a/T#get:t_in_node_module_a
  i32.const 1
  i32.eq
  i32.eqz
  if
