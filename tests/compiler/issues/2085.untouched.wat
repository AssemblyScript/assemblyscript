(module
 ...
 (global $issues/2085/foo (mut i32) (i32.const 0))
 ...
 (func $start:issues/2085
  ...
  global.get $~lib/memory/__stack_pointer
  i32.const 0
  call $issues/2085/Foo#constructor
  local.tee $0
  i32.store
  local.get $0
  global.set $issues/2085/foo
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
    ...
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $issues/2085/Foo $invalid
      end
      return
     end
     return
 ...
 (func $issues/2085/Foo#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
