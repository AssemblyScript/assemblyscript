(module
 ...
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#set:buffer (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0
  local.get $this
 ...
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#set:dataStart (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0 offset=4
 )
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#set:byteLength (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0 offset=8
 )
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#set:length_ (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0 offset=12
 )
 (func $issues/1699/MultiAssignmentTest#set:test (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0
 )
