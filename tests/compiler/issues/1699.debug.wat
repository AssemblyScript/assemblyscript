(module
 ...
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $~lib/array/Array<issues/1699/MultiAssignmentTest>#constructor (param $this i32) (param $length i32) (result i32)
  ...
  i32.store offset=4
  local.get $6
  call $~lib/array/Array<issues/1699/MultiAssignmentTest>#constructor|default
  local.get $length
  i32.const 1073741820
  i32.const 2
  i32.shr_u
 ...
 (func $issues/1699/MultiAssignmentTest#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $issues/1699/MultiAssignmentTest#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $issues/1699/MultiAssignmentTest#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
