(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2104))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34872))
 (global $~lib/memory/__heap_base i32 (i32.const 34872))
 (memory $0 1)
 ...
 (data $15 (i32.const 2080) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $issues/2322/index/test
  ...
  i32.store
  i32.const 0
  call $issues/2322/lib/Wrapper<i32>#constructor
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
  i32.store
  local.get $0
  call $issues/2322/lib/test<i32>
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
