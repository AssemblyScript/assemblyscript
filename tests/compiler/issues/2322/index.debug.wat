(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 65988))
 (global $~lib/memory/__heap_base i32 (i32.const 65988))
 (memory $0 2)
 ...
 (func $issues/2322/lib/Wrapper<i32>#set:v (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0
 )
