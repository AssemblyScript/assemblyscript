(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 436))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33204))
 (global $~lib/memory/__heap_base i32 (i32.const 33204))
 (memory $0 1)
 ...
 (data (i32.const 416) "\04\00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $issues/2322/lib/Wrapper<i32>#set:v (type $i32_i32_=>_none) (param $this i32) (param $v i32)
  local.get $this
  local.get $v
  i32.store $0
 )
 (func $issues/2322/lib/test<i32> (type $i32_=>_none) (param $t i32)
  nop
 )
    ...
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load $0
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $issues/2322/lib/Wrapper<i32> $invalid
      end
      return
     end
     return
 ...
 (func $issues/2322/lib/Wrapper<i32>#constructor (type $i32_=>_i32) (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
