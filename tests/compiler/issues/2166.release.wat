(module
 ...
 (data $19.1 (i32.const 3416) "\02\00\00\00\04\00\00\001\001")
 (data $20 (i32.const 3436) "\1c")
 (data $20.1 (i32.const 3448) "\02\00\00\00\0c\00\00\00S\00t\00r\00i\00n\00g")
 (data $21 (i32.const 3468) ",")
 (data $21.1 (i32.const 3480) "\02\00\00\00\1c\00\00\00i\00s\00s\00u\00e\00s\00/\002\001\006\006\00.\00t\00s")
 (data $22 (i32.const 3516) "\1c")
 (data $22.1 (i32.const 3528) "\02\00\00\00\06\00\00\00i\003\002")
 (data $23 (i32.const 3548) ",")
 (data $23.1 (i32.const 3560) "\02\00\00\00\12\00\00\00t\00e\00s\00t\00-\002\001\006\006")
 (data $24 (i32.const 3600) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$140
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1120
     local.set $0
     br $__inlined_func$~lib/string/String#concat$140
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
