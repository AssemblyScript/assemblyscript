(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36236))
 (memory $0 1)
 ...
 (data $20 (i32.const 3440) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
 (table $0 2 2 funcref)
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$133
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1120
     local.set $0
     br $__inlined_func$~lib/string/String#concat$133
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
