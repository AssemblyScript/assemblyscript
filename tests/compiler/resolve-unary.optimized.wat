(module
 ...
 (func $~lib/util/number/utoa_simple<u32> (; 3 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  loop $continue|0
   local.get $1
   i32.const 10
 ...
 (func $~lib/number/Bool#toString (; 8 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  i32.const 168
  i32.const 192
  local.get $0
  select
 )
 (func $start:resolve-unary (; 9 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 432
