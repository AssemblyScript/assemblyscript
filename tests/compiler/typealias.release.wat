(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36352))
 (memory $0 1)
 ...
 (data $20.1 (i32.const 3448) "\02\00\00\00\18\00\00\00t\00y\00p\00e\00a\00l\00i\00a\00s\00.\00t\00s")
 (data $21 (i32.const 3484) "\1c")
 (data $21.1 (i32.const 3496) "\02\00\00\00\06\00\00\00f\006\004")
 (data $22 (i32.const 3516) "\1c")
 (data $22.1 (i32.const 3528) "\04\00\00\00\08\00\00\00\01")
 (data $23 (i32.const 3552) "\07\00\00\00 \00\00\00 \00\00\00 ")
 (data $23.1 (i32.const 3576) "\02\t\00\00\02\n")
 (table $0 2 2 funcref)
       ...
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         block $~lib/object/Object
          ...
          i32.sub
          i32.load
          br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/function/Function<%28%29=>void> $~lib/array/Array<i32> $~lib/array/Array<i64> $invalid
         end
         return
        end
        return
