(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36444))
 ...
 (data $21 (i32.const 3468) "L")
 (data $21.1 (i32.const 3480) "\02\00\00\002\00\00\00c\00l\00a\00s\00s\00-\00o\00v\00e\00r\00l\00o\00a\00d\00i\00n\00g\00-\00c\00a\00s\00t\00.\00t\00s")
 (data $22 (i32.const 3548) "\1c")
 (data $22.1 (i32.const 3560) "\02\00\00\00\02\00\00\00a")
 (data $23 (i32.const 3580) "\1c")
 (data $23.1 (i32.const 3592) "\02\00\00\00\02\00\00\00D")
 (data $24 (i32.const 3616) "\0e\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$158
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1120
     local.set $0
     br $__inlined_func$~lib/string/String#concat$158
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
 ...
 (func $start:class-overloading-cast
  ...
  block $folding-inner0
   ...
   global.get $~lib/memory/__stack_pointer
   block $__inlined_func$class-overloading-cast/A<i32>#foo@override$147 (result i32)
    global.get $~lib/memory/__stack_pointer
    global.get $class-overloading-cast/v
    local.tee $0
    i32.store offset=4
    block $default
     block $case1
      ...
      i32.const 3456
      br $__inlined_func$class-overloading-cast/A<i32>#foo@override$147
     end
     i32.const 3456
     br $__inlined_func$class-overloading-cast/A<i32>#foo@override$147
    end
   ...
   global.get $~lib/memory/__stack_pointer
   block $__inlined_func$class-overloading-cast/A<f64>#foo@override$148 (result i32)
    global.get $~lib/memory/__stack_pointer
    global.get $class-overloading-cast/v3
    local.tee $0
    i32.store offset=4
    ...
    i32.const 7
    i32.eq
    br_if $__inlined_func$class-overloading-cast/A<f64>#foo@override$148
    drop
    i32.const 3424
   end
   local.tee $0
