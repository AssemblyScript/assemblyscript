(module
 ...
 (func $~start
  ...
  block $folding-inner0
   ...
   i64.const 0
   i64.store $0
   block $__inlined_func$~instanceof|managed-cast/Cat (result i32)
    local.get $1
    local.get $0
    i32.store $0 offset=4
    i32.const 0
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat
    drop
    i32.const 1
   end
   i32.eqz
   ...
   i32.const 0
   i32.store $0 offset=8
   block $__inlined_func$~instanceof|managed-cast/Cat4 (result i32)
    local.get $1
    local.get $0
    i32.store $0 offset=4
    local.get $0
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat4
    drop
    i32.const 1
   end
   i32.eqz
