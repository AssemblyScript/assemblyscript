(module
 ...
 (data (i32.const 56) "\04\00\00\00\01\00\00\00\01\00\00\00\04\00\00\00h\00i\00")
 (data (i32.const 80) "\04\00\00\00\01\00\00\00\01\00\00\00\04\00\00\00:\00 \00")
 (data (i32.const 104) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00n\00u\00l\00l\00")
 (table $0 1 funcref)
 ...
 (export "test" (func $features/exception-handling/test))
 ...
 (func $~lib/string/String#concat (; 9 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/string/String.__concat (; 10 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/stub/__retain
  drop
 ...
 (func $~lib/error/Error#toString (; 11 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $features/exception-handling/test (; 12 ;) (type $FUNCSIG$v)
  (local $0 exnref)
  (local $1 i32)
  (local $2 i32)
  try
