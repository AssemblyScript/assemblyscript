(module
 ...
 (data $10 (i32.const 1568) "\06\00\00\00 \00\00\00 \00\00\00 ")
 (table $~/lib/rt/visitor 6 6 funcref)
 (elem $~/lib/rt/visitor (i32.const 0) $features/reference-types-visit-member/foo $features/reference-types-visit-member/foo $features/reference-types-visit-member/foo $~lib/arraybuffer/ArrayBufferView~visit $~lib/arraybuffer/ArrayBufferView~visit $~lib/arraybuffer/ArrayBufferView~visit)
 ...
 (start $~start)
 (func $features/reference-types-visit-member/foo (param $0 i32) (param $1 i32)
 )
