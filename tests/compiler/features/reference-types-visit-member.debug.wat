(module
 ...
 (data $10 (i32.const 544) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $~/lib/rt/visitor 6 6 funcref)
 (table $0 1 1 funcref)
 (elem $~/lib/rt/visitor (table $~/lib/rt/visitor) (i32.const 0) func $~lib/object/Object~visit $~lib/object/Object~visit $~lib/object/Object~visit $~lib/arraybuffer/ArrayBufferView~visit $features/reference-types-visit-member/A~visit $features/reference-types-visit-member/B~visit)
 (elem $0 (table $0) (i32.const 1) func)
 ...
 (export "foo" (func $export:features/reference-types-visit-member/foo))
 (start $~start)
 (func $features/reference-types-visit-member/foo (param $a i32) (param $b i32)
 )
 ...
 (func $features/reference-types-visit-member/A~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  call $~lib/object/Object~visit
 ...
 (func $features/reference-types-visit-member/B~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  call $~lib/object/Object~visit
 ...
 (func $export:features/reference-types-visit-member/foo (param $0 i32) (param $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $0
  local.get $1
  call $features/reference-types-visit-member/foo
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
