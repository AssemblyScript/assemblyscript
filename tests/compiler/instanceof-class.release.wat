(module
 ...
 (data (i32.const 1436) "<")
 (data (i32.const 1448) "\01\00\00\00&\00\00\00i\00n\00s\00t\00a\00n\00c\00e\00o\00f\00-\00c\00l\00a\00s\00s\00.\00t\00s")
 (data (i32.const 1504) "\07\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1532) " \00\00\00\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\05")
 ...
 (func $~start (type $none_=>_none)
  (local $0 i32)
  (local $1 i32)
  block $__inlined_func$start:instanceof-class
   global.get $~lib/memory/__stack_pointer
   i32.const 4
   i32.sub
   ...
   block $folding-inner0
    ...
    local.get $0
    if (result i32)
     block $__inlined_func$~anyinstanceof|instanceof-class/Child (result i32)
      block $is_instance
       local.get $0
       i32.const 8
       i32.sub
       ...
       br_if $is_instance
       i32.const 0
       br $__inlined_func$~anyinstanceof|instanceof-class/Child
      end
      i32.const 1
     end
    else
    ...
    i32.add
    global.set $~lib/memory/__stack_pointer
    br $__inlined_func$start:instanceof-class
   end
   i32.const 34352
   i32.const 34400
   i32.const 1
