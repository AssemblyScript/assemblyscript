(module
 ...
 (data (i32.const 1696) "\t\00\00\00 \00\00\00 ")
 (data (i32.const 1728) "\02A\00\00\02A")
 ...
 (func $~lib/array/Array<extends-baseaggregate/B1>#__visit (type $i32_=>_none) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
