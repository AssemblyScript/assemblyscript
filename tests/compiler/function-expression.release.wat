(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36892))
 (memory $0 1)
 ...
 (data $20.1 (i32.const 3448) "\02\00\00\00,\00\00\00f\00u\00n\00c\00t\00i\00o\00n\00-\00e\00x\00p\00r\00e\00s\00s\00i\00o\00n\00.\00t\00s")
 (data $21 (i32.const 3500) "\1c")
 (data $21.1 (i32.const 3512) "\04\00\00\00\08\00\00\00\02")
 (data $22 (i32.const 3532) "\1c")
 (data $22.1 (i32.const 3544) "\05\00\00\00\08\00\00\00\03")
 (data $23 (i32.const 3564) "\1c")
 (data $23.1 (i32.const 3576) "\06\00\00\00\08\00\00\00\04")
 (data $24 (i32.const 3596) "\1c")
 (data $24.1 (i32.const 3608) "\07\00\00\00\08\00\00\00\05")
 (data $25 (i32.const 3628) "\1c")
 (data $25.1 (i32.const 3640) "\07\00\00\00\08\00\00\00\06")
 (data $26 (i32.const 3660) "\1c")
 (data $26.1 (i32.const 3672) "\07\00\00\00\08\00\00\00\07")
 (data $27 (i32.const 3692) "\1c")
 (data $27.1 (i32.const 3704) "\07\00\00\00\08\00\00\00\08")
 (data $28 (i32.const 3724) "\1c")
 (data $28.1 (i32.const 3736) "\07\00\00\00\08\00\00\00\t")
 (data $29 (i32.const 3756) "\1c")
 (data $29.1 (i32.const 3768) "\07\00\00\00\08\00\00\00\n")
 (data $30 (i32.const 3788) "\1c")
 (data $30.1 (i32.const 3800) "\06\00\00\00\08\00\00\00\0b")
 (data $31 (i32.const 3820) "\1c")
 (data $31.1 (i32.const 3832) "\04\00\00\00\08\00\00\00\0c")
 (data $32 (i32.const 3852) "\1c")
 (data $32.1 (i32.const 3864) "\08\00\00\00\08\00\00\00\r")
 (data $33 (i32.const 3884) "\1c")
 (data $33.1 (i32.const 3896) "\04\00\00\00\08\00\00\00\0e")
 (data $34 (i32.const 3916) "\1c")
 (data $34.1 (i32.const 3928) "\08\00\00\00\08\00\00\00\0f")
 (data $35 (i32.const 3948) "\1c")
 (data $35.1 (i32.const 3960) "\04\00\00\00\08\00\00\00\10")
 (data $36 (i32.const 3980) "\1c")
 (data $36.1 (i32.const 3992) "\08\00\00\00\08\00\00\00\11")
 (data $37 (i32.const 4012) "\1c")
 (data $37.1 (i32.const 4024) "\04\00\00\00\08\00\00\00\12")
 (data $38 (i32.const 4044) "\1c")
 (data $38.1 (i32.const 4056) "\04\00\00\00\08\00\00\00\13")
 (data $39 (i32.const 4080) "\n\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$151
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1152
     local.set $0
     br $__inlined_func$~lib/string/String#concat$151
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
