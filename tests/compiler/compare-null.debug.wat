(module
 ...
 (memory $0 1)
 (data $0 (i32.const 12) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\04\00\00\00a\00a\00\00\00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (export "compare_null_with_class" (func $export:compare-null/compare_null_with_class))
 (start $~start)
 ...
 (func $start:compare-null
  call $compare-null/compare_null_with_null
 )
 ...
 (func $compare-null/compare_null_with_nullable_class (param $a i32)
  i32.const 0
  local.get $a
  i32.eq
  drop
 ...
 (func $compare-null/compare_null_with_class (param $a i32)
  i32.const 0
  local.get $a
  i32.eq
  drop
 ...
 (func $export:compare-null/compare_null_with_nullable_class (param $0 i32)
  ...
  i32.store $0
  local.get $0
  call $compare-null/compare_null_with_nullable_class
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:compare-null/compare_null_with_class (param $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  i32.store $0
  local.get $0
  call $compare-null/compare_null_with_class
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
