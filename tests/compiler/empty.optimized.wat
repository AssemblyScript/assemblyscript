(module
 ...
 (global $empty/a (mut i32) (i32.const 0))
 ...
 (start $start)
 (func $empty/foo (; 1 ;) (type $FUNCSIG$i) (result i32)
  i32.const 24
 )
 ...
 (func $~lib/rt/pure/growRoots (; 8 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/pure/appendRoot (; 9 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.tee $1
 ...
 (func $~lib/rt/pure/decrement (; 10 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
  ...
  block $switch$1$case$5
   block $switch$1$case$3
    block $switch$1$default
     ...
     i32.sub
     i32.load
     br_table $switch$1$case$3 $switch$1$case$3 $switch$1$case$5 $switch$1$default
    end
    unreachable
   end
   return
 ...
 (func $~lib/rt/tlsf/__alloc (; 24 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/rt/tlsf/ROOT
  local.tee $1
  i32.eqz
