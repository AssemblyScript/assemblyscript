(module
 ...
 (func $~lib/allocator/tlsf/__mem_free (; 19 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
 ...
 (func $~lib/runtime/runtime.discard (; 20 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  i32.const 120
  i32.le_u
  if
 ...
 (func $~lib/collector/itcm/maybeInit (; 21 ;) (type $FUNCSIG$v)
  (local $0 i32)
 ...
 (func $~lib/collector/itcm/ManagedObjectList#push (; 22 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=12
  local.set $2
 ...
 (func $~lib/collector/itcm/__ref_register (; 23 ;) (type $FUNCSIG$vi) (param $0 i32)
 ...
 (func $~lib/runtime/runtime.register (; 24 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $0
  i32.const 120
  i32.le_u
 ...
 (func $~lib/collector/itcm/step (; 33 ;) (type $FUNCSIG$v)
  (local $0 i32)
  block $break|0
   block $case3|0
    block $case2|0
 ...
 (func $~lib/collector/itcm/__ref_collect (; 34 ;) (type $FUNCSIG$v)
  call $~lib/collector/itcm/maybeInit
  loop $continue|0
   global.get $~lib/collector/itcm/state
   i32.const 1
