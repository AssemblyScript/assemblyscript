(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 432))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33200))
 (global $~lib/memory/__heap_base i32 (i32.const 33200))
 (memory $0 1)
 ...
 (data (i32.const 416) "\03\00\00\00 \00\00\00 \00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
