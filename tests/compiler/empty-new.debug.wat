(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2100))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34868))
 (global $~lib/memory/__heap_base i32 (i32.const 34868))
 (memory $0 1)
 ...
 (data $15 (i32.const 2080) "\04\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
