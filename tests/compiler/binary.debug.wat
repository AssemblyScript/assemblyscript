(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 8320))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 41088))
 (global $~lib/memory/__heap_base i32 (i32.const 41088))
 (memory $0 1)
