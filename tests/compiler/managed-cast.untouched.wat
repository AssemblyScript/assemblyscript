(module
 ...
 (func $managed-cast/testDowncast (; 24 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $managed-cast/testDowncastFromNullable (; 25 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testDowncastToNullable (; 26 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testDowncastFromToNullable (; 27 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $~lib/rt/__instanceof (; 28 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $managed-cast/Cat#meow (; 29 ;) (param $0 i32)
  nop
 )
 (func $managed-cast/testUpcast (; 30 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testUpcastFromNullable (; 31 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testUpcastToNullable (; 32 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $managed-cast/testUpcastFromToNullable (; 33 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $~lib/rt/pure/appendRoot (; 37 ;) (param $0 i32)
  unreachable
 )
