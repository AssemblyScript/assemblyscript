(module
 ...
 (func $managed-cast/testDowncast (; 34 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $managed-cast/testDowncastFromNullable (; 35 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testDowncastToNullable (; 36 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testDowncastFromToNullable (; 37 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $~lib/rt/__instanceof (; 38 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $managed-cast/Cat#meow (; 39 ;) (param $0 i32)
  nop
 )
 (func $managed-cast/testUpcast (; 40 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testUpcastFromNullable (; 41 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $managed-cast/testUpcastToNullable (; 42 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $managed-cast/testUpcastFromToNullable (; 43 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
