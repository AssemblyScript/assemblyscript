(module
 ...
 (func $extends-baseaggregate/A1#set:padding0 (type $i32_f64_=>_none) (param $this i32) (param $value f64)
  local.get $this
  local.get $value
  f64.store $0
 )
 (func $extends-baseaggregate/A1#set:padding1 (type $i32_f64_=>_none) (param $this i32) (param $value f64)
  local.get $this
  local.get $value
 ...
 (func $extends-baseaggregate/A1#set:c1 (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0 offset=16
  local.get $this
 ...
 (func $~lib/array/Array<extends-baseaggregate/A2>#set:length_ (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0 offset=12
 )
