(module
 ...
 (memory $0 1)
 (data (i32.const 12) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\16\00\00\00i\00n\00l\00i\00n\00i\00n\00g\00.\00t\00s\00\00\00\00\00\00\00")
 (data (i32.const 60) "\1c\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\08\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data (i32.const 496) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00")
 (table $0 2 2 funcref)
 ...
 (func $inlining/Baz#set:b (type $i32_i32_=>_none) (param $this i32) (param $b i32)
  local.get $this
  local.get $b
 ...
 (func $inlining/Baz#set:a (type $i32_i32_=>_none) (param $this i32) (param $a i32)
  local.get $this
  local.get $a
  i32.store $0
 )
 (func $inlining/Bar#set:e (type $i32_i32_=>_none) (param $this i32) (param $e i32)
  local.get $this
  local.get $e
  i32.store $0 offset=12
 )
 (func $inlining/Bar#set:d (type $i32_i32_=>_none) (param $this i32) (param $d i32)
  local.get $this
  local.get $d
  i32.store $0 offset=8
 )
 (func $inlining/Baz#get:a (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0
 )
 (func $inlining/Baz#get:b (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0 offset=4
 )
 (func $inlining/Bar#get:d (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0 offset=8
 )
 (func $inlining/Bar#get:e (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0 offset=12
 )
