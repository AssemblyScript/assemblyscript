(module
 ...
 (export "Outer.InnerClass#constructor" (func $export:resolve-nested/Outer.InnerClass#constructor))
 (export "Outer.Inner.EvenInnerClass#constructor" (func $export:resolve-nested/Outer.Inner.EvenInnerClass#constructor))
 (export "Outer.Inner.evenInner" (func $export:resolve-nested/Outer.Inner.evenInner))
 (export "Outer.inner" (func $export:resolve-nested/Outer.inner))
      ...
      block $~lib/arraybuffer/ArrayBufferView
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         ...
         i32.sub
         i32.load
         br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $resolve-nested/OuterClass $resolve-nested/Outer.InnerClass $resolve-nested/Outer.Inner.EvenInnerClass $invalid
        end
        return
       end
       return
 ...
 (func $export:resolve-nested/Outer.InnerClass#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $resolve-nested/Outer.InnerClass#constructor
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $export:resolve-nested/Outer.Inner.EvenInnerClass#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $resolve-nested/Outer.Inner.EvenInnerClass#constructor
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $export:resolve-nested/Outer.Inner.evenInner (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 24
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $4
  local.get $5
  call $resolve-nested/Outer.Inner.evenInner
  global.get $~lib/memory/__stack_pointer
  i32.const 24
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:resolve-nested/Outer.inner (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 20
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $3
  local.get $4
  call $resolve-nested/Outer.inner
  global.get $~lib/memory/__stack_pointer
  i32.const 20
  i32.add
  global.set $~lib/memory/__stack_pointer
