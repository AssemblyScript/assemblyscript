(module
 ...
 (func $for/Ref#constructor (; 24 ;) (result i32)
  (local $0 i32)
  i32.const 0
  i32.const 3
 ...
 (func $for/testRefAutorelease (; 34 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  call $for/Ref#constructor
 ...
 (func $~lib/rt/pure/markGray (; 37 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/scanBlack (; 38 ;) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const -1879048193
 ...
 (func $~lib/rt/pure/scan (; 39 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/collectWhite (; 40 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
