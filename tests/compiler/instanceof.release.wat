(module
 ...
 (data $8.1 (i32.const 1448) "\02\00\00\00\1a\00\00\00i\00n\00s\00t\00a\00n\00c\00e\00o\00f\00.\00t\00s")
 (data $9 (i32.const 1488) "\18\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/rt/itcms/__visit (param $0 i32)
  ...
  if
   ...
   block $__inlined_func$~lib/rt/itcms/Object#unlink$248
    local.get $1
    i32.load offset=4
    i32.const -4
    i32.and
    ...
    if
     ...
     br $__inlined_func$~lib/rt/itcms/Object#unlink$248
    end
    local.get $1
    i32.load offset=8
    local.tee $2
 ...
 (func $"instanceof/assertDynamicTrue<~lib/object/Object,instanceof/IC>" (param $0 i32)
  ...
  local.get $0
  if (result i32)
   block $__inlined_func$~instanceof|instanceof/IC$84 (result i32)
    block $is_instance
     local.get $0
     i32.const 8
     i32.sub
     ...
     br_if $is_instance
     i32.const 0
     br $__inlined_func$~instanceof|instanceof/IC$84
    end
    i32.const 1
   end
  else
 ...
 (func $"instanceof/assertDynamicFalse<instanceof/IA,instanceof/IC>" (param $0 i32)
  ...
  local.get $0
  if (result i32)
   block $__inlined_func$~instanceof|instanceof/IC$90 (result i32)
    block $is_instance
     local.get $0
     i32.const 8
     i32.sub
     ...
     br_if $is_instance
     i32.const 0
     br $__inlined_func$~instanceof|instanceof/IC$90
    end
    i32.const 1
   end
  else
 ...
 (func $start:instanceof
  ...
  block $folding-inner0
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~anyinstanceof|instanceof/Child$116 (result i32)
     block $is_instance1
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance1
      i32.const 0
      br $__inlined_func$~anyinstanceof|instanceof/Child$116
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat$123 (result i32)
     block $is_instance8
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance8
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat$123
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat$125 (result i32)
     block $is_instance10
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance10
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat$125
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat$127 (result i32)
     block $is_instance12
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance12
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat$127
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Y$86 (result i32)
     block $is_instance21
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance21
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Y$86
     end
     i32.const 1
    end
   else
