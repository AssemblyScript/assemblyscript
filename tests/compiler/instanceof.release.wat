(module
 ...
 (data $19.1 (i32.const 3416) "\02\00\00\00\1a\00\00\00i\00n\00s\00t\00a\00n\00c\00e\00o\00f\00.\00t\00s")
 (data $20 (i32.const 3456) "\18\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $"instanceof/assertDynamicTrue<~lib/object/Object,instanceof/X>" (param $0 i32)
  ...
  local.get $0
  if (result i32)
   block $__inlined_func$~instanceof|instanceof/X$78 (result i32)
    block $is_instance
     block $tablify|0
      local.get $0
      i32.const 8
     ...
     i32.const 0
     br $__inlined_func$~instanceof|instanceof/X$78
    end
    i32.const 1
   end
  else
 ...
 (func $"instanceof/assertDynamicTrue<~lib/object/Object,instanceof/Y>" (param $0 i32)
  ...
  local.get $0
  if (result i32)
   block $__inlined_func$~instanceof|instanceof/Y$80 (result i32)
    block $is_instance
     local.get $0
     i32.const 8
     i32.sub
     ...
     br_if $is_instance
     i32.const 0
     br $__inlined_func$~instanceof|instanceof/Y$80
    end
    i32.const 1
   end
  else
 ...
 (func $"instanceof/assertDynamicFalse<instanceof/X,instanceof/Y>" (param $0 i32)
  ...
  local.get $0
  if (result i32)
   block $__inlined_func$~instanceof|instanceof/Y$84 (result i32)
    block $is_instance
     local.get $0
     i32.const 8
     i32.sub
     ...
     br_if $is_instance
     i32.const 0
     br $__inlined_func$~instanceof|instanceof/Y$84
    end
    i32.const 1
   end
  else
 ...
 (func $start:instanceof
  ...
  block $folding-inner0
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~anyinstanceof|instanceof/Child$114 (result i32)
     block $is_instance1
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance1
      i32.const 0
      br $__inlined_func$~anyinstanceof|instanceof/Child$114
     end
     i32.const 1
    end
   else
