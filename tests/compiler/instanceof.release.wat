(module
 ...
 (func $start:instanceof
  ...
  block $folding-inner0
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat0 (result i32)
     block $is_instance4
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance4
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat0
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat1 (result i32)
     block $is_instance6
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance6
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat1
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat2 (result i32)
     block $is_instance8
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance8
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat2
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat3 (result i32)
     block $is_instance10
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance10
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat3
     end
     i32.const 1
    end
   else
   ...
   local.get $0
   if (result i32)
    block $__inlined_func$~instanceof|instanceof/Cat4 (result i32)
     block $is_instance12
      local.get $0
      i32.const 8
      i32.sub
      ...
      br_if $is_instance12
      i32.const 0
      br $__inlined_func$~instanceof|instanceof/Cat4
     end
     i32.const 1
    end
   else
