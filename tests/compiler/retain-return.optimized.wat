(module
 ...
 (func $~lib/rt/tlsf/prepareBlock (; 6 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  i32.load
 ...
 (func $~lib/rt/tlsf/allocateBlock (; 7 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
 ...
 (func $retain-return/Ref#constructor (; 9 ;) (result i32)
