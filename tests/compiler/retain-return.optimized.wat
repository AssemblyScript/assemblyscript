(module
 ...
 (func $~lib/rt/tlsf/growMemory (; 6 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  memory.size
  local.tee $1
 ...
 (func $~lib/rt/tlsf/prepareBlock (; 7 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  i32.load
 ...
 (func $retain-return/Ref#constructor (; 11 ;) (result i32)
 ...
 (func $~lib/rt/__typeinfo (; 12 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 288
  i32.load
  i32.gt_u
