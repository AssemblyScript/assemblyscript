(module
 ...
 (func $retain-return/Ref#constructor (; 13 ;) (result i32)
  i32.const 0
  i32.const 3
 ...
 (func $~lib/rt/__typeinfo (; 15 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 288
  i32.load
  i32.gt_u
 ...
 (func $~lib/rt/pure/appendRoot (; 19 ;) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.tee $1
 ...
 (func $~lib/rt/pure/markGray (; 24 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/scanBlack (; 25 ;) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const -1879048193
