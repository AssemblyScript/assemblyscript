(module
 ...
 (data $19.1 (i32.const 3416) "\02\00\00\00\"\00\00\00c\00l\00a\00s\00s\00-\00o\00v\00e\00r\00r\00i\00d\00e\00.\00t\00s")
 (data $20 (i32.const 3472) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $class-override/fn (param $0 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.tee $1
   i32.store
   block $__inlined_func$class-override/A#f@override$140
    block $default
     block $case1
      block $case0
       local.get $1
      ...
      local.set $0
      br $__inlined_func$class-override/A#f@override$140
     end
     global.get $~lib/memory/__stack_pointer
     i32.const 4
     i32.sub
