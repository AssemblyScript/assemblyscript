(module
 ...
 (func $start:field-initialization
  ...
  global.get $~lib/memory/__stack_pointer
  block $field-initialization/Ref_Init_InlineCtor#constructor|inlined.0 (result i32)
   i32.const 0
   local.set $30
   local.get $30
   i32.eqz
  ...
  global.get $~lib/memory/__stack_pointer
  block $field-initialization/Ref_InlineCtor_Init#constructor|inlined.0 (result i32)
   i32.const 0
   local.set $32
   local.get $32
   i32.eqz
