(module
 ...
 (func $~lib/util/math/log_lut (; 0 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  (local $1 i64)
  (local $2 f64)
  (local $3 f64)
  (local $4 f64)
 ...
 (func $~lib/math/NativeMath.log (; 1 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  local.get $0
  call $~lib/util/math/log_lut
  return
 )
 (func $~lib/util/math/log2_lut (; 2 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  (local $1 i64)
  (local $2 f64)
  (local $3 f64)
  (local $4 f64)
 ...
 (func $~lib/math/NativeMath.log2 (; 3 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  local.get $0
  call $~lib/util/math/log2_lut
  return
 )
 (func $../../examples/mandelbrot/assembly/index/computeLine (; 4 ;) (type $FUNCSIG$viiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 f64)
  (local $5 f64)
  (local $6 i32)
  (local $7 i32)
