(module
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$200
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$200
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32)
  ...
  if
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/rt/itcms/__renew$190
    i32.const 1073741820
    local.get $2
    i32.const 1
    i32.shl
    ...
    if
     ...
     local.get $2
     local.set $1
     br $__inlined_func$~lib/rt/itcms/__renew$190
    end
    local.get $3
    local.get $4
    i32.load offset=12
