(module
 ...
 (start $start)
 (func $unsafe/one (; 5 ;) (type $FUNCSIG$v)
  nop
 )
 (func $unsafe/Foo.two (; 6 ;) (type $FUNCSIG$v)
  nop
 )
 ...
 (func $unsafe/Foo#constructor (; 19 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $unsafe/Foo#four (; 20 ;) (type $FUNCSIG$vi) (param $0 i32)
  nop
 )
 ...
 (func $start:unsafe (; 30 ;) (type $FUNCSIG$v)
  (local $0 i32)
  call $unsafe/one
  call $unsafe/Foo.two
  global.get $unsafe/Foo.threeTwoTimes
  drop
  i32.const 1
