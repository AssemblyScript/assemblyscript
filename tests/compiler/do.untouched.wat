(module
 ...
 (func $do/Ref#constructor (; 32 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $do/getRef (; 42 ;) (result i32)
  i32.const 0
  call $do/Ref#constructor
 )
 (func $do/testRefAutorelease (; 43 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
