(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 21076))
 (global $~lib/memory/__heap_base i32 (i32.const 21076))
 ...
 (func $templateliteral/Ref#set:value (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0
 )
 ...
 (func $templateliteral/RecursiveObject#set:key (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0
  local.get $0
 ...
 (func $templateliteral/RecursiveObject#set:val (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0 offset=4
  local.get $0
