(module
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$229
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$229
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/string/String.__eq (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   block $__inlined_func$~lib/util/string/compareImpl$107
    loop $while-continue|1
     local.get $0
     local.tee $3
     i32.const 1
     ...
     if
      ...
      local.get $5
      i32.ne
      br_if $__inlined_func$~lib/util/string/compareImpl$107
      local.get $2
      i32.const 2
      i32.add
      local.set $2
