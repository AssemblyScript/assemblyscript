(module
 ...
 (func $~lib/util/number/decimalCount32 (; 2 ;) (param $0 i32) (result i32)
  i32.const 1
  i32.const 2
  local.get $0
  i32.const 10
 ...
 (func $~lib/util/number/itoa32 (; 4 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/util/string/compareImpl (; 6 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  i32.const 144
 ...
 (func $start:resolve-function-expression (; 7 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 1
  global.set $~argumentsLength
