(module
 ...
 (func $~lib/rt/stub/__alloc (; 5 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/util/string/compareImpl (; 9 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 128
  local.set $2
 ...
 (func $~lib/string/String.__eq (; 10 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  i32.const 128
  i32.eq
 ...
 (func $start:resolve-function-expression (; 11 ;) (type $FUNCSIG$v)
  i32.const 1
  global.set $~lib/argc
  i32.const 2
