function testAtomic(): void {
  ...
  atomic.cmpxchg<u8>(0, <u64>1, <u64>2);  // i64.atomic.rmw8.xchg_u
  atomic.cmpxchg<u16>(0, <u64>1, <u64>2); // i64.atomic.rmw16.xchg_u
  atomic.cmpxchg<u32>(0, <u64>1, <u64>2); // i64.atomic.rmw32.xchg_u
