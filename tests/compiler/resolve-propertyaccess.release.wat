(module
 ...
 (data $22 (i32.const 4908) "L")
 (data $22.1 (i32.const 4920) "\02\00\00\002\00\00\00r\00e\00s\00o\00l\00v\00e\00-\00p\00r\00o\00p\00e\00r\00t\00y\00a\00c\00c\00e\00s\00s\00.\00t\00s")
 (data $23 (i32.const 4988) "\1c")
 (data $23.1 (i32.const 5000) "\02\00\00\00\04\00\00\001\001")
 (data $24 (i32.const 5020) "\1c")
 (data $24.1 (i32.const 5032) "\02\00\00\00\02\00\00\002")
 (data $25 (i32.const 5052) "\1c")
 (data $25.1 (i32.const 5064) "\02\00\00\00\04\00\00\002\002")
 (data $26 (i32.const 5084) "\1c")
 (data $26.1 (i32.const 5096) "\02\00\00\00\02\00\00\003")
 (data $27 (i32.const 5116) "\1c")
 (data $27.1 (i32.const 5128) "\02\00\00\00\04\00\00\003\003")
 (data $28 (i32.const 5148) "\1c")
 (data $28.1 (i32.const 5160) "\02\00\00\00\02\00\00\004")
 (data $29 (i32.const 5180) "\1c")
 (data $29.1 (i32.const 5192) "\02\00\00\00\02\00\00\005")
 (data $30 (i32.const 5212) "\1c")
 (data $30.1 (i32.const 5224) "\02\00\00\00\04\00\00\005\005")
 (data $31 (i32.const 5244) "\1c")
 (data $31.1 (i32.const 5256) "\02\00\00\00\02\00\00\007")
 (data $32 (i32.const 5276) "\1c")
 (data $32.1 (i32.const 5288) "\02\00\00\00\02\00\00\006")
 (data $33 (i32.const 5308) "\1c")
 (data $33.1 (i32.const 5320) "\02\00\00\00\02\00\00\008")
 (data $34 (i32.const 5344) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
