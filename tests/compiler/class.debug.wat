(module
 ...
 (func $class/Animal<f64>#set:one (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0
 )
 (func $class/Animal<f64>#set:two (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store16 $0 offset=4
 )
 (func $class/Animal<f64>#set:three (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
 ...
 (func $class/GenericInitializer<i32>#set:foo (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0
  local.get $this
