(module
 ...
 (data (i32.const 512) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $class/Animal<f64>#get:one (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0
 )
 (func $class/Animal<f64>#get:two (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load16_s $0 offset=4
 )
 (func $class/Animal<f64>#get:three (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load8_s $0 offset=6
 )
 (func $class/Animal<f64>#set:one (type $i32_i32_=>_none) (param $this i32) (param $one i32)
  local.get $this
  local.get $one
  i32.store $0
 )
 (func $class/Animal<f64>#set:two (type $i32_i32_=>_none) (param $this i32) (param $two i32)
  local.get $this
  local.get $two
  i32.store16 $0 offset=4
 )
 (func $class/Animal<f64>#set:three (type $i32_i32_=>_none) (param $this i32) (param $three i32)
  local.get $this
  local.get $three
 ...
 (func $class/GenericInitializer<i32>#set:foo (type $i32_i32_=>_none) (param $this i32) (param $foo i32)
  local.get $this
  local.get $foo
  i32.store $0
  local.get $this
