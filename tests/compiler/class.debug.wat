(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 1424))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34192))
 (global $~lib/memory/__heap_base i32 (i32.const 34192))
 (memory $0 1)
 ...
 (data $12 (i32.const 1392) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
