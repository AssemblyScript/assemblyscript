(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36304))
 (memory $0 1)
 ...
 (data $21 (i32.const 3504) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\02\t")
 ...
 (func $~lib/number/U32#toString (param $0 i32) (result i32)
  ...
  i32.const 0
  i32.store
  block $__inlined_func$~lib/util/number/utoa32$3
   local.get $1
   i32.eqz
   if
    global.get $~lib/memory/__stack_pointer
    ...
    i32.const 1376
    local.set $0
    br $__inlined_func$~lib/util/number/utoa32$3
   end
   global.get $~lib/memory/__stack_pointer
   local.get $1
   i32.const 100000
 ...
 (func $~lib/rt/itcms/__new (param $0 i32) (param $1 i32) (result i32)
  ...
  i32.ge_u
  if
   block $__inlined_func$~lib/rt/itcms/interrupt$73
    i32.const 2048
    local.set $2
    loop $do-loop|0
     local.get $2
     ...
     if
      ...
      br $__inlined_func$~lib/rt/itcms/interrupt$73
     end
     local.get $2
     i32.const 0
     i32.gt_s
