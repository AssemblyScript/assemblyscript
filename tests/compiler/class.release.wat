(module
 ...
 (global $class/memberTypeInfer (mut i32) (i32.const 0))
 ...
 (data $8.1 (i32.const 1448) "\02\00\00\00\06\00\00\00h\00h\00h")
 (data $9 (i32.const 1468) "\1c")
 (data $9.1 (i32.const 1480) "\02\00\00\00\06\00\00\00i\003\002")
 (data $10 (i32.const 1500) ",")
 (data $10.1 (i32.const 1512) "\02\00\00\00\10\00\00\00c\00l\00a\00s\00s\00.\00t\00s")
 (data $11 (i32.const 1548) "\1c")
 (data $11.1 (i32.const 1560) "\02\00\00\00\06\00\00\00f\003\002")
 (data $12 (i32.const 1580) "\1c")
 (data $12.1 (i32.const 1592) "\02\00\00\00\0c\00\00\00S\00t\00r\00i\00n\00g")
 ...
 (data $14.1 (i32.const 1672) "\02\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data $15 (i32.const 1712) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
 (data $15.1 (i32.const 1744) "\02\t")
 ...
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $class/memberTypeInfer
  local.tee $0
  if
   local.get $0
       ...
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         block $~lib/object/Object
          ...
          i32.sub
          i32.load
          br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $class/Animal<f64> $class/MemberTypeInfer $folding-inner0 $~lib/array/Array<i32> $invalid
         end
         return
        end
        return
 ...
 (func $~start
  ...
  block $folding-inner0
   ...
   global.set $~lib/memory/__stack_pointer
   local.get $0
   global.set $class/memberTypeInfer
   global.get $~lib/memory/__stack_pointer
   global.get $class/memberTypeInfer
   local.tee $0
   i32.store offset=8
