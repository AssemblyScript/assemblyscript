(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34680))
 (memory $0 1)
 (data (i32.const 1036) "<")
 ...
 (data (i32.const 1560) "\06\00\00\00\08\00\00\00\01")
 (data (i32.const 1580) "<")
 (data (i32.const 1592) "\02\00\00\00$\00\00\00K\00e\00y\00 \00d\00o\00e\00s\00 \00n\00o\00t\00 \00e\00x\00i\00s\00t")
 (data (i32.const 1644) ",")
 (data (i32.const 1656) "\02\00\00\00\16\00\00\00~\00l\00i\00b\00/\00m\00a\00p\00.\00t\00s")
 (data (i32.const 1692) ",")
 (data (i32.const 1704) "\02\00\00\00\1c\00\00\00s\00t\00d\00/\00w\00e\00a\00k\00r\00e\00f\00.\00t\00s")
 (data (i32.const 1740) "\1c")
 (data (i32.const 1752) "\01")
 (data (i32.const 1772) ",")
 (data (i32.const 1784) "\08\00\00\00\10\00\00\00\e0\06\00\00\e0\06")
 (data (i32.const 1820) ",")
 (data (i32.const 1832) "\02\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 1872) "\t\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00\00\00\00\00\10\01\02\00\02A")
 (table $0 2 2 funcref)
 ...
 (func $~lib/weakref/WeakRef.finalize (type $i32_=>_none) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  ...
  local.tee $2
  i32.store $0
  block $__inlined_func$~lib/map/Map<usize,u32>#delete (result i32)
   local.get $2
   i32.load $0
   local.get $2
   i32.load $0 offset=4
   ...
   local.get $1
   i32.eqz
   br_if $__inlined_func$~lib/map/Map<usize,u32>#delete
   drop
   local.get $1
   local.get $1
   i32.load $0 offset=8
 ...
 (func $~lib/weakref/WeakRef<std/weakref/Dummy>#deref (type $i32_=>_i32) (param $0 i32) (result i32)
  ...
  if (result i32)
   ...
   i32.load $0
   local.set $1
   block $__inlined_func$~lib/map/Map<usize,u32>#find2
    loop $while-continue|08
     ...
     if
      ...
      br_if $__inlined_func$~lib/map/Map<usize,u32>#find2
      local.get $3
      i32.const -2
      i32.and
      local.set $1
