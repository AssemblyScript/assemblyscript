(module
 ...
 (func $~lib/math/NativeMath.exp2 (; 99 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  (local $1 f64)
  (local $2 i64)
  (local $3 i32)
  (local $4 f64)
 ...
 (func $~lib/math/NativeMathf.exp2 (; 101 ;) (type $FUNCSIG$ff) (param $0 f32) (result f32)
  (local $1 f64)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
