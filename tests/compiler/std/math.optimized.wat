(module
 ...
 (func $~lib/math/murmurHash3_64 (; 130 ;) (; has Stack IR ;) (type $II) (param $0 i64) (result i64)
  (i64.xor
   (tee_local $0
    (i64.mul
     (i64.xor
 ...
 (func $~lib/math/murmurHash3_32 (; 131 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  (i32.xor
   (tee_local $0
    (i32.mul
     (i32.xor
