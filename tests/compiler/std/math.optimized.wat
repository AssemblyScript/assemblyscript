(module
 ...
 (func $~lib/util/math/pow_lut (; 125 ;) (type $FUNCSIG$ddd) (param $0 f64) (param $1 f64) (result f64)
  (local $2 i64)
  (local $3 f64)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $~lib/util/math/powf_lut (; 127 ;) (type $FUNCSIG$fff) (param $0 f32) (param $1 f32) (result f32)
  (local $2 i32)
  (local $3 i32)
  (local $4 f64)
  (local $5 i32)
