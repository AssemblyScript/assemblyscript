(module
 ...
 (memory $0 1)
 (data (i32.const 8) "\10\00\00\00\1c\00\00\00\00\00\00\00\00\00\00\00s\00t\00d\00/\00p\00o\00i\00n\00t\00e\00r\00.\00t\00s\00")
 (table $0 1 funcref)
 ...
 (func $std/pointer/Pointer<std/pointer/Entry>#set:value (; 3 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $1
  i32.const 0
  i32.eq
  if
 ...
 (func $std/pointer/Pointer<f32>#set:value (; 5 ;) (type $FUNCSIG$vif) (param $0 i32) (param $1 f32)
  local.get $0
  local.get $1
  f32.store
 )
