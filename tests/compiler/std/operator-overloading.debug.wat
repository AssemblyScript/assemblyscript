(module
 ...
 (data (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\006\00\00\00s\00t\00d\00/\00o\00p\00e\00r\00a\00t\00o\00r\00-\00o\00v\00e\00r\00l\00o\00a\00d\00i\00n\00g\00.\00t\00s\00\00\00\00\00\00\00")
 (data (i32.const 492) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00x\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 524) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00y\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 560) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $std/operator-overloading/Tester#set:x (type $i32_i32_=>_none) (param $this i32) (param $x i32)
  local.get $this
  local.get $x
  i32.store $0
 )
 (func $std/operator-overloading/Tester#set:y (type $i32_i32_=>_none) (param $this i32) (param $y i32)
  local.get $this
  local.get $y
  i32.store $0 offset=4
 )
 ...
 (func $std/operator-overloading/TesterInlineStatic#set:x (type $i32_i32_=>_none) (param $this i32) (param $x i32)
  local.get $this
  local.get $x
  i32.store $0
 )
 (func $std/operator-overloading/TesterInlineStatic#set:y (type $i32_i32_=>_none) (param $this i32) (param $y i32)
  local.get $this
  local.get $y
  i32.store $0 offset=4
 )
 ...
 (func $std/operator-overloading/TesterInlineInstance#set:x (type $i32_i32_=>_none) (param $this i32) (param $x i32)
  local.get $this
  local.get $x
  i32.store $0
 )
 (func $std/operator-overloading/TesterInlineInstance#set:y (type $i32_i32_=>_none) (param $this i32) (param $y i32)
  local.get $this
  local.get $y
  i32.store $0 offset=4
 )
 ...
 (func $std/operator-overloading/TesterElementAccess#set:x (type $i32_i32_=>_none) (param $this i32) (param $x i32)
  local.get $this
  local.get $x
  i32.store $0
 )
 (func $std/operator-overloading/TesterElementAccess#set:y (type $i32_i32_=>_none) (param $this i32) (param $y i32)
  local.get $this
  local.get $y
  i32.store $0 offset=4
 )
