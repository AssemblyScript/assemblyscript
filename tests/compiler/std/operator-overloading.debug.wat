(module
 ...
 (func $std/operator-overloading/TesterElementAccess#set:x (param $0 i32) (param $1 f32)
  local.get $0
  local.get $1
  f32.store
 )
 (func $std/operator-overloading/TesterElementAccess#set:y (param $0 i32) (param $1 f32)
  local.get $0
  local.get $1
  f32.store offset=4
 )
 ...
 (func $std/operator-overloading/TesterElementAccess#__set (param $0 i32) (param $1 i32) (param $2 f32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $std/operator-overloading/TesterElementAccess#__get (param $0 i32) (param $1 i32) (result f32)
  (local $2 i32)
  (local $3 f32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $std/operator-overloading/TesterElementAccess#constructor (param $0 i32) (param $1 f32) (param $2 f32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
