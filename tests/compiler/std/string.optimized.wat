(module
 ...
 (data (i32.const 912) "\01\00\00\00c")
 (data (i32.const 920) "\07\00\00\00a\00,\00 \00b\00,\00 \00c")
 (data (i32.const 944) "\02\00\00\00,\00 ")
 ...
 (func $~lib/array/Array<String>#push (; 42 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $4
