(module
 ...
 (func $start:std/set~anonymous|0 (; 112 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  local.get $1
  i32.eq
  i32.eqz
 ...
 (func $~lib/set/Set<i32>#getPtr (; 113 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/set/Set<i32>#forEach (; 114 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
     ...
     block
      ...
      if
       ...
       if
         ...
         loop $continue|1
          block
           ...
           if
            ...
            block $~lib/set/ENTRY_SIZE<i32>|inlined.11 (result i32)
             i32.const 8
            end
            i32.add
            local.set $9
        ...
        local.get $0
        i32.load offset=16
        block $~lib/set/ENTRY_SIZE<i32>|inlined.12 (result i32)
         i32.const 8
        end
        i32.mul
        i32.add
        ...
        if
         ...
         local.get $0
         i32.load offset=16
         block $~lib/set/ENTRY_SIZE<i32>|inlined.13 (result i32)
          i32.const 8
         end
         i32.mul
         i32.add
 ...
 (func $start:std/set~anonymous|1 (; 115 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $2
  i32.const 11
  call $~lib/set/Set<i32>#add
  global.get $std/set/i
 ...
 (func $start:std/set~anonymous|2 (; 116 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $0
  i32.const 11
  i32.eq
 ...
 (func $start:std/set~anonymous|3 (; 117 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $2
  local.get $0
  call $~lib/set/Set<i32>#delete
  drop
 ...
 (func $start:std/set~anonymous|4 (; 118 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  global.get $std/set/i
  i32.const 1
  i32.add
  global.set $std/set/i
