  ...
  block $folding-inner0
   ...
   block $__inlined_func$~lib/staticarray/StaticArray<i32>#indexOf19
    ...
    if
     i32.const -1
     local.set $0
     br $__inlined_func$~lib/staticarray/StaticArray<i32>#indexOf19
    end
    local.get $1
    i32.const 1
    i32.sub
   ...
   block $__inlined_func$~lib/staticarray/StaticArray<i32>#indexOf21
    local.get $2
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     i32.const -1
     local.set $0
     br $__inlined_func$~lib/staticarray/StaticArray<i32>#indexOf21
    end
    local.get $1
    i32.const 3
    i32.sub
    ...
    loop $while-continue|022
     ...
     if
      ...
      i32.const 2
      i32.eq
      br_if $__inlined_func$~lib/staticarray/StaticArray<i32>#indexOf21
      local.get $0
      i32.const 1
      i32.add
      local.set $0
