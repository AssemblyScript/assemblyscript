(module
 ...
 (func $start:std/array
  ...
  block $folding-inner1
   ...
   i32.load offset=12
   local.set $3
   block $__inlined_func$~lib/array/Array<i32>#findIndex37
    loop $for-loop|038
     local.get $1
     local.get $3
     local.get $4
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex37
      local.get $1
      i32.const 1
      i32.add
      local.set $1
   ...
   i32.sub
   local.set $0
   block $__inlined_func$~lib/array/Array<i32>#findLastIndex48
    loop $for-loop|049
     local.get $0
     i32.const 0
     i32.ge_s
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findLastIndex48
      local.get $0
      i32.const 1
      i32.sub
      local.set $0
   ...
   block $1of1113
    block $0of1114
     block $outOfRange115
      global.get $~argumentsLength
      br_table $0of1114 $1of1113 $outOfRange115
     end
     unreachable
    end
    i32.const 8432
   ...
   block $__inlined_func$std/array/isArraysEqual<~lib/string/String|null> (result i32)
    ...
    i64.const 0
    i64.store
    block $folding-inner162
     block $folding-inner063
      local.get $1
      i32.load offset=12
      local.tee $0
      local.get $5
      i32.load offset=12
      i32.ne
      br_if $folding-inner063
      local.get $1
      local.get $5
      i32.eq
      br_if $folding-inner162
      loop $for-loop|064
       local.get $0
       local.get $2
       i32.gt_s
   ...
   block $1of1118
    block $0of1119
     block $outOfRange120
      ...
      i32.const 1
      i32.sub
      br_table $0of1119 $1of1118 $outOfRange120
     end
     unreachable
    end
    i32.const 9440
