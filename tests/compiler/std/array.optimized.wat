(module
 ...
 (func $~lib/runtime/runtime.makeArray (; 12 ;) (type $FUNCSIG$iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  i32.const 16
  call $~lib/runtime/runtime.allocate
 ...
 (func $~lib/runtime/runtime.reallocate (; 18 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/runtime/runtime.discard (; 122 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  i32.const 8060
  i32.le_u
  if
