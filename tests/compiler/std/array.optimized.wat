(module
 ...
 (func $start:std/array
  ...
  block $folding-inner1
   ...
   i32.sub
   local.set $1
   block $__inlined_func$~lib/array/Array<i32>#findLastIndex53
    loop $for-loop|054
     local.get $1
     i32.const 0
     i32.ge_s
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findLastIndex53
      local.get $1
      i32.const 1
      i32.sub
      local.set $1
   ...
   i32.const 6288
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#every56 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|057
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every56
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6320
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#every58 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|059
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every58
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6352
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#every60 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|061
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every60
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6384
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#every62 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|063
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every62
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6448
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#some65 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|066
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some65
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6480
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#some67 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|068
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some67
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6512
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#some69 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|070
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some69
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   i32.const 6544
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#some71 (result i32)
    i32.const 0
    local.set $0
    local.get $5
    i32.load offset=12
    ...
    loop $for-loop|072
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some71
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$std/array/isArraysEqual<~lib/string/String|null> (result i32)
    ...
    i64.const 0
    i64.store
    block $folding-inner163
     block $folding-inner064
      local.get $1
      i32.load offset=12
      local.tee $0
      local.get $5
      i32.load offset=12
      i32.ne
      br_if $folding-inner064
      local.get $1
      local.get $5
      i32.eq
      br_if $folding-inner163
      loop $for-loop|065
       local.get $0
       local.get $2
       i32.gt_s
