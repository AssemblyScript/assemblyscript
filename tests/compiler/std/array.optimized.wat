 ...
 (func $start:std/array
  ...
  block $folding-inner0
   ...
   block $__inlined_func$std/array/isArraysEqual<~lib/string/String|null> (result i32)
    ...
    i64.const 0
    i64.store
    block $folding-inner156
     block $folding-inner057
      local.get $11
      i32.load offset=12
      local.tee $1
      local.get $14
      i32.load offset=12
      i32.ne
      br_if $folding-inner057
      local.get $11
      local.get $14
      i32.eq
      br_if $folding-inner156
      loop $for-loop|058
       local.get $1
       local.get $3
       i32.gt_s
   ...
   block $1of163
    block $0of164
     block $outOfRange65
      ...
      i32.const 1
      i32.sub
      br_table $0of164 $1of163 $outOfRange65
     end
     unreachable
    end
    i32.const 8912
   ...
   call $~lib/rt/itcms/step
   drop
   loop $while-continue|1135
    global.get $~lib/rt/itcms/state
    if
     call $~lib/rt/itcms/step
     drop
     br $while-continue|1135
    end
   end
   global.get $~lib/rt/itcms/total
   i64.extend_i32_u
