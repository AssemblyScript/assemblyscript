  ...
  block $folding-inner3
   ...
   block $__inlined_func$~lib/array/Array<i32>#indexOf57
    ...
    if
     i32.const -1
     local.set $0
     br $__inlined_func$~lib/array/Array<i32>#indexOf57
    end
    local.get $1
    i32.load offset=4
    local.set $1
   ...
   i32.load offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex70
    loop $for-loop|071
     local.get $2
     local.get $1
     i32.load offset=12
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex70
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.const 6640
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#every79 (result i32)
    i32.const 0
    local.set $1
    local.get $0
    i32.load offset=12
    ...
    loop $for-loop|080
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every79
      drop
      local.get $1
      i32.const 1
      i32.add
   ...
   i32.const 6800
   i32.store offset=8
   block $__inlined_func$~lib/array/Array<i32>#some88 (result i32)
    i32.const 0
    local.set $1
    local.get $0
    i32.load offset=12
    ...
    loop $for-loop|089
     ...
     if
      ...
      i32.load
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some88
      drop
      local.get $1
      i32.const 1
      i32.add
