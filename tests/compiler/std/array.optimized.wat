(module
 ...
 (func $~lib/internal/arraybuffer/allocateZeroedUnsafe (; 4 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
 ...
 (func $~lib/internal/arraybuffer/reallocateZeroedUnsafe (; 15 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
