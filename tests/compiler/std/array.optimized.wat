(module
 ...
 (table 28 28 anyfunc)
 (elem (i32.const 0) $start~anonymous|0 $start~anonymous|1 $start~anonymous|2 $start~anonymous|3 $start~anonymous|2 $start~anonymous|5 $start~anonymous|6 $start~anonymous|7 $start~anonymous|8 $start~anonymous|9 $start~anonymous|10 $start~anonymous|11 $start~anonymous|12 $start~anonymous|13 $start~anonymous|14 $start~anonymous|15 $start~anonymous|16 $start~anonymous|16 $start~anonymous|18 $start~anonymous|19 $start~anonymous|20 $start~anonymous|16 $start~anonymous|22 $~lib/internal/array/defaultComparator<i32>~anonymous|23 $start~anonymous|24 $start~anonymous|25 $start~anonymous|24 $start~anonymous|25)
 (memory $0 1)
 ...
 (data (i32.const 152) "\a0")
 (data (i32.const 168) "\b0\00\00\00\01\00\00\00\04\00\00\00\00\00\00\00\01")
 (data (i32.const 192) "\c8\00\00\00\02\00\00\00\08\00\00\00\00\00\00\00\02\00\00\00\01")
 (data (i32.const 216) "\e0\00\00\00\04\00\00\00\10\00\00\00\00\00\00\00\03\00\00\00\02\00\00\00\01")
 (data (i32.const 256) "\08\01\00\00\04\00\00\00\10")
 (data (i32.const 276) "\01\00\00\00\02\00\00\00\03")
 (data (i32.const 296) "0\01\00\00\01\00\00\00\04\00\00\00\00\00\00\00\01")
 (data (i32.const 320) "H\01\00\00\02\00\00\00\08\00\00\00\00\00\00\00\01\00\00\00\02")
 ...
 (func $start~anonymous|16 (; 45 ;) (type $iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (i32.add
   (get_local $0)
   (get_local $1)
  )
 )
 (func $~lib/array/Array<i32>#reduce<i32> (; 46 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $start~anonymous|19 (; 48 ;) (type $iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (i32.and
   (select
    (get_local $0)
    (i32.gt_s
 ...
 (func $start~anonymous|20 (; 49 ;) (type $iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (drop
   (call $~lib/array/Array<i32>#push
    (get_local $3)
    (i32.const 1)
 ...
 (func $~lib/math/murmurHash3 (; 51 ;) (type $II) (param $0 i64) (result i64)
  (i64.xor
   (tee_local $0
    (i64.mul
     (i64.xor
 ...
 (func $~lib/math/NativeMath.seedRandom (; 52 ;) (type $Iv) (param $0 i64)
  (if
   (i64.eqz
    (get_local $0)
   )
 ...
 (func $std/array/createReverseOrderedArray (; 53 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (set_local $1
   (call $~lib/array/Array<i32>#constructor
    (i32.const 0)
 ...
 (func $~lib/internal/array/defaultComparator<i32>~anonymous|23 (; 56 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (i32.sub
   (i32.gt_s
    (get_local $0)
    (get_local $1)
 ...
 (func $~lib/internal/array/defaultComparator<i32> (; 57 ;) (type $i) (result i32)
  (i32.const 23)
 )
 (func $~lib/internal/array/insertionSort<i32> (; 58 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/allocator/arena/free_memory (; 59 ;) (type $iv) (param $0 i32)
  (nop)
 )
 (func $~lib/internal/array/weakHeapSort<i32> (; 60 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
