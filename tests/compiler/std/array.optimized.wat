(module
 ...
 (func $~lib/array/Array<~lib/array/Array<~lib/string/String | null>>#flat (; 199 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
