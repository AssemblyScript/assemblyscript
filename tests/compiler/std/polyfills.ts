...
assert(bitrev<u32>(<u32>0x80) == <u32>0x01000000);
assert(bitrev<i32>(<i32>0x80) == <i32>0x01000000);
...
assert(bitrev<u64>(<u64>0) == <u64>0);
assert(bitrev<i64>(<i64>0) == <i64>0);
assert(bitrev<u64>(<u64>1) == <u64>0x8000000000000000);
assert(bitrev<i64>(<i64>1) == <i64>0x8000000000000000);
assert(bitrev<u64>(<u64>2) == <u64>0x4000000000000000);
assert(bitrev<i64>(<i64>2) == <i64>0x4000000000000000);
assert(bitrev<u64>(<u64>0x80) == <u64>0x0100000000000000);
assert(bitrev<i64>(<i64>0x80) == <i64>0x0100000000000000);
assert(bitrev<u64>(<u64>0x1234567897654321) == <u64>0x84C2A6E91E6A2C48);
assert(bitrev<i64>(<i64>0x1234567897654321) == <i64>0x84C2A6E91E6A2C48);
assert(bitrev<u64>(<u64>0x8000000000000000) == <u64>1);
assert(bitrev<i64>(<i64>0x8000000000000000) == <i64>1);
assert(bitrev<u64>(<u64>0xFFFFFFFFFFFFFFFF) == <u64>0xFFFFFFFFFFFFFFFF);
assert(bitrev<i64>(<i64>0xFFFFFFFFFFFFFFFF) == <i64>0xFFFFFFFFFFFFFFFF);
