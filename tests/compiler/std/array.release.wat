(module
 ...
 (func $start:std/array (type $none_=>_none)
  ...
  block $folding-inner1
   ...
   i32.load $0 offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex240
    loop $for-loop|0243
     local.get $0
     local.get $2
     local.get $1
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex240
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.load $0 offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex247
    loop $for-loop|0250
     local.get $0
     local.get $2
     local.get $1
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex247
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.load $0 offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex254
    loop $for-loop|0257
     local.get $0
     local.get $2
     local.get $1
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex254
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.load $0 offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex263
    loop $for-loop|0266
     local.get $0
     local.get $2
     local.get $1
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex263
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.load $0 offset=12
   local.set $2
   block $__inlined_func$~lib/array/Array<i32>#findIndex270
    loop $for-loop|0273
     local.get $0
     local.get $2
     local.get $1
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findIndex270
      local.get $0
      i32.const 1
      i32.add
      local.set $0
   ...
   i32.sub
   local.set $0
   block $__inlined_func$~lib/array/Array<i32>#findLastIndex284
    loop $for-loop|0287
     local.get $0
     i32.const 0
     i32.ge_s
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findLastIndex284
      local.get $0
      i32.const 1
      i32.sub
      local.set $0
   ...
   i32.sub
   local.set $0
   block $__inlined_func$~lib/array/Array<i32>#findLastIndex290
    loop $for-loop|0293
     local.get $0
     i32.const 0
     i32.ge_s
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findLastIndex290
      local.get $0
      i32.const 1
      i32.sub
      local.set $0
   ...
   i32.sub
   local.set $0
   block $__inlined_func$~lib/array/Array<i32>#findLastIndex296
    loop $for-loop|0299
     local.get $0
     i32.const 0
     i32.ge_s
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#findLastIndex296
      local.get $0
      i32.const 1
      i32.sub
      local.set $0
   ...
   block $__inlined_func$~lib/array/Array<i32>#every308 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0311
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every308
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$~lib/array/Array<i32>#every315 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0318
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every315
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$~lib/array/Array<i32>#every324 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0327
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every324
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   call $~lib/array/Array<i32>#pop
   drop
   block $__inlined_func$~lib/array/Array<i32>#every331 (result i32)
    global.get $~lib/memory/__stack_pointer
    global.get $std/array/arr
    local.tee $1
    i32.store $0
    ...
    loop $for-loop|0334
     ...
     if
      ...
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      i32.eqz
      br_if $__inlined_func$~lib/array/Array<i32>#every331
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$~lib/array/Array<i32>#some346 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0349
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some346
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$~lib/array/Array<i32>#some353 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0356
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some353
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $__inlined_func$~lib/array/Array<i32>#some362 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.tee $0
    global.get $std/array/arr
    local.tee $1
    ...
    loop $for-loop|0365
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some362
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   call $~lib/array/Array<i32>#pop
   drop
   block $__inlined_func$~lib/array/Array<i32>#some369 (result i32)
    global.get $~lib/memory/__stack_pointer
    global.get $std/array/arr
    local.tee $1
    i32.store $0
    ...
    loop $for-loop|0372
     ...
     if
      ...
      i32.load $0
      call_indirect $0 (type $i32_i32_i32_=>_i32)
      br_if $__inlined_func$~lib/array/Array<i32>#some369
      drop
      local.get $0
      i32.const 1
      i32.add
   ...
   block $1of1559
    block $0of1560
     block $outOfRange561
      ...
      i32.const 1
      i32.sub
      br_table $0of1560 $1of1559 $outOfRange561
     end
     unreachable
    end
    i32.const 11664
