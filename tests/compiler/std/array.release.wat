(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 49076))
 ...
 (data (i32.const 6600) "\r\00\00\00\08\00\00\00\01")
 (data (i32.const 6620) "\1c")
 (data (i32.const 6632) "\r\00\00\00\08\00\00\00\02")
 (data (i32.const 6652) "\1c")
 (data (i32.const 6664) "\r\00\00\00\08\00\00\00\03")
 (data (i32.const 6684) "\1c")
 (data (i32.const 6696) "\r\00\00\00\08\00\00\00\04")
 (data (i32.const 6716) "\1c")
 (data (i32.const 6728) "\r\00\00\00\08\00\00\00\05")
 (data (i32.const 6748) "\1c")
 (data (i32.const 6760) "\r\00\00\00\08\00\00\00\06")
 (data (i32.const 6780) ",")
 (data (i32.const 6796) "\10\00\00\00\00\00\00\00\01\00\00\00\02\00\00\00\03")
 (data (i32.const 6828) "\1c")
 (data (i32.const 6840) "\r\00\00\00\08\00\00\00\07")
 (data (i32.const 6860) "\1c")
 (data (i32.const 6872) "\r\00\00\00\08\00\00\00\08")
 (data (i32.const 6892) "\1c")
 (data (i32.const 6904) "\r\00\00\00\08\00\00\00\t")
 (data (i32.const 6924) "\1c")
 (data (i32.const 6936) "\r\00\00\00\08\00\00\00\n")
 (data (i32.const 6956) "\1c")
 (data (i32.const 6968) "\r\00\00\00\08\00\00\00\0b")
 (data (i32.const 6988) "\1c")
 (data (i32.const 7000) "\r\00\00\00\08\00\00\00\0c")
 (data (i32.const 7020) "\1c")
 (data (i32.const 7032) "\r\00\00\00\08\00\00\00\r")
 (data (i32.const 7052) "\1c")
 (data (i32.const 7064) "\r\00\00\00\08\00\00\00\0e")
 (data (i32.const 7084) "\1c")
 (data (i32.const 7096) "\r\00\00\00\08\00\00\00\0f")
 (data (i32.const 7116) "\1c")
 (data (i32.const 7128) "\r\00\00\00\08\00\00\00\10")
 (data (i32.const 7148) "\1c")
 (data (i32.const 7160) "\r\00\00\00\08\00\00\00\11")
 (data (i32.const 7180) "\1c")
 (data (i32.const 7192) "\r\00\00\00\08\00\00\00\12")
 (data (i32.const 7212) "\1c")
 (data (i32.const 7224) "\r\00\00\00\08\00\00\00\13")
 (data (i32.const 7244) "\1c")
 (data (i32.const 7256) "\r\00\00\00\08\00\00\00\14")
 ...
 (data (i32.const 9384) "\r\00\00\00\08\00\00\00\1f")
 (data (i32.const 9404) "\1c")
 (data (i32.const 9416) "\r\00\00\00\08\00\00\00 ")
 (data (i32.const 9436) "\1c")
 (data (i32.const 9448) "\r\00\00\00\08\00\00\00!")
 (data (i32.const 9468) "\1c")
 (data (i32.const 9480) "\r\00\00\00\08\00\00\00\"")
        ...
        block $std/array/Ref
         block $~lib/string/String
          block $~lib/arraybuffer/ArrayBuffer
           ...
           i32.sub
           i32.load $0
           br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner4 $folding-inner4 $std/array/Ref $folding-inner4 $folding-inner4 $folding-inner4 $folding-inner4 $folding-inner2 $folding-inner4 $folding-inner4 $folding-inner2 $folding-inner3 $folding-inner3 $folding-inner2 $folding-inner3 $folding-inner3 $folding-inner3 $folding-inner3 $folding-inner3 $std/array/Dim $folding-inner2 $folding-inner3 $folding-inner3 $folding-inner3 $folding-inner3 $folding-inner3 $folding-inner2 $folding-inner3 $std/array/Proxy<i32> $folding-inner2 $folding-inner3 $folding-inner2 $folding-inner3 $folding-inner3 $folding-inner4 $folding-inner4 $folding-inner4 $folding-inner4 $folding-inner4 $folding-inner2 $folding-inner2 $folding-inner2 $folding-inner2 $folding-inner3 $invalid
          end
          return
         end
         return
