(module
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  if
   ...
   block $__inlined_func$~lib/rt/itcms/__renew$644
    local.get $3
    i32.const 20
    i32.sub
    local.tee $4
    ...
    if
     ...
     local.get $3
     local.set $2
     br $__inlined_func$~lib/rt/itcms/__renew$644
    end
    local.get $1
    local.get $4
    i32.load offset=12
 ...
 (func $std/array/assertSorted<i32> (param $0 i32) (param $1 i32)
  ...
  block $folding-inner0
   ...
   i64.const 0
   i64.store offset=8
   block $__inlined_func$std/array/isSorted<i32>$649 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=8
    global.get $~lib/memory/__stack_pointer
    ...
    loop $for-loop|0
     ...
     if
      ...
      if
       ...
       global.set $~lib/memory/__stack_pointer
       i32.const 0
       br $__inlined_func$std/array/isSorted<i32>$649
      end
      local.get $0
      i32.const 1
      i32.add
 ...
 (func $start:std/array
  ...
  block $folding-inner2
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/array/Array<f32>#indexOf$705
    local.get $0
    i32.load offset=12
    local.tee $3
    i32.eqz
    ...
    if
     ...
     i32.const -1
     local.set $1
     br $__inlined_func$~lib/array/Array<f32>#indexOf$705
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/array/Array<f64>#indexOf$706
    local.get $0
    i32.load offset=12
    local.tee $3
    i32.eqz
    ...
    if
     ...
     i32.const -1
     local.set $1
     br $__inlined_func$~lib/array/Array<f64>#indexOf$706
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
   ...
   block $__inlined_func$~lib/array/Array<f32>#includes$707 (result i32)
    i32.const 1
    i32.const 2
    i32.const 9
    i32.const 4576
    ...
    if
     ...
     global.set $~lib/memory/__stack_pointer
     i32.const 0
     br $__inlined_func$~lib/array/Array<f32>#includes$707
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
   ...
   block $__inlined_func$~lib/array/Array<f64>#includes$708 (result i32)
    i32.const 1
    i32.const 3
    i32.const 12
    i32.const 4608
    ...
    if
     ...
     global.set $~lib/memory/__stack_pointer
     i32.const 0
     br $__inlined_func$~lib/array/Array<f64>#includes$708
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
   ...
   i64.const 0
   i64.store offset=8
   block $__inlined_func$std/array/isSorted<~lib/string/String|null>$653 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=8
    global.get $~lib/memory/__stack_pointer
    ...
    loop $for-loop|07
     ...
     if
      ...
      if
       ...
       global.set $~lib/memory/__stack_pointer
       i32.const 0
       br $__inlined_func$std/array/isSorted<~lib/string/String|null>$653
      end
      local.get $4
      i32.const 1
      i32.add
