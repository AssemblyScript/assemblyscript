(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34660))
 (memory $0 1)
 (data (i32.const 1036) "<")
 ...
 (data (i32.const 1760) " \00\00\00 \00\00\00 \00\00\00\00\00\00\00\10\89\10\00B\08\00\00\02\t\00\00P\88\10\00\10\t\12\00\10\89\00\00B\00\00\00P\80\00\00\10\t\11\00\82\08\00\00\90\08\11\00\10\t\01\00\82\00\00\00\90\00\01\00\10\t\02\00\02\01\00\00\10\01\02\00\10\t\14\00\02\n\00\00\10\n\14\00\10\t\04\00\02\02\00\00\10\02\04\00\10\t2\00\02\19\00\00\10\192\00\10\t4\00\02\1a\00\00\10\1a4")
  ...
  block $folding-inner1
   ...
   loop $for-loop|1
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find15
      loop $while-continue|019
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find15
        local.get $3
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|2
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find41
      loop $while-continue|045
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find41
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find48
      loop $while-continue|052
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find48
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|3
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find80
      loop $while-continue|084
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find80
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find87
      loop $while-continue|091
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find87
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|4
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find96
      loop $while-continue|0100
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find96
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find103
      loop $while-continue|0107
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find103
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<i64,i32>#find110
      loop $while-continue|0114
       ...
       if
        ...
        br_if $__inlined_func$~lib/map/Map<i64,i32>#find110
        local.get $1
        i32.const -2
        i32.and
        local.set $0
  ...
  block $folding-inner1
   ...
   loop $for-loop|1
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find15
      loop $while-continue|019
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find15
        local.get $3
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|2
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find41
      loop $while-continue|045
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find41
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find48
      loop $while-continue|052
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find48
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|3
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find80
      loop $while-continue|084
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find80
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find87
      loop $while-continue|091
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find87
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|4
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find96
      loop $while-continue|0100
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find96
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find103
      loop $while-continue|0107
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find103
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<u64,i32>#find110
      loop $while-continue|0114
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<u64,i32>#find110
        local.get $1
        i32.const -2
        i32.and
        local.set $0
  ...
  block $folding-inner1
   ...
   loop $for-loop|2
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find41
      loop $while-continue|045
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find41
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find48
      loop $while-continue|052
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find48
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|3
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find80
      loop $while-continue|084
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find80
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find87
      loop $while-continue|091
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find87
        local.get $1
        i32.const -2
        i32.and
        local.set $0
   ...
   loop $for-loop|4
    ...
    if
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find96
      loop $while-continue|0100
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find96
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find103
      loop $while-continue|0107
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find103
        local.get $1
        i32.const -2
        i32.and
        local.set $0
     ...
     i32.load $0
     local.set $0
     block $__inlined_func$~lib/map/Map<f64,i32>#find110
      loop $while-continue|0114
       local.get $0
       if
        local.get $0
        ...
        br_if $__inlined_func$~lib/map/Map<f64,i32>#find110
        local.get $1
        i32.const -2
        i32.and
        local.set $0
