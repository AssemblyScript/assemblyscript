(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 35872))
 (memory $0 1)
 ...
 (data $13.1 (i32.const 1768) "\02\00\00\00\14\00\00\00s\00t\00d\00/\00m\00a\00p\00.\00t\00s")
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$1827
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$1827
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  ...
  if
   ...
   block $__inlined_func$~lib/rt/itcms/__renew$1779
    local.get $4
    i32.const 20
    i32.sub
    local.tee $3
    ...
    if
     ...
     local.get $4
     local.set $2
     br $__inlined_func$~lib/rt/itcms/__renew$1779
    end
    local.get $1
    local.get $3
    i32.load offset=12
 ...
 (func $"~lib/map/Map<i32,i32>#constructor@varargs" (result i32)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.sub
 ...
 (func $"std/map/testNumeric<i8,i32>"
  ...
  block $folding-inner1
   ...
   i32.store offset=16
   global.get $~lib/memory/__stack_pointer
   call $"~lib/map/Map<i32,i32>#constructor@varargs"
   local.tee $6
   i32.store offset=20
   loop $for-loop|2
    global.get $~lib/memory/__stack_pointer
