(module
 ...
 (start $~start)
 (func $std/new/AClass#get:aField (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0
 )
 (func $std/new/AClass#set:aField (type $i32_i32_=>_none) (param $this i32) (param $aField i32)
  local.get $this
  local.get $aField
  i32.store $0
 )
 (func $std/new/AClass#set:anotherField (type $i32_f32_=>_none) (param $this i32) (param $anotherField f32)
  local.get $this
