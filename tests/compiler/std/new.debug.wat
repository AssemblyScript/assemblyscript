(module
 ...
 (func $std/new/AClass#set:aField (type $i32_i32_=>_none) (param $this i32) (param $value i32)
  local.get $this
  local.get $value
  i32.store $0
 )
 (func $std/new/AClass#set:anotherField (type $i32_f32_=>_none) (param $this i32) (param $value f32)
  local.get $this
  local.get $value
