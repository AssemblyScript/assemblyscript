(module
 ...
 (func $std/iterator/IterableArray<i32>#get:iterator (; 3 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  i32.const 8
  i32.const 6
 ...
 (func $~lib/map/EntriesIter<~lib/string/String,i32>#constructor (; 22 ;) (type $FUNCSIG$iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $~lib/map/EntriesIter<~lib/string/String,i32>#get:value (; 32 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  call $~lib/map/EntriesIter<~lib/string/String,i32>#get:entry
 )
 ...
 (func $~lib/iterator/IteratorResult<i32>#get:done (; 34 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  i32.const 8
  i32.sub
