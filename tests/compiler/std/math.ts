...
assert(Math.E == NativeMath.E); // should exist
...
assert(test_scalbn(9.26705696697258574, 2, 37.0682278678903430, 0.0, 0));
assert(test_scalbn(0.661985898099504477, 3, 5.29588718479603582, 0.0, 0));
assert(test_scalbn(-0.406603922385355310, 4, -6.50566275816568496, 0.0, 0));
assert(test_scalbn(0.561759746220724110, 5, 17.9763118790631715, 0.0, 0));
assert(test_scalbn(0.774152296591303690, 6, 49.5457469818434362, 0.0, 0));
...
assert(test_scalbnf(4.345239639, -1, 2.172619820, 0.0, 0));
...
assert(test_abs(-0.406603922385355310, 0.406603922385355310, 0.0, 0));
assert(test_abs(0.561759746220724110, 0.561759746220724110, 0.0, 0));
assert(test_abs(0.774152296591303690, 0.774152296591303690, 0.0, 0));
assert(test_abs(-0.678763702639402444, 0.678763702639402444, 0.0, 0));

// special
assert(test_abs(0.0, 0.00, 0.0, 0));
...
assert(test_acos(0.661985898099504477, 0.847331082843350680, -0.415532767772674561, INEXACT));
assert(test_acos(-0.406603922385355310, 1.98953007108866897, 0.497394621372222900, INEXACT));
assert(test_acos(0.561759746220724110, 0.974284964567490364, -0.442889750003814697, INEXACT));
assert(test_acos(0.774152296591303690, 0.685421515863622210, -0.125895276665687561, INEXACT));
...
assert(test_acosf(-0.5051405430, 2.100341082, -0.2085270584, INEXACT));
assert(test_acosf(-0.5189794898, 2.116452932, -0.1460082680, INEXACT));
...
assert(test_acosh(-0.406603922385355310, NaN, 0.0, INVALID));
assert(test_acosh(0.561759746220724110, NaN, 0.0, INVALID));
assert(test_acosh(0.774152296591303690, NaN, 0.0, INVALID));
...
assert(test_acosh(0.999992370605468750, NaN, 0.0, INVALID));
assert(test_acosh(0.0, NaN, 0.0, INVALID));
assert(test_acosh(-0.0, NaN, 0.0, INVALID));
assert(test_acosh(-Infinity, NaN, 0.0, INVALID));

// TODO: hard cases close to 1
// assert(test_acosh(1.00047471439683111, 0.0308115836212692340, -0.147202208638191223, INEXACT));
// assert(test_acosh(1.00183940730320464, 0.0606439391272710696, -0.276413351297378540, INEXACT));
// assert(test_acosh(1.00188411580836734, 0.0613762895053152624, 0.144539892673492432, INEXACT));
// assert(test_acosh(1.00710219219241903, 0.119111722533103620, -0.0701267644762992859, INEXACT));
// assert(test_acosh(1.00721657615236126, 0.120065923465338800, 0.348167449235916138, INEXACT));
...
// assert(test_acosh(1.02566252207476860, 0.226068601206439679, -0.0386677794158458710, INEXACT));
// assert(test_acosh(1.02583916511391160, 0.226842008792436378, -0.214941442012786865, INEXACT));
// assert(test_acosh(1.02779264167821971, 0.235222655703679978, -0.181946381926536560, INEXACT));
// assert(test_acosh(1.02795793845257588, 0.235917895367856345, -0.210223436355590820, INEXACT));
...
assert(test_acosh(1.10608311999264286, 0.456637340438480310, -0.293816089630126953, INEXACT));
...
assert(test_acosh(1.11694291598755213, 0.479024331340752840, -0.321674108505249023, INEXACT));
...
assert(test_acoshf(4.345239639, 2.148716450, 0.4251045287, INEXACT));
...
assert(test_asin(-0.406603922385355310, -0.418733744293772248, -0.0926423072814941406, INEXACT));
assert(test_asin(0.561759746220724110, 0.596511362227406194, -0.108642138540744781, INEXACT));
assert(test_asin(0.774152296591303690, 0.885374810931274348, -0.425636619329452515, INEXACT));
...
assert(test_asin(0.507304392911914759, 0.532053899777234940, -0.161573171615600586, INEXACT));
...
assert(test_asinf(0.5617597699, 0.5965113640, -0.4510819614, INEXACT));
assert(test_asinf(0.7741522789, 0.8853747845, 0.02493886836, INEXACT));
assert(test_asinf(-0.6787636876, -0.7460777760, 0.2515012324, INEXACT));
...
assert(test_asinf(0.5004770160, 0.5241496563, -0.2942709923, INEXACT));
...
assert(test_asinh(-8.38143342755524934, -2.82270608369769604, 0.209852576255798340, INEXACT));
...
assert(test_asinh(-0.406603922385355310, -0.396159903931920354, -0.408144384622573853, INEXACT));
assert(test_asinh(0.561759746220724110, 0.535758887025547414, 0.352071315050125122, INEXACT));
assert(test_asinh(0.774152296591303690, 0.712357126319734912, 0.133714511990547180, INEXACT));
...
// assert(test_asinh(0.241896364059492580, 0.239597351837045336, -0.432244122028350830, INEXACT));
// assert(test_asinh(0.242977050175132520, 0.240647613714979003, 0.464605927467346191, INEXACT));
...
// assert(test_asinh(0.465276618378783480, 0.449940706126732537, 0.415301203727722168, INEXACT));
...
assert(test_asinhf(0.6619858742, 0.6212462783, 0.3684912920, INEXACT));
...
assert(test_atan(-0.406603922385355310, -0.386186417755213118, -0.257428169250488281, INEXACT));
assert(test_atan(0.561759746220724110, 0.511826953162888065, -0.114442773163318634, INEXACT));
assert(test_atan(0.774152296591303690, 0.658780243165382196, -0.112864881753921509, INEXACT));
...
assert(test_atan(0.692982153567462400, 0.606000455515256164, -0.170757904648780823, INEXACT));
...
assert(test_atanf(0.5617597699, 0.5118269920, 0.3499770761, INEXACT));
...
assert(test_cbrt(-8.38143342755524934, -2.03129391067336096, -0.0481018163263797760, INEXACT));
...
assert(test_cbrt(0.661985898099504477, 0.871531147045597310, 0.441491812467575073, INEXACT));
assert(test_cbrt(-0.406603922385355310, -0.740839030300223023, 0.0164538137614727020, INEXACT));
assert(test_cbrt(0.561759746220724110, 0.825119540055928580, 0.306806385517120361, INEXACT));
assert(test_cbrt(0.774152296591303690, 0.918210247895991372, 0.0654399842023849487, INEXACT));
...
assert(test_cbrtf(0.5617597699, 0.8251195550, 0.05601907894, INEXACT));
assert(test_cbrtf(0.7741522789, 0.9182102680, 0.4549820423, INEXACT));
...
assert(test_cos(-0.406603922385355310, 0.918469239700729356, -0.261207133531570435, INEXACT));
assert(test_cos(0.561759746220724110, 0.846319046741589642, -0.302586168050765991, INEXACT));
...
assert(test_cos(4.0, -0.653643620863611940, -0.232805609703063965, INEXACT));
...
assert(test_cos(0.200000000000000011, 0.980066577841241626, -0.0240764096379280090, INEXACT));
...
assert(test_cos(-8.98846567431157954e+307, -0.826369834614148036, -0.369596511125564575, INEXACT));
assert(test_cos(3.14000000000000012, -0.999998731727539503, 0.385551601648330688, INEXACT));
assert(test_cos(3.14150000000000018, -0.999999995707656186, -0.306089758872985840, INEXACT));
...
assert(test_cos(3.14159265350000005, -1.0, -0.0000181558480107923970, INEXACT));
...
assert(test_cos(1.57079632679488990, 6.72257048770830682e-15, -0.107476837933063507, INEXACT));
...
assert(test_cos(0.453814475343389145, 0.898781390226378263, -0.0177248660475015640, INEXACT));
assert(test_cos(0.460988881358358915, 0.895613047471305657, 0.364498198032379150, INEXACT));
...
assert(test_cos(0.953620125220343340, 0.578734618348708429, -0.170898333191871643, INEXACT));
...
assert(test_cos(2.35619449038261974, -0.707106781321092170, -0.306183516979217529, INEXACT));
...
assert(test_cos(7.50026133227361580, 0.346390176334581135, -0.499621003866195679, INEXACT));
...
assert(test_cosh(0.661985898099504477, 1.22723219573428421, 0.232807412743568420, INEXACT));
assert(test_cosh(-0.406603922385355310, 1.08380854187119691, -0.396091699600219727, INEXACT));
assert(test_cosh(0.561759746220724110, 1.16198035831750768, 0.377483904361724854, INEXACT));
assert(test_cosh(0.774152296591303690, 1.31492368762767065, 0.435870081186294556, INEXACT));
...
assert(test_exp(0.661985898099504477, 1.93863845255719980, -0.496424645185470581, INEXACT));
assert(test_exp(-0.406603922385355310, 0.665907889283802512, -0.106083184480667114, INEXACT));
assert(test_exp(0.561759746220724110, 1.75375595186263111, -0.391621112823486328, INEXACT));
assert(test_exp(0.774152296591303690, 2.16875288851292458, -0.299612581729888916, INEXACT));
...
assert(test_exp(1.03972148895263650, 2.82842915587641119, 0.188030809164047241, INEXACT));
assert(test_exp(-1.03972148895263650, 0.353553136702178472, 0.252727240324020386, INEXACT));
...
assert(test_expf(9.267057419, 10583.56348, 0.4596210420, INEXACT));
...
assert(test_expf(0.5617597699, 1.753756046, 0.4435549080, INEXACT));
...
assert(test_expf(-103.9720840, 0.0, -0.4999965131, INEXACT | UNDERFLOW));
...
assert(test_expf(0.3465736210, 1.414213657, 0.4321174324, INEXACT));
...
assert(test_expm1(-0.406603922385355310, -0.334092110716197488, -0.212166368961334229, INEXACT));
assert(test_expm1(0.561759746220724110, 0.753755951862631224, 0.216757774353027344, INEXACT));
assert(test_expm1(0.774152296591303690, 1.16875288851292480, 0.400774806737899780, INEXACT));
...
assert(test_expm1f(9.267057419, 10582.56348, 0.4596210420, INEXACT));
...
assert(test_hypot(-0.792054511984895959, 7.67640268511753998, 7.71715676489958380, 0.0517808496952056885, INEXACT));
...
assert(test_hypot(Infinity, NaN, Infinity, 0.00, 0));
...
assert(test_hypotf(-6.531673431, 4.567535400, 7.970265865, 0.06785223633, INEXACT));
assert(test_hypotf(9.267057419, 4.811392307, 10.44163990, -0.2677630782, INEXACT));
assert(test_hypotf(-6.450045586, 0.6620717645, 6.483936310, 0.4838129282, INEXACT));
assert(test_hypotf(7.858890057, 0.05215452611, 7.859063148, 0.07413065434, INEXACT));
assert(test_hypotf(-0.7920545340, 7.676402569, 7.717156887, 0.4940592647, INEXACT));
assert(test_hypotf(0.6157026887, 2.011902571, 2.104006052, -0.2870894670, INEXACT));
...
assert(test_log(-0.406603922385355310, NaN, 0.0, INVALID));
assert(test_log(0.561759746220724110, -0.576681018319586181, -0.109831996262073517, INEXACT));
assert(test_log(0.774152296591303690, -0.255986659126386518, -0.0579900443553924561, INEXACT));
...
assert(test_log10(4.34523984933830487, 0.638013753712002862, -0.208882406353950500, INEXACT));
...
assert(test_log10(-0.406603922385355310, NaN, 0.0, INVALID));
assert(test_log10(0.561759746220724110, -0.250449384074544368, -0.304684162139892578, INEXACT));
assert(test_log10(0.774152296591303690, -0.111173593499438367, -0.315033614635467529, INEXACT));
...
assert(test_log1p(4.34523984933830487, 1.67620641706017337, 0.461881995201110840, INEXACT));
...
assert(test_log1p(-0.406603922385355310, -0.521893181166397935, -0.258257269859313965, INEXACT));
assert(test_log1p(0.561759746220724110, 0.445813227948810176, -0.132748872041702271, INEXACT));
assert(test_log1p(0.774152296591303690, 0.573322729464841419, 0.0271658301353454590, INEXACT));
assert(test_log1p(-0.678763702639402444, -1.13557829781285635, 0.271309286355972290, INEXACT));
...
assert(test_log1pf(4.345239639, 1.676206350, -0.2301485986, INEXACT));
...
assert(test_log1pf(-0.6787636876, -1.135578275, -0.1987948120, INEXACT));
...
assert(test_log2(0.661985898099504477, -0.595127610420740250, 0.332148522138595581, INEXACT));
assert(test_log2(-0.406603922385355310, NaN, 0.0, INVALID));
assert(test_log2(0.561759746220724110, -0.831974845304464417, 0.0575554370880126953, INEXACT));
assert(test_log2(0.774152296591303690, -0.369310683655371341, -0.198382794857025146, INEXACT));
...
assert(test_pow(0.615702673197924044, 2.01190257903248026, 0.376907735213801831, 0.324733018875122070, INEXACT));
...
assert(test_powf(-6.531673431, 4.567535400, NaN, 0.0, INVALID));
...
assert(test_sin(9.26705696697258574, 0.157067897720280070, -0.0295501593500375748, INEXACT));
assert(test_sin(0.661985898099504477, 0.614684486011344733, -0.0997673794627189636, INEXACT));
assert(test_sin(-0.406603922385355310, -0.395492421828236962, -0.366877496242523193, INEXACT));
assert(test_sin(0.561759746220724110, 0.532676328667237575, -0.355040758848190308, INEXACT));
assert(test_sin(0.774152296591303690, 0.699110206864977934, -0.427672415971755981, INEXACT));
...
// sanity
assert(test_sinf(-8.066848755, -0.9774292111, 0.08010572940, INEXACT));
...
assert(test_sinh(4.34523984933830487, 38.5487808868541180, 0.215374305844306946, INEXACT));
...
assert(test_sinh(-0.406603922385355310, -0.417900652587394450, 0.372200459241867065, INEXACT));
assert(test_sinh(0.561759746220724110, 0.591775593545123657, 0.461789965629577637, INEXACT));
assert(test_sinh(0.774152296591303690, 0.853829200885254158, -0.0701905190944671631, INEXACT));
...
assert(test_sinh(-Infinity, -Infinity, 0.0, 0));
assert(test_sinh(NaN, NaN, 0.00, 0));
...
// sanity
assert(test_sinhf(-8.066848755, -1593.521240, 0.1671663225, INEXACT));
assert(test_sinhf(4.345239639, 38.54877090, -0.4934032857, INEXACT));
...
assert(test_sinhf(9.267057419, 5291.781250, -0.4436251521, INEXACT));
assert(test_sinhf(0.6619858742, 0.7114062309, 0.05810388550, INEXACT));
assert(test_sinhf(-0.4066039324, -0.4179006517, 0.3934949934, INEXACT));
assert(test_sinhf(0.5617597699, 0.5917755961, -0.4183797240, INEXACT));
assert(test_sinhf(0.7741522789, 0.8538292050, 0.4599210620, INEXACT));
...
assert(test_sqrt(0.661985898099504477, 0.813625158226750300, -0.0861815735697746277, INEXACT));
assert(test_sqrt(-0.406603922385355310, NaN, 0.0, INVALID));
assert(test_sqrt(0.561759746220724110, 0.749506335010401425, -0.0981396734714508057, INEXACT));
assert(test_sqrt(0.774152296591303690, 0.879859248170583030, -0.371243536472320557, INEXACT));
...
assert(test_sqrt(98.2751822888191953, 9.91338399784953417, 0.499799311161041260, INEXACT));
...
assert(test_sqrt(100.609546088784811, 10.0304310021446650, 0.499756723642349243, INEXACT));
...
assert(test_sqrt(101.302769128774599, 10.0649276762813660, 0.499910563230514526, INEXACT));
...
assert(test_tan(-6.53167358191348413, -0.253732252345372500, -0.467970371246337891, INEXACT));
...
assert(test_tan(0.561759746220724110, 0.629403687318739968, -0.321913480758666992, INEXACT));
assert(test_tan(0.774152296591303690, 0.977757465294964545, -0.196665182709693909, INEXACT));
...
assert(test_tanf(0.7741522789, 0.9777574539, 0.3896938860, INEXACT));
...
assert(test_tanh(-0.406603922385355310, -0.385585309990165215, 0.359938710927963257, INEXACT));
assert(test_tanh(0.561759746220724110, 0.509281924870043867, -0.394365221261978149, INEXACT));
assert(test_tanh(0.774152296591303690, 0.649337455031855471, -0.489939600229263306, INEXACT));
...
assert(test_tanhf(0.5617597699, 0.5092819333, -0.1528785080, INEXACT));
assert(test_tanhf(0.7741522789, 0.6493374705, 0.4317026138, INEXACT));
assert(test_tanhf(-0.6787636876, -0.5907150507, 0.4079873860, INEXACT));
