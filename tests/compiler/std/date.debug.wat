(module
 ...
 (func $~lib/staticarray/StaticArray<string>#__uget (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.const 2
  i32.shl
 ...
 (func $~lib/array/Array<string>#push (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/date/Date#toDateString (param $0 i32) (result i32)
  ...
  local.get $1
  local.get $6
  call $~lib/staticarray/StaticArray<string>#__uget
  local.set $10
  global.get $~lib/memory/__stack_pointer
  local.get $10
  i32.store offset=32
