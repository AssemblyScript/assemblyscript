(module
 ...
 (global $~lib/util/math/log2f_data_tab i32 (i32.const 3360))
 (global $~lib/util/math/SIGN_BIAS i32 (i32.const 262144))
 (global $~lib/util/math/POW_LOG_TABLE_BITS i32 (i32.const 7))
 (global $~lib/util/math/pow_log_data_tab i32 (i32.const 7504))
 ...
 (func $~lib/math/NativeMath.log2 (; 118 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  (local $1 i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 f64)
 ...
 (func $std/math/test_log2 (; 119 ;) (type $FUNCSIG$idddi) (param $0 f64) (param $1 f64) (param $2 f64) (param $3 i32) (result i32)
  local.get $0
 ...
 (func $~lib/util/math/log2f_lut (; 120 ;) (type $FUNCSIG$ff) (param $0 f32) (result f32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/util/math/exp_inline (; 131 ;) (type $FUNCSIG$dddi) (param $0 f64) (param $1 f64) (param $2 i32) (result f64)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
  (local $6 i64)
