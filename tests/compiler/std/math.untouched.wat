(module
 ...
 (func $~lib/math/NativeMath.imul (; 159 ;) (type $FFF) (param $0 f64) (param $1 f64) (result f64)
  local.get $0
  local.get $1
  f64.add
  call $~lib/builtins/isFinite<f64>
 ...
 (func $~lib/math/ipow64 (; 160 ;) (type $IiI) (param $0 i64) (param $1 i32) (result i64)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  i64.const 1
 ...
 (func $~lib/math/ipow32f (; 161 ;) (type $fif) (param $0 f32) (param $1 i32) (result f32)
  (local $2 i32)
  (local $3 f32)
  local.get $1
  i32.const 31
 ...
 (func $~lib/math/ipow64f (; 162 ;) (type $FiF) (param $0 f64) (param $1 i32) (result f64)
  (local $2 i32)
  (local $3 f64)
  local.get $1
  i32.const 31
