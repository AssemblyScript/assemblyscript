(module
 ...
 (func $~lib/util/hash/hashStr (; 6 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/map/Map<~lib/string/String,usize>#find (; 9 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.load
  local.get $1
  local.get $0
 ...
 (func $~lib/map/Map<~lib/string/String,usize>#rehash (; 10 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<~lib/string/String,usize>#set (; 11 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $~lib/util/hash/hash32 (; 12 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 255
  i32.and
  i32.const -2128831035
 ...
 (func $~lib/map/Map<usize,~lib/string/String>#find (; 13 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.load
  local.get $2
  local.get $0
 ...
 (func $~lib/map/Map<usize,~lib/string/String>#rehash (; 14 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<usize,~lib/string/String>#set (; 15 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $~lib/symbol/_Symbol.for (; 16 ;) (result i32)
  (local $0 i32)
 ...
 (func $~lib/map/Map<usize,~lib/string/String>#get (; 17 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  local.get $1
  call $~lib/util/hash/hash32
 ...
 (func $~lib/symbol/_Symbol.keyFor (; 18 ;) (param $0 i32) (result i32)
  global.get $~lib/symbol/idToString
  if (result i32)
   global.get $~lib/symbol/idToString
   local.get $0
 ...
 (func $~lib/string/String.__concat (; 20 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/symbol/_Symbol#toString (; 21 ;) (param $0 i32) (result i32)
  i32.const 800
