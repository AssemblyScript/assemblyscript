(module
 ...
 (func $~lib/rt/__allocBuffer (; 10 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  local.get $0
  local.get $1
 ...
 (func $~lib/rt/stub/__retain (; 11 ;) (param $0 i32) (result i32)
  local.get $0
 )
 (func $std/fixedarray/test (; 12 ;) (result i32)
  i32.const 12
  i32.const 3
  i32.const 320
