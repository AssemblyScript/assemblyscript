(module
 ...
 (func $~lib/rt/tlsf/__free (; 37 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  if (result i32)
 ...
 (func $~lib/rt/pure/appendRoot (; 39 ;) (param $0 i32)
  (local $1 i32)
  global.get $~lib/rt/pure/CUR
  local.set $1
  local.get $1
 ...
 (func $~lib/rt/pure/__release (; 41 ;) (param $0 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.gt_u
  if
