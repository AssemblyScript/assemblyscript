(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 21776))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 54544))
 (global $~lib/memory/__heap_base i32 (i32.const 54544))
 (memory $0 1)
