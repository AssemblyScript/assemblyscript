(module
 ...
 (global $std/string-encoding/ÀÀ (mut i32) (i32.const 21616))
 (global $std/string-encoding/变量 (mut i32) (i32.const 21648))
 ...
 (func $std/string-encoding/testUnicodeEscape
  (local $a i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $start:std/string-encoding
  ...
  call $std/string-encoding/testUnicodeEscape
  i32.const 1120
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
