(module
 ...
 (data (i32.const 4208) "\c0\00\00\00\01\00\00\00\05\00\00\00\c0\00\00\00n\83\f9\a2\00\00\00\00\d1W\'\fc)\15DN\99\95b\db\c0\dd4\f5\abcQ\feA\90C<:n$\b7a\c5\bb\de\ea.I\06\e0\d2MB\1c\eb\1d\fe\1c\92\d1\t\f55\82\e8>\a7)\b1&p\9c\e9\84D\bb.9\d6\919A~_\b4\8b_\84\9c\f49S\83\ff\97\f8\1f;(\f9\bd\8b\11/\ef\0f\98\05\de\cf~6m\1fm\nZf?FO\b7\t\cb\'\c7\ba\'u-\ea_\9e\f79\07={\f1\e5\eb\b1_\fbk\ea\92R\8aF0\03V\08]\8d\1f \bc\cf\f0\abk{\fca\91\e3\a9\1d6\f4\9a_\85\99e\08\1b\e6^\80\d8\ff\8d@h\a0\14W\15\06\061\'sM")
 ...
 (global $~lib/math/PIO2_TABLE i32 (i32.const 4224))
 (global $~lib/math/res128_hi (mut i64) (i64.const 0))
 (global $~lib/util/math/EXP_TABLE_BITS i32 (i32.const 7))
 (global $~lib/util/math/exp_data_tab i32 (i32.const 6496))
 (global $~lib/util/math/LOG2_TABLE_BITS i32 (i32.const 6))
 (global $~lib/util/math/log2_data_tab1 i32 (i32.const 7568))
 (global $~lib/util/math/log2_data_tab2 i32 (i32.const 8640))
 (global $~lib/util/math/SIGN_BIAS i32 (i32.const 262144))
 (global $~lib/util/math/POW_LOG_TABLE_BITS i32 (i32.const 7))
 (global $~lib/util/math/pow_log_data_tab i32 (i32.const 12784))
 (global $~lib/util/math/log_tail (mut f64) (f64.const 0))
 (global $~lib/util/math/LOGF_TABLE_BITS i32 (i32.const 4))
 (global $~lib/util/math/logf_data_tab i32 (i32.const 13088))
 (global $~lib/math/rempio2f_y (mut f64) (f64.const 0))
 (global $~lib/math/PIO2F_TABLE i32 (i32.const 13120))
 (global $~lib/util/math/EXP2F_TABLE_BITS i32 (i32.const 5))
 (global $~lib/util/math/exp2f_data_tab i32 (i32.const 13440))
 (global $~lib/util/math/LOG2F_TABLE_BITS i32 (i32.const 4))
 (global $~lib/util/math/log2f_data_tab i32 (i32.const 13744))
