  ...
  block $folding-inner1
   ...
   loop $for-loop|6
    ...
    if
     ...
     i32.load
     local.set $3
     block $__inlined_func$~lib/map/Map<u8,i32>#find21
      loop $while-continue|022
       local.get $3
       if
        local.get $3
   ...
   loop $for-loop|8
    ...
    if
     ...
     i32.load
     local.set $3
     block $__inlined_func$~lib/map/Map<u8,i32>#find27
      loop $while-continue|028
       local.get $3
       if
        local.get $3
  ...
  block $folding-inner1
   ...
   loop $for-loop|6
    ...
    if
     ...
     i32.load
     local.set $3
     block $__inlined_func$~lib/map/Map<u16,i32>#find21
      loop $while-continue|022
       local.get $3
       if
        local.get $3
   ...
   loop $for-loop|8
    ...
    if
     ...
     i32.load
     local.set $3
     block $__inlined_func$~lib/map/Map<u16,i32>#find27
      loop $while-continue|028
       local.get $3
       if
        local.get $3
