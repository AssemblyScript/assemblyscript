(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 3328))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36096))
 (global $~lib/memory/__heap_base i32 (i32.const 36096))
 (memory $0 1)
 ...
 (data (i32.const 3312) "\03\00\00\00 \00\00\00 \00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $~lib/uri/encodeURI (type $i32_=>_i32) (param $str i32) (result i32)
  local.get $str
  local.get $str
  call $~lib/string/String#get:length
 ...
 (func $~lib/util/uri/decode (type $i32_i32_i32_=>_i32) (param $src i32) (param $len i32) (param $component i32) (result i32)
  (local $i i32)
  (local $offset i32)
  (local $ch i32)
  (local $dst i32)
 ...
 (func $~lib/uri/decodeURIComponent (type $i32_=>_i32) (param $str i32) (result i32)
  local.get $str
  local.get $str
  call $~lib/string/String#get:length
  i32.const 1
 ...
 (func $~lib/uri/decodeURI (type $i32_=>_i32) (param $str i32) (result i32)
  local.get $str
  local.get $str
  call $~lib/string/String#get:length
  i32.const 0
