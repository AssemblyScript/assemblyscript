(module
 ...
 (func $~lib/array/Array<std/array-literal/Ref>#__uset (param $this i32) (param $index i32) (param $value i32)
  local.get $this
  i32.load offset=4
  local.get $index
  i32.const 2
 ...
 (func $~lib/array/Array<std/array-literal/RefWithCtor>#__uset (param $this i32) (param $index i32) (param $value i32)
  local.get $this
  i32.load offset=4
  local.get $index
  i32.const 2
