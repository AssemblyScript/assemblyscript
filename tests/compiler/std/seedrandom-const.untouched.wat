(module
 ...
 (global $~lib/ASC_SEEDRANDOM_HIGH i32 (i32.const 2147483647))
 (global $~lib/ASC_SEEDRANDOM_LOW i32 (i32.const -1))
 ...
 (func $start:std/seedrandom-const (; 7 ;)
  i32.const 32
  i32.const 1
 ...
 (func $~start (; 8 ;)
  ...
  call $start:std/seedrandom-const
 )
)
