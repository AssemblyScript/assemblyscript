(module
 ...
 (data (i32.const 352) "\08\00\00\00\01\00\00\00\00\00\00\00\08\00\00\00\01\00\00\00\02")
 (data (i32.const 384) " \00\00\00\01\00\00\00\01\00\00\00 \00\00\00~\00l\00i\00b\00/\00d\00a\00t\00a\00v\00i\00e\00w\00.\00t\00s")
 ...
 (func $~lib/memory/memory.fill (; 12 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
 ...
 (func $~lib/arraybuffer/ArrayBuffer#slice (; 15 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  local.get $0
  i32.const 16
  i32.sub
 ...
 (func $~lib/dataview/DataView#constructor (; 17 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $~setArgumentsLength (; 18 ;) (param $0 i32)
  local.get $0
  global.set $~argumentsLength
 )
 (func $start:std/arraybuffer (; 19 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
