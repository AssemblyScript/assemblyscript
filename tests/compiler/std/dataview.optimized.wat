(module
 ...
 (func $~lib/rt/pure/markGray (; 58 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/scanBlack (; 59 ;) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const -1879048193
 ...
 (func $~lib/rt/pure/scan (; 60 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/collectWhite (; 61 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
