(module
 ...
 (func $~lib/memory/memory.fill (; 18 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.const 0
  i32.store8
 ...
 (func $~lib/arraybuffer/ArrayBufferView#alloc (; 20 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 8
 ...
 (func $~lib/dataview/DataView#constructor (; 23 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $2
 ...
 (func $~lib/typedarray/Uint8Array#get:buffer (; 24 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load
  call $~lib/rt/pure/__retain
 )
 (func $~lib/typedarray/Uint8Array#get:byteOffset (; 25 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load offset=4
  local.get $0
  i32.load
 ...
 (func $~lib/rt/__visit_members (; 55 ;) (param $0 i32)
