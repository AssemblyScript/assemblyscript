(module
 ...
 (global $HEAP_BASE i32 (i32.const 1304))
 (memory $0 1)
 ...
 (data (i32.const 1172) "\07\00\00\001\001\001\001\001\001\001\00")
 (data (i32.const 1192) "\07\00\00\001\002\003\004\005\006\007\00")
 (data (i32.const 1212) "\n\00\00\002\001\004\007\004\008\003\006\004\006\00")
 (data (i32.const 1236) "\n\00\00\002\001\004\007\004\008\003\006\004\007\00")
 (data (i32.const 1260) "\02\00\00\00-\001\00")
 (data (i32.const 1268) "\04\00\00\001\000\000\000\00")
 ...
 (func $~lib/array/Array<i32>#__unchecked_get (; 25 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (return
 ...
 (func $~lib/array/Array<u32>#__unchecked_get (; 26 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (return
   (block $~lib/internal/arraybuffer/loadUnsafe<u32,u32>|inlined.0 (result i32)
    ...
    (br $~lib/internal/arraybuffer/loadUnsafe<u32,u32>|inlined.0
     (i32.load offset=8
      (i32.add
       (get_local $2)
       (i32.shl
 ...
 (func $~lib/internal/itoa/utoa32_lut (; 27 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $~lib/internal/itoa/itoa32 (; 28 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (set_local $4
   (i32.add
    (block $~lib/internal/itoa/decimalCount|inlined.0 (result i32)
     (set_local $2
      (i32.sub
       (i32.const 32)
       (i32.clz
     ...
     (br $~lib/internal/itoa/decimalCount|inlined.0
      (i32.add
       (get_local $3)
       (i32.const 1)
      )
 ...
 (func $~lib/internal/itoa/utoa32 (; 29 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (set_local $3
   (block $~lib/internal/itoa/decimalCount|inlined.1 (result i32)
    (set_local $1
     (i32.sub
      (i32.const 32)
      (i32.clz
    ...
    (br $~lib/internal/itoa/decimalCount|inlined.1
     (i32.add
      (get_local $2)
      (i32.const 1)
     )
