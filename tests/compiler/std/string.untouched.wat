 ...
 (func $~lib/internal/itoa/utoa64 (; 29 ;) (type $Ii) (param $0 i64) (result i32)
  ...
  (if
   ...
   (block
    ...
    (set_local $12
     (block $~lib/internal/itoa/decimalCount|inlined.2 (result i32)
      (set_local $8
       (i32.shr_u
        (get_local $6)
        (i32.const 31)
      ...
      (br $~lib/internal/itoa/decimalCount|inlined.2
       (i32.add
        (get_local $11)
        (i32.const 1)
       )
   ...
   (block
    ...
    (set_local $10
     (block $~lib/internal/itoa/decimalCount|inlined.3 (result i32)
      (set_local $12
       (i32.shr_u
        (get_local $11)
        (i32.const 31)
      ...
      (br $~lib/internal/itoa/decimalCount|inlined.3
       (i32.add
        (get_local $5)
        (i32.const 1)
       )
 ...
 (func $~lib/internal/itoa/itoa64 (; 30 ;) (type $Ii) (param $0 i64) (result i32)
  ...
  (if
   ...
   (block
    ...
    (set_local $13
     (block $~lib/internal/itoa/decimalCount|inlined.4 (result i32)
      (set_local $9
       (i32.shr_u
        (get_local $7)
        (i32.const 31)
      ...
      (br $~lib/internal/itoa/decimalCount|inlined.4
       (i32.add
        (get_local $12)
        (i32.const 1)
       )
   ...
   (block
    ...
    (set_local $11
     (i32.add
      (block $~lib/internal/itoa/decimalCount|inlined.5 (result i32)
       (set_local $13
        (i32.shr_u
         (get_local $12)
         (i32.const 31)
       ...
       (br $~lib/internal/itoa/decimalCount|inlined.5
        (i32.add
         (get_local $6)
         (i32.const 1)
        )
