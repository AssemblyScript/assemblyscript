(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 55572))
 (memory $0 1)
 (data (i32.const 1036) "\1c")
 (data (i32.const 1048) "\02\00\00\00\0c\00\00\00\01\d87\dch\00i\00R\d8b\df")
 (data (i32.const 1068) "<")
 (data (i32.const 1080) "\02\00\00\00,\00\00\00s\00t\00d\00/\00s\00t\00r\00i\00n\00g\00-\00e\00n\00c\00o\00d\00i\00n\00g\00.\00t\00s")
 (data (i32.const 1132) "<")
 ...
 (data (i32.const 1544) "\02")
 (data (i32.const 1564) "\1c")
 (data (i32.const 1576) "\02\00\00\00\04\00\00\00\01\d87\dc")
 (data (i32.const 1596) "\1c")
 (data (i32.const 1608) "\02\00\00\00\02\00\00\00h")
 (data (i32.const 1628) "\1c")
 (data (i32.const 1640) "\02\00\00\00\04\00\00\00h\00i")
 (data (i32.const 1660) "\1c")
 (data (i32.const 1672) "\02\00\00\00\04\00\00\00R\d8b\df")
 (data (i32.const 1692) "<")
 (data (i32.const 1704) "\02\00\00\00$\00\00\00U\00n\00p\00a\00i\00r\00e\00d\00 \00s\00u\00r\00r\00o\00g\00a\00t\00e")
 (data (i32.const 1756) ",")
 (data (i32.const 1768) "\02\00\00\00\1c\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s")
 (data (i32.const 1804) "L")
 (data (i32.const 1816) "\02\00\00\008\00\00\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a\00a")
 (data (i32.const 1884) "\1c")
 (data (i32.const 1896) "\02\00\00\00\02\00\00\004\d8")
 (data (i32.const 1916) "\1c")
 (data (i32.const 1928) "\02\00\00\00\02\00\00\00\fd\ff")
 (data (i32.const 1948) "\1c")
 (data (i32.const 1960) "\02\00\00\00\02\00\00\00\1e\dd")
 (data (i32.const 1980) ",")
 (data (i32.const 1992) "\02\00\00\00\0e\00\00\001\002\003\00\00\004\005\006")
 (data (i32.const 2028) "\1c")
 (data (i32.const 2040) "\02\00\00\00\06\00\00\001\002\003")
 (data (i32.const 2060) "\1c")
 (data (i32.const 2072) "\02\00\00\00\08\00\00\00h\00i\00R\d8b\df")
 (data (i32.const 2092) "<3")
 ...
 (func $~lib/string/String.UTF8.byteLength (type $i32_i32_=>_i32) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $~lib/string/String.UTF16.encode (type $i32_=>_i32) (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
 ...
 (func $~lib/string/String.UTF16.decode (type $i32_=>_i32) (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $std/string-encoding/testUTF16DecodeUnsafe (type $none_=>_none)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $~lib/string/String.UTF8.encode (type $i32_i32_i32_=>_i32) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $~lib/string/String.UTF8.encode@varargs (type $i32_i32_=>_i32) (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
 ...
 (func $std/string-encoding/testUTF8EncodeNullTerminated (type $none_=>_none)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 16
  i32.sub
 ...
 (func $~lib/string/String.UTF8.decode (type $i32_i32_=>_i32) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $std/string-encoding/testUTF8DecodeUnsafe (type $none_=>_none)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $std/string-encoding/testRoundtrip (type $i32_=>_none) (param $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 20
  i32.sub
 ...
 (func $~lib/string/String.UTF16.decodeUnsafe (type $i32_i32_=>_i32) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $~lib/string/String.UTF8.decodeUnsafe (type $i32_i32_i32_=>_i32) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
