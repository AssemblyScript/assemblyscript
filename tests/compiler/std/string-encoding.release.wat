(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 57252))
 (memory $0 1)
 (data $0 (i32.const 1036) "\1c")
 (data $0.1 (i32.const 1048) "\02\00\00\00\0c\00\00\00\01\d87\dch\00i\00R\d8b\df")
 ...
 (data $7.1 (i32.const 2760) "\02\00\00\00,\00\00\00s\00t\00d\00/\00s\00t\00r\00i\00n\00g\00-\00e\00n\00c\00o\00d\00i\00n\00g\00.\00t\00s")
 ...
 (func $~lib/string/String.UTF8.encode (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  i32.add
  local.set $6
  block $__inlined_func$~lib/string/String.UTF8.encodeUnsafe$1
   loop $while-continue|0
    local.get $0
    local.get $6
    i32.lt_u
    if
     ...
     if
      ...
      i32.eqz
      i32.and
      br_if $__inlined_func$~lib/string/String.UTF8.encodeUnsafe$1
     else
      local.get $3
      i32.const 2048
      i32.lt_u
