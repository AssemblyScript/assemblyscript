(module
 ...
 (global $HEAP_BASE i32 (i32.const 3752))
 (table 56 56 anyfunc)
 ...
 (data (i32.const 3680) "\02\00\00\00\00\00\00\00\01\02\00\00\00\00\00\00")
 (data (i32.const 3696) "`\0e\00\00\02\00\00\00")
 (data (i32.const 3704) "\02\00\00\00\00\00\00\00\03\04\00\00\00\00\00\00")
 (data (i32.const 3720) "x\0e\00\00\02\00\00\00")
 (data (i32.const 3728) "\08\00\00\00\00\00\00\00p\0e\00\00\88\0e\00\00")
 (data (i32.const 3744) "\90\0e\00\00\02\00\00\00")
 ...
 (func $~lib/internal/itoa/itoa<u8> (; 183 ;) (type $ii) (param $0 i32) (result i32)
  (return
   (call $~lib/internal/itoa/utoa32
    (i32.and
     (get_local $0)
 ...
 (func $~lib/array/Array<u8>#join (; 184 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<Array<u8>>#join (; 185 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
