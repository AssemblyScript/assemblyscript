(module
 ...
 (func $~lib/internal/sort/COMPARATOR<String>~anonymous|55 (; 164 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
