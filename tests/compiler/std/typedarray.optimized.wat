(module
 ...
 (func $start:std/typedarray (; 501 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/pure/__visit (; 503 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  i32.const 6412
  i32.lt_u
  if
 ...
 (func $~lib/rt/__visit_members (; 504 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  block $block$4$break
