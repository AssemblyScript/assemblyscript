(module
 ...
 (func $std/math/check<f64> (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  block $__inlined_func$std/math/ulperr64 (result f64)
   f64.const 0
   local.get $1
   local.get $1
   f64.ne
   ...
   f64.ne
   i32.and
   br_if $__inlined_func$std/math/ulperr64
   drop
   local.get $0
   local.get $1
   f64.eq
   if
    ...
    drop
    f64.const inf
    br $__inlined_func$std/math/ulperr64
   end
   local.get $0
   local.get $0
   f64.sub
 ...
 (func $std/math/check<f32> (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  block $__inlined_func$std/math/ulperr32 (result f32)
   ...
   f32.ne
   i32.and
   br_if $__inlined_func$std/math/ulperr32
   drop
   local.get $0
   local.get $1
   f32.eq
   if
    ...
    drop
    f32.const inf
    br $__inlined_func$std/math/ulperr32
   end
   local.get $0
   local.get $0
   f32.sub
