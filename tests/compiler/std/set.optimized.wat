(module
 ...
 (table $0 6 funcref)
 (elem (i32.const 0) $null $start:std/set~anonymous|0 $start:std/set~anonymous|1 $start:std/set~anonymous|2 $start:std/set~anonymous|3 $start:std/set~anonymous|4)
 ...
 (func $start:std/set~anonymous|0 (; 61 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  local.get $1
  i32.ne
  if
 ...
 (func $~lib/set/Set<i32>#forEach (; 63 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $start:std/set~anonymous|1 (; 64 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $2
  i32.const 11
  call $~lib/set/Set<i32>#add
  global.get $std/set/i
 ...
 (func $start:std/set~anonymous|2 (; 65 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  i32.const 11
  i32.eq
  if
 ...
 (func $start:std/set~anonymous|3 (; 66 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $2
  local.get $0
  call $~lib/set/Set<i32>#delete
  global.get $std/set/i
 ...
 (func $start:std/set~anonymous|4 (; 67 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  global.get $std/set/i
  i32.const 1
  i32.add
  global.set $std/set/i
 )
 (func $start:std/set (; 68 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 144
  ...
  call $~lib/set/Set<i8>#constructor
  global.set $std/set/set
  loop $repeat|0
   local.get $0
   i32.const 10
   i32.lt_s
   if
    global.get $std/set/set
    local.get $0
    call $~lib/set/Set<i32>#add
    local.get $0
    i32.const 1
