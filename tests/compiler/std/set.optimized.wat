(module
 ...
 (func $std/set/testNumeric<i16> (; 54 ;)
  (local $0 i32)
  (local $1 i32)
 ...
 (func $~lib/set/Set<u16>#has (; 56 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  local.get $1
  i32.const 65535
 ...
 (func $~lib/set/Set<u16>#rehash (; 57 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/set/Set<u16>#add (; 58 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $std/set/testNumeric<u16> (; 60 ;)
  (local $0 i32)
  (local $1 i32)
 ...
 (func $~lib/util/hash/hash32 (; 62 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 255
  i32.and
  i32.const -2128831035
 ...
 (func $~lib/set/Set<i32>#find (; 63 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.load
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/set/Set<i32>#has (; 64 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  local.get $1
 ...
 (func $~lib/set/Set<i32>#rehash (; 65 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/set/Set<i32>#add (; 66 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $~lib/set/Set<i64>#add (; 77 ;) (param $0 i32) (param $1 i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $std/set/testNumeric<i64> (; 79 ;)
  (local $0 i64)
  (local $1 i32)
 ...
 (func $std/set/testNumeric<u64> (; 81 ;)
  (local $0 i64)
  (local $1 i32)
 ...
 (func $~lib/set/Set<f32>#find (; 83 ;) (param $0 i32) (param $1 f32) (param $2 i32) (result i32)
  local.get $0
  i32.load
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/set/Set<f32>#has (; 84 ;) (param $0 i32) (param $1 f32) (result i32)
  local.get $0
  local.get $1
  local.get $1
  i32.reinterpret_f32
 ...
 (func $~lib/set/Set<f32>#rehash (; 85 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/set/Set<f32>#add (; 86 ;) (param $0 i32) (param $1 f32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $std/set/testNumeric<f32> (; 88 ;)
  (local $0 f32)
  (local $1 i32)
 ...
 (func $~lib/set/Set<f64>#find (; 90 ;) (param $0 i32) (param $1 f64) (param $2 i32) (result i32)
  local.get $0
  i32.load
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/set/Set<f64>#has (; 91 ;) (param $0 i32) (param $1 f64) (result i32)
  local.get $0
  local.get $1
  local.get $1
  i64.reinterpret_f64
 ...
 (func $~lib/set/Set<f64>#rehash (; 92 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/set/Set<f64>#add (; 93 ;) (param $0 i32) (param $1 f64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
 ...
 (func $std/set/testNumeric<f64> (; 95 ;)
  (local $0 f64)
  (local $1 i32)
 ...
 (func $~lib/rt/pure/__visit (; 97 ;) (param $0 i32) (param $1 i32)
  local.get $0
  i32.const 508
  i32.lt_u
  if
 ...
 (func $~lib/rt/__visit_members (; 98 ;) (param $0 i32) (param $1 i32)
