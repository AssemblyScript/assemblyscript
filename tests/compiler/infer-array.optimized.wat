(module
 ...
 (data (i32.const 1430) "\f0?\00\00\00\00\00\00\00@\00\00\00\00\00\00\08@")
 (data (i32.const 1452) "\1c")
 (data (i32.const 1468) "\08\00\00\00\01\00\00\00\ff\ff\ff\ff")
 (data (i32.const 1484) ",")
 (data (i32.const 1496) "\01\00\00\00\1c\00\00\00i\00n\00f\00e\00r\00-\00a\00r\00r\00a\00y\00.\00t\00s")
 (data (i32.const 1532) ",")
 (data (i32.const 1548) "\18")
 (data (i32.const 1558) "\f0?\00\00\00\00\00\00\00@\00\00\00\00\00\00\08@")
 (data (i32.const 1580) "\1c")
 (data (i32.const 1596) "\0c\00\00\00\00\00\80?\00\00\00@\00\00@@")
 (data (i32.const 1612) "\1c")
 (data (i32.const 1624) "\01\00\00\00\02\00\00\00a")
 (data (i32.const 1644) "\1c")
 (data (i32.const 1660) "\08\00\00\00\00\00\00\00`\06")
 (data (i32.const 1676) "\1c")
 (data (i32.const 1692) "\04")
 (data (i32.const 1708) "\1c")
 (data (i32.const 1724) "\08")
 (data (i32.const 1740) "\1c")
 (data (i32.const 1756) "\08\00\00\00\01")
 (data (i32.const 1772) "\1c")
 (data (i32.const 1788) "\08\00\00\00\00\00\00\00\01")
 (data (i32.const 1804) "\1c")
 (data (i32.const 1820) "\04\00\00\00\01")
 (data (i32.const 1836) "\1c")
 (data (i32.const 1852) "\04\00\00\00\02")
 (data (i32.const 1868) "|")
