(module
 ...
 (global $~lib/native/ASC_LOW_MEMORY_LIMIT i32 (i32.const 4096))
 (global $~lib/memory/__data_end i32 (i32.const 140))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 268))
 ...
 (func $~lib/rt/tlsf/initialize
  ...
  i64.lt_u
  select
  local.set $limitedEnd
  local.get $memStart
  i64.extend_i32_u
  local.get $limitedEnd
  i64.gt_u
  if
   unreachable
  end
 ...
 (func $~lib/rt/tlsf/growMemory (param $root i32) (param $size i32)
  ...
  local.tee $10
  block $~lib/rt/tlsf/sizeRoundToPage|inlined.2 (result i32)
   i32.const 4096
   local.set $size|9
   local.get $size|9
   i32.const 65535
   ...
   i32.const 16
   i32.shr_u
   br $~lib/rt/tlsf/sizeRoundToPage|inlined.2
  end
  local.get $pagesBefore
  i32.sub
  local.tee $11
 ...
 (func $start:lowMemoryLimit/less-than-64k-error
  i32.const 4096
  call $~lib/rt/tlsf/__alloc
  drop
 )
 (func $~start
  call $start:lowMemoryLimit/less-than-64k-error
 )
)
