(module
 ...
 (data (i32.const 288) "\1e\00\00\00\01\00\00\00\01\00\00\00\1e\00\00\00m\00a\00n\00a\00g\00e\00d\00-\00c\00a\00s\00t\00.\00t\00s")
 (data (i32.const 336) "\05\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\04\00\00\00\10")
 ...
 (func $~lib/rt/tlsf/growMemory (; 10 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  memory.size
  local.tee $1
 ...
 (func $~lib/rt/tlsf/prepareBlock (; 11 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  i32.load
 ...
 (func $~lib/rt/tlsf/allocateBlock (; 12 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
 ...
 (func $~lib/rt/tlsf/__alloc (; 13 ;) (param $0 i32) (result i32)
 ...
 (func $managed-cast/Cat#constructor (; 16 ;) (result i32)
  (local $0 i32)
  i32.const 3
 ...
 (func $~lib/rt/__typeinfo (; 17 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 336
  i32.load
  i32.gt_u
 ...
 (func $~lib/rt/__instanceof (; 20 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 16
  i32.sub
  i32.load offset=8
 ...
 (func $managed-cast/testUpcastFromNullable (; 21 ;) (param $0 i32)
 ...
 (func $~lib/rt/__visit_members (; 24 ;) (param $0 i32)
