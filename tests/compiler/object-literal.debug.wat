(module
 ...
 (func $object-literal/Unmanaged#constructor|default (param $this i32)
  local.get $this
  i32.const 0
 ...
 (func $object-literal/Unmanaged#constructor (param $this i32) (result i32)
  ...
  local.get $this
  call $object-literal/Unmanaged#constructor|default
  local.get $this
 )
 ...
 (func $object-literal/Managed#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $object-literal/Managed#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $object-literal/Managed#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $object-literal/OmittedTypes#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $object-literal/OmittedTypes#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $object-literal/OmittedTypes#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $object-literal/MixedOmitted#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $object-literal/MixedOmitted#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $object-literal/MixedOmitted#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $object-literal/OmittedFoo#constructor|default (param $this i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
 ...
 (func $object-literal/OmittedFoo#constructor (param $this i32) (result i32)
  ...
  i32.store offset=4
  local.get $1
  call $object-literal/OmittedFoo#constructor|default
  local.get $this
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 8
