(module
 ...
 (data $20.1 (i32.const 3448) "\02\00\00\00\"\00\00\00f\00u\00n\00c\00t\00i\00o\00n\00-\00t\00y\00p\00e\00s\00.\00t\00s")
 ...
 (data $23.1 (i32.const 3576) "\04\00\00\00\08\00\00\00\04")
 (data $24 (i32.const 3600) "\07\00\00\00 \00\00\00 \00\00\00 ")
 (table $0 5 5 funcref)
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$143
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1152
     local.set $0
     br $__inlined_func$~lib/string/String#concat$143
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    call $~lib/rt/itcms/__new
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $folding-inner0 $folding-inner0 $folding-inner0 $invalid
       end
       return
      end
      return
