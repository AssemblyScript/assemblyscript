(module
 ...
 (memory $0 1)
 (data (i32.const 16) "\18\00\00\00\01\00\00\00\01\00\00\00\18\00\00\00~\00l\00i\00b\00/\00m\00a\00t\00h\00.\00t\00s")
 ...
 (func $~lib/string/String.UTF8.encodeUnsafe (; 6 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/bindings/wasi/abort (; 8 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/math/NativeMath.seedRandom (; 9 ;) (param $0 i64)
  i32.const 1
 ...
 (func $~lib/math/NativeMath.random (; 10 ;) (result f64)
  (local $0 i64)
  (local $1 i64)
 ...
 (func $wasi/seed/test (; 11 ;) (result f64)
