(module
 ...
 (func $object-literal-method/SomeClass#set:add (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $start:object-literal-method~anonymous|1 (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 (func $start:object-literal-method
  (local $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $object-literal-method/SomeClass~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.tee $2
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $~lib/function/Function<%28i32%2Ci32%29=>i32>
    block $object-literal-method/SomeClass
     block $~lib/arraybuffer/ArrayBufferView
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $object-literal-method/SomeClass $~lib/function/Function<%28i32%2Ci32%29=>i32> $invalid
       end
       return
      end
      return
    ...
    local.get $0
    local.get $1
    call $object-literal-method/SomeClass~visit
    return
   end
   local.get $0
   local.get $1
 ...
 (func $~start
  call $start:object-literal-method
 )
 (func $~stack_check
  global.get $~lib/memory/__stack_pointer
 ...
 (func $object-literal-method/SomeClass#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
