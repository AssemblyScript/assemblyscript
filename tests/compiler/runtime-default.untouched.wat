(module
 ...
 (func $~lib/collector/itcm/ManagedObjectList#clear (; 26 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  local.get $0
  i32.store offset=8
  local.get $0
 ...
 (func $~lib/collector/itcm/maybeInit (; 27 ;) (type $FUNCSIG$v)
 ...
 (func $~lib/collector/itcm/ManagedObject#set:color (; 28 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $0
  i32.load offset=8
  i32.const 3
 ...
 (func $~lib/collector/itcm/ManagedObject#set:next (; 29 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  local.get $0
  i32.load offset=8
 ...
 (func $~lib/collector/itcm/__ref_register (; 31 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
 ...
 (func $~lib/collector/itcm/step (; 45 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  block $break|0
   block $case3|0
 ...
 (func $~lib/collector/itcm/__ref_collect (; 46 ;) (type $FUNCSIG$v)
  call $~lib/collector/itcm/maybeInit
  block $break|0
   loop $continue|0
    global.get $~lib/collector/itcm/state
 ...
 (func $~lib/collector/itcm/__ref_mark (; 50 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  call $~lib/collector/itcm/maybeInit
 ...
 (func $~lib/runtime/__gc_mark_roots (; 51 ;) (type $FUNCSIG$v)
  (local $0 i32)
  global.get $~lib/runtime/ROOT
  local.tee $0
  if
 ...
 (func $~lib/runtime/__gc_mark_members (; 52 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  block $invalid
 ...
 (func $~lib/runtime/__runtime_instanceof (; 53 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  block $nope
   block $~lib/runtime/Root
    block $~lib/arraybuffer/ArrayBuffer
     block $~lib/string/String
 ...
 (func $~lib/runtime/runtime.newArray|trampoline (; 55 ;) (type $FUNCSIG$iiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  block $1of1
   block $0of1
    block $outOfRange
     global.get $~lib/argc
