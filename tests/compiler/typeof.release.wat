(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36556))
 ...
 (data $20.1 (i32.const 3448) "\02\00\00\00\12\00\00\00t\00y\00p\00e\00o\00f\00.\00t\00s")
 (data $21 (i32.const 3484) "\1c")
 (data $21.1 (i32.const 3496) "\02\00\00\00\0c\00\00\00o\00b\00j\00e\00c\00t")
 (data $22 (i32.const 3516) ",")
 (data $22.1 (i32.const 3528) "\02\00\00\00\10\00\00\00f\00u\00n\00c\00t\00i\00o\00n")
 (data $23 (i32.const 3564) ",")
 (data $23.1 (i32.const 3576) "\02\00\00\00\0e\00\00\00b\00o\00o\00l\00e\00a\00n")
 (data $24 (i32.const 3612) "\1c")
 (data $24.1 (i32.const 3624) "\02\00\00\00\02\00\00\001")
 (data $25 (i32.const 3644) "\1c")
 (data $25.1 (i32.const 3656) "\02\00\00\00\0c\00\00\00s\00t\00r\00i\00n\00g")
 (data $26 (i32.const 3676) "\1c")
 (data $26.1 (i32.const 3688) "\04\00\00\00\08\00\00\00\01")
 (data $27 (i32.const 3708) ",")
 (data $27.1 (i32.const 3720) "\02\00\00\00\12\00\00\00u\00n\00d\00e\00f\00i\00n\00e\00d")
 (data $28 (i32.const 3760) "\06\00\00\00 \00\00\00 \00\00\00 ")
 (data $28.1 (i32.const 3784) " ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$136
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1152
     local.set $0
     br $__inlined_func$~lib/string/String#concat$136
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
