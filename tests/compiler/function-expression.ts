...
function testOmittedReturn1(): (a: i32, b: i32) => i32 { return (a, b) => a + b; }
function testOmittedReturn2(): (a: i32, b: i32) => i32 { return (a) => a; }
function testOmittedReturn3(): (a: i32, b: i32) => i32 { return () => 42; }
