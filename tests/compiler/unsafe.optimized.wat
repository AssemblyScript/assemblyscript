(module
 ...
 (global $unsafe/Foo.threeTwoTimes (mut i32) (i32.const 0))
 ...
 (func $unsafe/Foo#constructor (; 16 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  i32.const 4
  i32.const 3
 ...
 (func $start:unsafe (; 24 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 1
  global.set $unsafe/Foo.threeTwoTimes
  call $unsafe/Foo#constructor
  local.tee $0
  i32.load
  drop
  local.get $0
