(module
 ...
 (memory $0 1)
 (data (i32.const 16) "\18\00\00\00\01\00\00\00\01\00\00\00\18\00\00\00i\00n\00t\00e\00r\00f\00a\00c\00e\00.\00t\00s\00")
 (table $0 1 funcref)
 ...
 (func $interface/AFoo#constructor (; 4 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 5
 ...
 (func $interface/StructurallyImplementsIFoo#constructor (; 5 ;) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 5
 ...
 (func $interface/passAnInterface (; 7 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/stub/__retain
  local.set $0
  local.get $0
 ...
 (func $interface/expectX (; 8 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/stub/__retain
  local.set $0
  local.get $0
 ...
 (func $interface/StructurallyImplementsIFoo#foo (; 12 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.load
  local.get $1
  i32.add
 )
 (func $interface/IFoo#foo (; 13 ;) (param $0 i32) (param $1 i32) (result i32)
 ...
 (func $interface/AFoo#faa (; 14 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $1
  local.get $2
  i32.add
 )
 (func $interface/StructurallyImplementsIFoo#faa (; 15 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $1
  local.get $2
  i32.add
 )
 (func $interface/IFoo#faa (; 16 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  block $switch$1$case$4
   block $switch$1$case$3
    block $switch$1$default
     local.get $0
 ...
 (func $interface/AFoo#set:x (; 17 ;) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store8 offset=4
 )
 (func $interface/IFoo#set:x (; 18 ;) (param $0 i32) (param $1 i32)
 ...
 (func $interface/AFoo#get:x (; 19 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load8_u offset=4
 )
 (func $interface/IFoo#get:x (; 20 ;) (param $0 i32) (result i32)
  block $switch$1$case$4
   block $switch$1$case$3
    block $switch$1$default
     local.get $0
