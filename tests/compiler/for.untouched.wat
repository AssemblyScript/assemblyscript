(module
 ...
 (func $~lib/rt/__typeinfo (; 30 ;) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/rt/pure/__release (; 38 ;) (param $0 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.gt_u
  if
 ...
 (func $for/getRef (; 40 ;) (result i32)
  i32.const 0
  call $for/Ref#constructor
 )
 (func $for/testRefAutorelease (; 41 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/pure/markGray (; 44 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/pure/scanBlack (; 45 ;) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const 1879048192
 ...
 (func $~lib/rt/pure/scan (; 46 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/pure/collectWhite (; 47 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
