(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 536))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33304))
 (global $~lib/memory/__heap_base i32 (i32.const 33304))
 (memory $0 1)
 (data (i32.const 12) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\16\00\00\00r\00e\00e\00x\00p\00o\00r\00t\00.\00t\00s\00\00\00\00\00\00\00")
 ...
 (data (i32.const 460) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1a\00\00\00r\00e\00r\00e\00e\00x\00p\00o\00r\00t\00.\00t\00s\00\00\00")
 (data (i32.const 512) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $exports/Car#set:doors (type $i32_i32_=>_none) (param $this i32) (param $doors i32)
  local.get $this
  local.get $doors
  i32.store $0
 )
 ...
 (func $exports/Car#get:doors (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  i32.load $0
 )
 (func $exports/Car#get:numDoors (type $i32_=>_i32) (param $this i32) (result i32)
  local.get $this
  call $exports/Car#get:doors
  return
 )
 (func $start:exportstar-rereexport (type $none_=>_none)
 ...
 (func $start:reexport (type $none_=>_none)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $start:rereexport (type $none_=>_none)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $exports/Car#constructor (type $i32_i32_=>_i32) (param $this i32) (param $doors i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
