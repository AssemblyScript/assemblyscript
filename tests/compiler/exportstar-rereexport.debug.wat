(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 2200))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34968))
 (global $~lib/memory/__heap_base i32 (i32.const 34968))
 (memory $0 1)
 (data $0 (i32.const 12) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\16\00\00\00r\00e\00e\00x\00p\00o\00r\00t\00.\00t\00s\00\00\00\00\00\00\00")
 ...
 (data $16 (i32.const 2124) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1a\00\00\00r\00e\00r\00e\00e\00x\00p\00o\00r\00t\00.\00t\00s\00\00\00")
 (data $17 (i32.const 2176) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $exports/Car#set:doors (param $this i32) (param $doors i32)
  local.get $this
  local.get $doors
  i32.store
 )
 ...
 (func $exports/Car#get:numDoors (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
