(module
 ...
 (func $class-overloading/B#a<i32>@virtual (param $0 i32)
  block $default
   block $case1
    local.get $0
    i32.const 8
 ...
 (func $start:class-overloading
  ...
  block $folding-inner1
     ...
     block $case214
      block $case115
       block $case016
        ...
        i32.const 4
        i32.sub
        br_table $case016 $case115 $case016 $case016 $case214 $default13
       end
       i32.const 1520
       global.set $class-overloading/which
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/A#b@virtual17
    block $default18
     block $case219
      block $case120
       block $case021
       ...
       i32.const 1520
       global.set $class-overloading/which
       br $__inlined_func$class-overloading/A#b@virtual17
      end
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/A#b@virtual17
   ...
   i32.store
   local.get $0
   call $class-overloading/B#a<i32>@virtual
   global.get $~lib/memory/__stack_pointer
   global.get $class-overloading/which
   local.tee $0
   i32.store
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#b@virtual
    block $default29
     block $case130
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#b@virtual
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#b@virtual
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#get:c@virtual
    block $default35
     block $case136
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#get:c@virtual
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#get:c@virtual
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#b@virtual41
    block $default42
     block $case143
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#b@virtual41
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#b@virtual41
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#b@virtual48
    block $default49
     block $case150
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#b@virtual48
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#b@virtual48
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#get:c@virtual55
    block $default56
     block $case157
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#get:c@virtual55
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#get:c@virtual55
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/B#b@virtual62
    block $default63
     block $case164
      local.get $0
      i32.const 8
      ...
      i32.const 1616
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/B#b@virtual62
     end
     i32.const 1648
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/B#b@virtual62
   ...
   local.tee $0
   i32.store
   block $__inlined_func$class-overloading/IA#foo@virtual77
    block $default78
     block $case179
      local.get $0
      i32.const 8
      ...
      i32.const 1680
      global.set $class-overloading/which
      br $__inlined_func$class-overloading/IA#foo@virtual77
     end
     i32.const 1712
     global.set $class-overloading/which
     br $__inlined_func$class-overloading/IA#foo@virtual77
