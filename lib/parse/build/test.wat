(module
 ...
 (global $HEAP_BASE i32 (i32.const 108))
 ...
 (func $assembly/host/index/log<String> (; 14 ;) (type $iv) (param $0 i32)
  get_local $0
  call $assembly/host/index/_log_str
 )
 (func $tests/assembly/index/startUp (; 15 ;) (type $v)
  i32.const 48
  set_global $tests/assembly/index/str
  get_global $tests/assembly/index/str
  call $assembly/host/index/log<String>
 )
 (func $tests/assembly/index/overwrite (; 16 ;) (type $v)
  get_global $tests/assembly/index/str
  i32.const 2
  i32.add
  i32.const 0
 ...
 (func $tests/assembly/index/getStr (; 17 ;) (type $i) (result i32)
  get_global $tests/assembly/index/str
 )
