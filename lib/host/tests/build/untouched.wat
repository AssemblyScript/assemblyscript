(module
 ...
 (memory $0 1)
 (data (i32.const 8) "\1e\00\00\00D\00o\00e\00s\00 \00t\00h\00e\00 \00s\00t\00r\00i\00n\00g\00 \00p\00r\00i\00n\00t\00i\00n\00g\00 \00w\00o\00r\00k\00?\00")
 (table $0 1 anyfunc)
 ...
 (func $assembly/index/log<String> (; 16 ;) (type $iv) (param $0 i32)
  get_local $0
  call $assembly/host/_log_str
 )
 (func $assembly/index/log<i32> (; 17 ;) (type $iv) (param $0 i32)
  get_local $0
  call $assembly/host/_logi
 )
 (func $assembly/index/log<Car> (; 18 ;) (type $iv) (param $0 i32)
  get_local $0
  i32.const 16
  call $assembly/host/_log<i32>
 )
 (func $tests/assembly/index/runTest (; 19 ;) (type $v)
  (local $0 i32)
  i32.const 8
