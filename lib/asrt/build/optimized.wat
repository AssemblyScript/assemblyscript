(module
 ...
 (import "env" "__heap_base" (global $asrt/__heap_base i32))
 (import "env" "abort" (func $~lib/builtins/abort (param i32 i32 i32 i32)))
 (global $asrt/rel_mbase (mut i32) (i32.const 0))
 (global $asrt/rel_visit (mut i32) (i32.const 0))
 ...
 (export "alloc" (func $asrt/alloc))
 (export "realloc" (func $asrt/realloc))
 (export "free" (func $asrt/free))
 (export "retain" (func $asrt/retain))
 (export "release" (func $asrt/release))
 (export "visit" (func $asrt/visit))
 (export "collect" (func $asrt/collect))
 ...
 (func $asrt/__visit_members (; 7 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  i32.const 2
  global.set $~lib/argc
  local.get $0
  global.get $asrt/rel_mbase
  i32.sub
  local.get $1
  global.get $asrt/rel_visit
 ...
 (func $asrt/alloc (; 18 ;) (type $FUNCSIG$iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $1
  local.get $2
 ...
 (func $asrt/realloc (; 22 ;) (type $FUNCSIG$iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
  local.get $2
 ...
 (func $asrt/free (; 24 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.add
 ...
 (func $asrt/retain (; 26 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
  local.tee $1
 ...
 (func $asrt/release (; 31 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  global.set $asrt/rel_mbase
  local.get $2
  global.set $asrt/rel_visit
  local.get $0
  local.get $1
  i32.add
  local.tee $0
 ...
 (func $asrt/visit (; 33 ;) (type $FUNCSIG$viiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  local.get $0
  global.set $asrt/rel_mbase
  local.get $3
  global.set $asrt/rel_visit
 ...
 (func $asrt/collect (; 34 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  global.set $asrt/rel_mbase
  local.get $1
  global.set $asrt/rel_visit
