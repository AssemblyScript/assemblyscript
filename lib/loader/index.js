...
function postInstantiate(baseModule, instance) {
  ...
  Object.defineProperties(memory, // Different view of memory
    {
      U8: {
        get: function(){
      ...
      U64: {
        get: function(){
          return new BigUint64Array(this.buffer);
        }
      },
      I64: {
        get: function(){
          return new BigInt64Array(this.buffer);
        }
      },
      F32: {
        get: function(){
  ...
  function __getString(ptr) {
    ...
    const id = memory.U32[ptr + ID_OFFSET >>> 2];
  ...
  function getView(alignLog2, signed, float) {
    if (float) {
      switch (alignLog2) {
        case 2: return memory.F32;
        case 3: return memory.F64;
      }
    } else {
      switch (alignLog2) {
        case 0: return signed ? memory.I8  : memory.U8;
        case 1: return signed ? memory.I16 : memory.U16;
        case 2: return signed ? memory.I32 : memory.U32;
        case 3: return signed ? memory.I64 : memory.U64;
      }
    }
  ...
  function __getArrayBuffer(ptr) {
    const buffer = memory.buffer;
    const length = memory.U32[ptr + SIZE_OFFSET >>> 2];
  ...
  function getTypedArrayImpl(Type, alignLog2, ptr) {
    ...
    return new Type(memory.buffer).slice(bufPtr >>> alignLog2, bufPtr + length >>> alignLog2);
  }
