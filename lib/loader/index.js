...
/** Extends memory with accessor functions. */
function extendMemory(memory) {
  if (memory.__extended) return;
...
function preInstantiate(imports) {
  ...
  function getString(memory, ptr) {
    ...
    if (memory.getString) return memory.getString(ptr);
...
function postInstantiate(baseModule, instance) {
  ...
  extendMemory(memory);
  baseModule.memory = memory;
  baseModule.getString = memory.getString;
  baseModule.getArray = memory.getArray;
  ...
  function newString(str) {
    ...
    let U32 = memory.U32, U16 = memory.U16;
  ...
  function newArray(view, length, unsafe) {
    ...
    U32[(buf + 4) >>> 2] = 0;          // 0
    if (view) {
      new ctor(memory.buffer, buf + 8, length).set(view);
  ...
  return demangle(rawExports, Object.defineProperties(baseModule, {
    I8: { get: function() { return memory.I8; } },
    U8: { get: function() { return memory.U8; } },
    I16: { get: function() { return memory.I16; } },
    U16: { get: function() { return memory.U16; } },
    I32: { get: function() { return memory.I32; } },
    U32: { get: function() { return memory.U32; } },
    I64: { get: function() { return memory.I64; } },
    U64: { get: function() { return memory.U64; } },
    F32: { get: function() { return memory.F32; } },
    F64: { get: function() { return memory.F64; } }
  }));
}
