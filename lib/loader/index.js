...
function instantiate(module, imports) {
  ...
  function checkFunction(f, nbArgs) {
    if (f.length === nbArgs) return f;
    throw new Error("Unexpected number of arguments, expected " + nbArgs + ", got " + f.length);
  }
  ...
  return demangle(exports, {
    ...
    getArray,
    freeArray,
    getFunction, // For JavaScript only
    getFunction0,
    getFunction1,
    getFunction2,
    getFunction3,
