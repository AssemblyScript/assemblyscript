...
function postInstantiate(extendedExports, instance) {
  ...
  extendedExports.memory = baseModule.memory || memory;
  extendedExports.table  = baseModule.table  || table;
...
async function instantiate(source, imports) {
  ...
  const instance = await WebAssembly.instantiate(module, imports || (imports = {}));
  const exports = postInstantiate(preInstantiate(imports), instance);
...
function instantiateSync(source, imports) {
  ...
  const instance = new WebAssembly.Instance(module, imports || (imports = {}));
  const exports = postInstantiate(preInstantiate(imports), instance);
  return { module, instance, exports };
}
...
async function instantiateStreaming(source, imports) {
  ...
  const result = await WebAssembly.instantiateStreaming(source, imports || (imports = {}));
...
function demangle(exports, extendedExports) {
  extendedExports = extendedExports ? Object.create(extendedExports) : {};
