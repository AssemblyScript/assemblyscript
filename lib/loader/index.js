...
function instantiate(module, imports) {
  ...
  function getArray(ptr, type) {
    ...
    if (type === F64) {
      return type.subarray(dataStart >>> 1, (dataStart >>> 1) + len);
    }
    return type.subarray(dataStart, dataStart + len);
  }
