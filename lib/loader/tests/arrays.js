...
assert(asmModule.getArray(asmModule.arr_u8, asmModule.U8) instanceof Uint8Array);

// test arr_i8
assert.deepEqual(asmModule.getArray(asmModule.arr_i8, asmModule.I8), [ -1, 2, -3 ]);
assert(asmModule.getArray(asmModule.arr_i8, asmModule.I8) instanceof Int8Array);

// test arr_i16
assert.deepEqual(asmModule.getArray(asmModule.arr_i16, asmModule.I16), [-1, 2, -3]);
assert(asmModule.getArray(asmModule.arr_i16, asmModule.I16) instanceof Int16Array);

// test arr_u16
assert.deepEqual(asmModule.getArray(asmModule.arr_u16, asmModule.U16), [1, 2, 3]);
assert(asmModule.getArray(asmModule.arr_u16, asmModule.U16) instanceof Uint16Array);

// test arr_u32
assert.deepEqual(asmModule.getArray(asmModule.arr_u32, asmModule.U32), [10, 20, 30]);
assert(asmModule.getArray(asmModule.arr_u32, asmModule.U32) instanceof Uint32Array);

// test arr_i32
assert.deepEqual(asmModule.getArray(asmModule.arr_i32, asmModule.I32), [-10, 20, -30]);
assert(asmModule.getArray(asmModule.arr_i32, asmModule.I32) instanceof Int32Array);
...
assert(asmModule.getArray(asmModule.arr_f32, asmModule.F32) instanceof Float32Array);

// test arr_f64
assert.deepEqual(asmModule.getArray(asmModule.arr_f64, asmModule.F64), [ 10.1, -20.20, 30.30 ]);
assert(asmModule.getArray(asmModule.arr_f64, asmModule.F64) instanceof Float64Array);
