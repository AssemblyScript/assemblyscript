...
var func = module.getFunction0(module.getCallback0());
assert.strictEqual(func(), 42);
func = module.getFunction1(module.getCallback1());
assert.strictEqual(func(4), 42 + 4);
func = module.getFunction2(module.getCallback2());
assert.strictEqual(func(4, 6), 4 + 6);
func = module.getFunction3(module.getCallback3());
assert.strictEqual(func(4, 1, 3), 4 + 1 + 3);
func = module.getFunction4(module.getCallback4());
