...
function test(file) {
  ...
  {
    var arr = [1, 2, 3, 4, 5, 0x80000000 | 0];
    let ref = exports.__retain(exports.__allocStaticArray(exports.INT32STATICARRAY_ID, arr));
    assert(exports.__instanceof(ref, exports.INT32STATICARRAY_ID));
  ...
  */
  ...
  // should be able to distinguish between signed and unsigned static arrays
  {
    let arr = new Uint8Array([0, 255, 127]);
    let ref = exports.__retain(exports.__allocStaticArray(exports.UINT8STATICARRAY_ID, arr));
    assert(exports.__instanceof(ref, exports.UINT8STATICARRAY_ID));
    assert.deepEqual(exports.__getUint8StaticArray(ref), arr);
    exports.__release(ref);
    try { exports.__release(ref); assert(false); } catch (e) {};
  }
  ...
  // should be able to distinguish between signed and unsigned staticarrays
  {
    let arr = new Int16Array([0, 0xFFFF, -0x00FF]);
    let ref = exports.__retain(exports.__allocStaticArray(exports.INT16STATICARRAY_ID, arr));
    assert(exports.__instanceof(ref, exports.INT16STATICARRAY_ID));
    assert.deepEqual(exports.__getInt16StaticArray(ref), arr);
    exports.__release(ref);
    try { exports.__release(ref); assert(false); } catch (e) {};
  }
  ...
  {
    let arr = [1, -1 >>> 0, 0x80000000];
    let ref = exports.__retain(exports.__allocStaticArray(exports.UINT32STATICARRAY_ID, arr));
    assert(exports.__instanceof(ref, exports.UINT32STATICARRAY_ID));
    assert.deepEqual(exports.__getUint32StaticArray(ref), new Uint32Array(arr));
    assert.deepEqual(exports.__getUint32StaticArrayView(ref), new Uint32Array(arr));
    assert.deepEqual(exports.__getArray(ref), arr);
    exports.__release(ref);
    try { exports.__release(ref); assert(false); } catch (e) {};
  }
  ...
  // should be able to distinguish between integer and float staticarrays
  {
    let arr = [0.0, 1.5, 2.5];
    let ref = exports.__retain(exports.__allocStaticArray(exports.FLOAT32STATICARRAY_ID, arr));
    assert(exports.__instanceof(ref, exports.FLOAT32STATICARRAY_ID));
    assert.deepEqual(exports.__getFloat32StaticArray(ref), new Float32Array(arr));
    assert.deepEqual(exports.__getFloat32StaticArrayView(ref), new Float32Array(arr));
    assert.deepEqual(exports.__getArray(ref), arr);
    exports.__release(ref);
    try { exports.__release(ref); assert(false); } catch (e) {};
  }
  ...
  // should be able to mutate an array in place using getStaticArrayView
  {
    let ptr = exports.__retain(exports.__allocStaticArray(exports.FLOAT32STATICARRAY_ID, [1, 2, 3]));
    let view = exports.__getArrayView(ptr);
    assert.deepEqual(view, new Float32Array([1, 2, 3]));
    exports.modifyFloat32StaticArray(ptr, 0, 4);
    assert.deepEqual(view, new Float32Array([4, 2, 3]));
    exports.__release(ptr);
  }
  ...
  // should be able to mutate an array in place using getFloat32StaticArray
  {
    let ptr = exports.newFloat32StaticArray(3); // returns are pre-retained
    let view = exports.__getFloat32StaticArrayView(ptr);
    let arr = exports.__getFloat32StaticArray(ptr);
    assert.deepEqual(view, new Float32Array([0, 0, 0]));
    assert.deepEqual(arr, new Float32Array([0, 0, 0]));
    exports.modifyFloat32StaticArray(ptr, 0, 3);
    exports.modifyFloat32StaticArray(ptr, 1, 2);
    exports.modifyFloat32StaticArray(ptr, 2, 1);
    assert.deepEqual(view, new Float32Array([3, 2, 1]));
    assert.deepEqual(arr, new Float32Array([0, 0, 0]));
    exports.__release(ptr);
  }
