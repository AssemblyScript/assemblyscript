...
function test(file) {
  ...
  */
  ...
  // should be able to create arrays with capacity from array like object
  {
    let ref = exports.__newArray(exports.ARRAYI32_ID, { length: 4 });
    assert(exports.__instanceof(ref, exports.ARRAYI32_ID));
    assert.strictEqual(exports.__getArray(ref).length, 4);
  }
