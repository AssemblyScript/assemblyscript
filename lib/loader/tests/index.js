...
function test(file) {
  ...
  */
  ...
  // should be able to create arrays with capacity from arraylike object
  {
    let ref = exports.__newArray(exports.ARRAYI32_ID, { length: 16 });
    assert(exports.__instanceof(ref, exports.ARRAYI32_ID));
    assert.strictEqual(exports.__getArray(ref).length, 16);
  }
