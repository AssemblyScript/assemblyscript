...
var loader = (function(exports) {
  ...
  function preInstantiate(imports) {
    ...
    env.mark = env.mark || function () {
      if (!extendedExports.__mark) {
        // Not yet returned from instantiation
        return;
      }
  ...
  function postInstantiate(extendedExports, instance) {
    ...
    extendedExports.__release = __release; // At the time of this comment, FinalizationRegistry is supported in latest V8
