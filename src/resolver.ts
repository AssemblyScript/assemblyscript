...
export class Resolver extends DiagnosticEmitter {
  ...
  resolveType(
    ...
    var localName = getSourceLevelName(typeNode.range.source, simpleName); // TODO cache
  ...
  resolveIdentifier(
    ...
    if (element = elementsLookup.get(getSourceLevelName(identifier.range.source, name))) {
      this.currentThisExpression = null;
      this.currentElementExpression = null;
