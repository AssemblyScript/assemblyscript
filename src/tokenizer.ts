...
const BASIC_TOKENS: Token[] = [
  ...
  /*    a */ Token.MAYBE_KEYWORD,
  /*    b */ Token.MAYBE_KEYWORD,
  /*    c */ Token.MAYBE_KEYWORD,
  /*    d */ Token.MAYBE_KEYWORD,
  /*    e */ Token.MAYBE_KEYWORD,
  /*    f */ Token.MAYBE_KEYWORD,
  /*    g */ Token.MAYBE_KEYWORD,
  /*    h */ Token.IDENTIFIER,
  /*    i */ Token.MAYBE_KEYWORD,
  /*    j */ Token.IDENTIFIER,
  /*    k */ Token.MAYBE_KEYWORD,
  /*    l */ Token.MAYBE_KEYWORD,
  /*    m */ Token.MAYBE_KEYWORD,
  /*    n */ Token.MAYBE_KEYWORD,
  /*    o */ Token.MAYBE_KEYWORD,
  /*    p */ Token.MAYBE_KEYWORD,
  /*    q */ Token.IDENTIFIER,
  /*    r */ Token.MAYBE_KEYWORD,
  /*    s */ Token.MAYBE_KEYWORD,
  /*    t */ Token.MAYBE_KEYWORD,
  /*    u */ Token.IDENTIFIER,
  /*    v */ Token.MAYBE_KEYWORD,
  /*    w */ Token.MAYBE_KEYWORD,
  /*    x */ Token.IDENTIFIER,
  /*    y */ Token.MAYBE_KEYWORD,
  /*    z */ Token.IDENTIFIER,
  /*    { */ Token.OPENBRACE,
  /*    | */ Token.OPERATOR,
  /*    } */ Token.CLOSEBRACE,
