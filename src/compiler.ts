...
export class Compiler extends DiagnosticEmitter {
  ...
  makeNe(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type, reportNode: Node): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.USIZE:
      case TypeKind.ISIZE: return module.binary(BinaryOp.NeSize, leftExpr, rightExpr);
      case TypeKind.I64:
  ...
  makeShl(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.USIZE:
      case TypeKind.ISIZE: return module.binary(BinaryOp.ShlSize, leftExpr, rightExpr);
    }
    assert(false);
    return module.unreachable();
  }
  ...
  makeShru(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.U64: return module.binary(BinaryOp.ShrU64, leftExpr, rightExpr);
      case TypeKind.USIZE:
      case TypeKind.ISIZE: return module.binary(BinaryOp.ShrUSize, leftExpr, rightExpr);
    }
    assert(false);
    return module.unreachable();
  }
  ...
  makeAnd(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.USIZE:
      case TypeKind.ISIZE: return module.binary(BinaryOp.AndSize, leftExpr, rightExpr);
    }
    assert(false);
    return module.unreachable();
  }
  ...
  makeOr(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.USIZE:
      case TypeKind.ISIZE: return module.binary(BinaryOp.OrSize, leftExpr, rightExpr);
    }
    assert(false);
    return module.unreachable();
  }
