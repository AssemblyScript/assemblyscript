...
export enum DiagnosticCode {
  ...
  Property_0_has_no_initializer_and_is_not_definitely_assigned_in_constructor = 2564,
...
export function diagnosticCodeToString(code: DiagnosticCode): string {
  switch (code) {
    ...
    case 2564: return "Property {0} has no initializer and is not definitely assigned in constructor";
