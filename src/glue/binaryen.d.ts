...
export declare function _BinaryenBlockSetName(expr: BinaryenExpressionRef, name: usize): void;
...
export declare function _BinaryenSwitchGetNameAt(expr: BinaryenExpressionRef, index: BinaryenIndex): usize;
