...
function createProject(answer) {
  ...
  console.log([
    ...
    "",
    stdoutColors.cyan("  ./build/untouched.wasm"),
    stdoutColors.cyan("  ./build/untouched.wasm.map"),
    stdoutColors.cyan("  ./build/untouched.wat"),
    "",
    ...
    stdoutColors.cyan("  ./build/optimized.wasm.map"),
    stdoutColors.cyan("  ./build/optimized.wat"),
    "",
