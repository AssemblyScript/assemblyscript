function asmFunc(global, env, buffer) {
 ...
 function assembly_index_NBodySystem_advance($0) {
  $0 = $0 | 0;
  var $1 = 0, $2 = 0.0, $3 = 0.0, $4 = 0.0, $5 = 0.0, $6 = 0.0, $10 = 0.0, $11 = 0.0, $7 = 0, $8 = 0, $9 = 0, $19 = 0.0, $12 = 0, $13 = 0, $14 = 0, $15 = 0.0, $16 = 0.0, $17 = 0.0, $18 = 0.0, wasm2js_i32$0 = 0, wasm2js_f64$0 = 0.0;
  $0 = HEAPU32[$0 >> 2] | 0;
  $12 = HEAP32[($0 + 4 | 0) >> 2] | 0;
  $13 = HEAPU32[$0 >> 2] | 0;
  repeat_0 : do {
   if ($7 >>> 0 < $12 >>> 0) {
    $0 = HEAPU32[(($13 + $14 | 0) + 8 | 0) >> 2] | 0;
    $14 = $14 + 4 | 0;
    $8 = 0;
    $15 = +HEAPF64[$0 >> 3];
    $16 = +HEAPF64[($0 + 8 | 0) >> 3];
    ...
    repeat_1 : do {
     if ($9 >>> 0 < $12 >>> 0) {
      $1 = HEAPU32[(($8 + $13 | 0) + 8 | 0) >> 2] | 0;
      $8 = $8 + 4 | 0;
      $19 = $15 - +HEAPF64[$1 >> 3];
      $2 = $19;
      $10 = $16 - +HEAPF64[($1 + 8 | 0) >> 3];
      $11 = $17 - +HEAPF64[($1 + 16 | 0) >> 3];
      $3 = $2 * $2 + $10 * $10 + $11 * $11;
      $2 = .01 / ($3 * Math_sqrt($3));
      $3 = +HEAPF64[($1 + 48 | 0) >> 3] * $2;
      $4 = $4 - $19 * $3;
      $5 = $5 - $10 * $3;
      $6 = $6 - $11 * $3;
      $2 = $18 * $2;
      wasm2js_i32$0 = $1;
      wasm2js_f64$0 = +HEAPF64[($1 + 24 | 0) >> 3] + $19 * $2;
      HEAPF64[(wasm2js_i32$0 + 24 | 0) >> 3] = wasm2js_f64$0;
      wasm2js_i32$0 = $1;
      wasm2js_f64$0 = +HEAPF64[($1 + 32 | 0) >> 3] + $10 * $2;
      HEAPF64[(wasm2js_i32$0 + 32 | 0) >> 3] = wasm2js_f64$0;
      wasm2js_i32$0 = $1;
      wasm2js_f64$0 = +HEAPF64[($1 + 40 | 0) >> 3] + $11 * $2;
      HEAPF64[(wasm2js_i32$0 + 40 | 0) >> 3] = wasm2js_f64$0;
      $9 = $9 + 1 | 0;
      continue repeat_1;
     }
